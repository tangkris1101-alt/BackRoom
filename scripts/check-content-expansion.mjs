...
assert.match(levelNinePropsSource, /new THREE\.PointLight\(0xffd18b, 0, 34, 1\.45\)/);
assert.match(levelNinePropsSource, /new THREE\.CircleGeometry\(7\.6, 32\)/);
assert.match(levelNinePropsSource, /light\.intensity = strength \* 3\.6/);
assert.match(levelNinePropsSource, /pool\.material\.opacity = \(fogSurge \? 0\.2 : 0\.38\) \* flicker/);
