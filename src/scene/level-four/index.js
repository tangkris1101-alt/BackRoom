...
import { CELL_SIZE, WALL_HEIGHT, WALL_THICKNESS, CEILING_Y, circleIntersectsAabb } from "../constants.js";
...
} from "../level-one/props.js";
import {
  createLevelFourCarpetTexture,
  createLevelFourWallTexture,
  createLevelFourCeilingTexture,
} from "./textures.js";
import {
  addLevelFourStairDoor,
  addLevelFourOfficeDetails,
} from "./props.js";
import {
  createAlmondWaterPickup,
  createFlashlightPickup,
  createDetectorPickup,
  SUPER_ALMOND_WATER_DEFAULTS,
} from "../items/index.js";
import {
  createHoundEntity,
  chooseBacteriaSpawn,
...
export function createLevelFourScene() {
  ...
  const superAlmondWater = createAlmondWaterPickup(scene, {
    ...
    blockedAabbs: propColliders,
    variant: "super",
    respawnMin: SUPER_ALMOND_WATER_DEFAULTS.respawnMin,
    respawnVariance: SUPER_ALMOND_WATER_DEFAULTS.respawnVariance,
    initialSpawnChance: SUPER_ALMOND_WATER_DEFAULTS.initialSpawnChance,
    respawnChance: SUPER_ALMOND_WATER_DEFAULTS.respawnChance,
  });
