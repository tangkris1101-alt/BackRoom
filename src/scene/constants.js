...
export const BASE_STAMINA_MAX = 200;
export const SUPER_ALMOND_WATER_STAMINA_MAX = 500;
export const ALMOND_WATER_PICKUP_RADIUS = 3.2;
export const ALMOND_WATER_STAMINA_BONUS = 100;
...
export const SUPER_ALMOND_WATER_INITIAL_SPAWN_CHANCE = 0.26;
export const SUPER_ALMOND_WATER_RESPAWN_CHANCE = 0.36;
...
export const SILENCE_LIQUID_INITIAL_SPAWN_CHANCE = 0.53;
export const SILENCE_LIQUID_RESPAWN_CHANCE = 0.57;
