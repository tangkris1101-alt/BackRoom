...
export const LEVEL_SIX_COLS = 36;
export const LEVEL_SIX_ROWS = 27;
...
export const LEVEL_SIX_ORIGIN_X = -(LEVEL_SIX_COLS * CELL_SIZE) / 2;
export const LEVEL_SIX_ORIGIN_Z = -(LEVEL_SIX_ROWS * CELL_SIZE) / 2;
