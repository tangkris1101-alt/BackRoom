...
const LEVEL_PRESENTATIONS = new Map([
  ...
  [0, { exposure: 0.98, shadowMode: "indoor", shadow: { penumbra: 0.9, radius: 4.5, intensityScale: 0.3, intensityCap: 1.15, angle: 0.5 }, surface: "carpet", environment: "carpeted-indoor", reverb: "medium", post: { aoIntensity: 0.55, vignette: 0.1, grain: 0.045, bloom: { threshold: 0.78, strength: 0.3, radius: 0.6 }, exposureDrift: 0.035 } }],
