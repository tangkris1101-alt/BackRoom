...
export const CHANGELOG_ENTRIES = [
  ...
  { commit: "4e1dfb3", date: "2026-08-02", title: "Update Backrooms build artifact", titleZh: "更新 Backrooms 独立版构建" },
  { commit: "585be8c", date: "2026-08-01", title: "Add equipped item drop button", titleZh: "新增已装备物品丢弃按钮" },
  { commit: "fe79dc4", date: "2026-07-28", title: "Update Backrooms build version", titleZh: "更新 Backrooms 构建版本" },
  { commit: "918a7d3", date: "2026-07-28", title: "Update application implementation", titleZh: "更新应用实现" },
  { commit: "2659ba7", date: "2026-07-27", title: "Update Backrooms build ID", titleZh: "更新 Backrooms 构建标识" },
