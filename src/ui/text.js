...
export const INTERACTION_TEXT = {
  "zh-CN": {
    ...
    "level-five-door-009": {
      name: "009 \u5ba2\u623f\u95e8",
      effect: "\u95e8\u724c\u6570\u5b57\u6bd4\u8d70\u5eca\u7684\u65f6\u949f\u66f4\u65e9\u4e00\u5206\u949f",
      action: "F / \u6309\u94ae\u5f00\u95e8",
      response: "\u623f\u95f4\u91cc\u7684\u9ed1\u6697\u968f\u95e8\u8f6c\u52a8\u3002",
    },
    "level-five-door-312": {
      name: "312 \u5ba2\u623f\u95e8",
      effect: "\u4e00\u679a\u9ec4\u94dc\u95e8\u724c\u88ab\u9489\u5728\u6d53\u7ea2\u8272\u58c1\u7eb8\u4e0a",
      action: "F / \u6309\u94ae\u5f00\u95e8",
      response: "\u95e8\u540e\u4f20\u6765\u4e00\u53e5\u542c\u4e0d\u6e05\u7684\u6b22\u8fce\u8bcd\u3002",
    },
  ...
  en: {
    ...
    "level-five-door-118": {
      name: "ROOM 118",
      effect: "A windowless guest room waits behind the wood.",
      action: "F / BUTTON OPEN",
      response: "The hinge gives a dry complaint.",
    },
    "level-five-door-009": {
      name: "ROOM 009",
      effect: "Its number is one minute ahead of every hallway clock.",
      action: "F / BUTTON OPEN",
      response: "Darkness inside shifts with the door.",
    },
    "level-five-door-312": {
      name: "ROOM 312",
      effect: "A brass room plate is fixed to the deep red wallpaper.",
      action: "F / BUTTON OPEN",
      response: "A welcome from behind it is too quiet to understand.",
    },
    "level-five-portrait-a": {
      name: "AGED PORTRAIT",
...
export const STATUS_TEXT = {
  "zh-CN": {
    ...
    pauseSettingsHint: "语言 · 帧数 · 画质 · 音频",
    pauseSettingsTitle: "设置",
    pauseSettingsClose: "关闭设置",
    settingsLanguage: "语言",
    settingsFrameRate: "帧数",
    settingsAutomatic: "自动",
    settingsQuality: "画质",
    settingsAudio: "音频",
    changelogLabel: "更新日志",
    changelogHint: "查看最近的更新记录",
    changelogEyebrow: "GIT 记录快照",
    changelogTitle: "更新日志",
    changelogDescription: "以下内容来自当前版本内置的 Git 提交记录。",
    ...
    levelTransitionPrewarming: "\u6b63\u5728\u9884\u70ed\u4e0b\u4e00\u5c42",
    levelTransitionBuilding: "\u6b63\u5728\u7a33\u5b9a\u4e0b\u4e00\u5c42\u7a7a\u95f4",
  ...
  en: {
    ...
    pauseSettingsHint: "LANGUAGE · FRAME RATE · QUALITY · AUDIO",
    pauseSettingsTitle: "SETTINGS",
    pauseSettingsClose: "CLOSE SETTINGS",
    settingsLanguage: "LANGUAGE",
    settingsFrameRate: "FRAME RATE",
    settingsAutomatic: "AUTO",
    settingsQuality: "QUALITY",
    settingsAudio: "AUDIO",
    changelogLabel: "CHANGELOG",
    changelogHint: "VIEW RECENT UPDATE RECORDS",
    changelogEyebrow: "GIT HISTORY SNAPSHOT",
    changelogTitle: "CHANGELOG",
    changelogDescription: "Entries below are bundled from this build's Git history snapshot.",
    changelogClose: "CLOSE CHANGELOG",
    ...
    levelTransitionPrewarming: "PREWARMING NEXT LEVEL",
    levelTransitionBuilding: "STABILIZING NEXT LEVEL SPACE",
...
export const MAIN_MENU_TEXT = {
  ...
  en: {
    ...
    settings: "SETTINGS",
    settingsHint: "LANGUAGE · FRAME RATE · QUALITY · AUDIO",
