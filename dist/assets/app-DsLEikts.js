...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(e,t,n){let r=new Float32Array(Ha),i=new H(0,1,0);return new Si({name:`SphericalGaussianBlur`,defines:{n:Ha,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Si({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function io(){return new Si({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ao(),fragmentShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ws(i,i.VERTEX_SHADER,y),S=ws(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=As(i,x,`vertex`),n=As(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
...
}`,Ic=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ii(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Si({vertexShader:Pc,fragmentShader:Fc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new K(new ui(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Lc=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Ic,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new V,O=null,k=new na;k.viewport=new Ot;let te=new na;te.viewport=new Ot;let A=[k,te],j=new pa,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new At(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new ni(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new At(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new H,se=new H;function N(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;ce(j,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?N(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),le(e,j,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let ue=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new na,o.layers.enable(n),o.viewport=new Ot,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ii,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ue&&ue(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new ka;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){ue=e},this.dispose=function(){}}},Rc=new Nt,zc=new U;zc.set(-1,0,0,0,1,0,0,0,1);function Bc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,vi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Rc.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(zc),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Vc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return z(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?R(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):R(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Hc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Uc=null;function Wc(){return Uc===null&&(Uc=new Ir(Hc,16,16,O,g),Uc.name=`DFG_LUT`,Uc.minFilter=o,Uc.magFilter=o,Uc.wrapS=t,Uc.wrapT=t,Uc.generateMipmaps=!1,Uc.needsUpdate=!0),Uc}var Gc=class{constructor(e={}){let{canvas:t=Je(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new H,O=null,A=null,j=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null;this._outputColorSpace=Re;let oe=0,se=0,N=null,ce=-1,le=null,ue=new Ot,de=new Ot,fe=null,pe=new G(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new Ot(0,0,he,ge),xe=new Ot(0,0,he,ge),Se=!1,Ce=new $r,we=!1,Te=!1,Ee=new Nt,De=new H,Oe=new Ot,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return N===null?_e:1}let P=n;function Me(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,ot,!1),t.addEventListener(`webglcontextrestored`,B,!1),t.addEventListener(`webglcontextcreationerror`,st,!1),P===null){let t=`webgl2`;if(P=Me(t,e),P===null)throw Me(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw z(`WebGLRenderer: `+e.message),e}let Ne,Pe,F,Fe,I,L,Ie,Le,ze,Be,Ve,He,Ue,Ge,Ke,qe,Ye,Xe,Qe,$e,tt,nt,rt;function it(){Ne=new co(P),Ne.init(),tt=new Nc(P,Ne),Pe=new Ra(P,Ne,e,tt),F=new jc(P,Ne),Pe.reversedDepthBuffer&&h&&F.buffers.depth.setReversed(!0),Fe=new fo(P),I=new dc,L=new Mc(P,Ne,F,I,Pe,tt,Fe),Ie=new so(M),Le=new Aa(P),nt=new Ia(P,Le),ze=new lo(P,Le,Fe,nt),Be=new mo(P,ze,Le,nt,Fe),Xe=new po(P,Pe,L),Ke=new za(I),Ve=new uc(M,Ie,Ne,Pe,nt,Ke),He=new Bc(M,I),Ue=new hc,Ge=new Sc(Ne),Ye=new Fa(M,Ie,F,Be,x,s),qe=new Ac(M,Be,Pe),rt=new Vc(P,Fe,Pe,F),Qe=new La(P,Ne,Fe),$e=new uo(P,Ne,Fe),Fe.programs=Ve.programs,M.capabilities=Pe,M.extensions=Ne,M.properties=I,M.renderLists=Ue,M.shadowMap=qe,M.state=F,M.info=Fe}it(),S!==1009&&(re=new go(S,t.width,t.height,r,i));let at=new Lc(M,P);this.xr=at,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=Ne.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Ne.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(at.isPresenting){R(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){z(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){R(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),F.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),F.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){F.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Ye.getClearColor())},this.setClearColor=function(){Ye.setClearColor(...arguments)},this.getClearAlpha=function(){return Ye.getClearAlpha()},this.setClearAlpha=function(){Ye.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=Ye.getClearColor(),r=Ye.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,ot,!1),t.removeEventListener(`webglcontextrestored`,B,!1),t.removeEventListener(`webglcontextcreationerror`,st,!1),Ye.dispose(),Ue.dispose(),Ge.dispose(),I.dispose(),Ie.dispose(),Be.dispose(),nt.dispose(),rt.dispose(),Ve.dispose(),at.dispose(),at.removeEventListener(`sessionstart`,pt),at.removeEventListener(`sessionend`,U),mt.stop()};function ot(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ie=!0}function B(){Ze(`WebGLRenderer: Context Restored.`),ie=!1;let e=Fe.autoReset,t=qe.enabled,n=qe.autoUpdate,r=qe.needsUpdate,i=qe.type;it(),Fe.autoReset=e,qe.enabled=t,qe.autoUpdate=n,qe.needsUpdate=r,qe.type=i}function st(e){z(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ct(e){let t=e.target;t.removeEventListener(`dispose`,ct),lt(t)}function lt(e){ut(e),I.remove(e)}function ut(e){let t=I.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=wt(e,t,n,r,i);F.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=ze.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;nt.setup(i,r,s,n,c);let h,g=Qe;if(c!==null&&(h=Le.get(c),g=$e,g.setIndex(h)),i.isMesh)r.wireframe===!0?(F.setLineWidth(r.wireframeLinewidth*je()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),F.setLineWidth(e*je()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(Ne.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Le.get(c).bytesPerElement:1,o=I.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function V(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,bt(e,t,n),e.side=0,e.needsUpdate=!0,bt(e,t,n),e.side=2):bt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=Ge.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];V(a,n,e),r.add(a)}else V(t,n,e),r.add(t)}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){I.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Ne.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let dt=null;function ft(e){dt&&dt(e)}function pt(){mt.stop()}function U(){mt.start()}let mt=new ka;mt.setAnimationLoop(ft),typeof self<`u`&&mt.setContext(self),this.setAnimationLoop=function(e){dt=e,at.setAnimationLoop(e),e===null?mt.stop():mt.start()},at.addEventListener(`sessionstart`,pt),at.addEventListener(`sessionend`,U),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){z(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=at.enabled===!0&&at.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),at.enabled===!0&&at.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(at.cameraAutoUpdate===!0&&at.updateCamera(t),t=at.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),A=Ge.get(e,ne.length),A.init(t),A.state.textureUnits=L.getTextureUnits(),ne.push(A),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,We,t.reversedDepth),Te=this.localClippingEnabled,we=Ke.init(this.clippingPlanes,Te),O=Ue.get(e,j.length),O.init(),j.push(O),at.enabled===!0&&at.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&ht(e,t,-1/0,M.sortObjects)}ht(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(ve,ye),Ae=at.enabled===!1||at.isPresenting===!1||at.hasDepthSensing()===!1,Ae&&Ye.addToRenderList(O,e),this.info.render.frame++,we===!0&&Ke.beginShadows();let i=A.state.shadowsArray;if(qe.render(i,e,t),we===!0&&Ke.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];_t(n,r,e,a)}Ae&&Ye.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];gt(O,e,n,n.viewport)}}else r.length>0&&_t(n,r,e,t),Ae&&Ye.render(e),gt(O,e,t)}N!==null&&se===0&&(L.updateMultisampleRenderTarget(N),L.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),nt.resetDefaultState(),ce=-1,le=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],L.setTextureUnits(A.state.textureUnits),we===!0&&Ke.setGlobalState(M.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ae!==null&&ae.renderEnd()};function ht(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ce.intersectsSprite(e)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let t=Be.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Oe.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ce.intersectsObject(e))){let t=Be.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Oe.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Oe.z,o)}}else i.visible&&O.push(e,t,i,n,Oe.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)ht(i[e],t,n,r)}function gt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),we===!0&&Ke.setGlobalState(M.clippingPlanes,n),r&&F.viewport(ue.copy(r)),i.length>0&&vt(i,t,n),a.length>0&&vt(a,t,n),o.length>0&&vt(o,t,n),F.buffers.depth.setTest(!0),F.buffers.depth.setMask(!0),F.buffers.color.setMask(!0),F.setPolygonOffset(!1)}function _t(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=Ne.has(`EXT_color_buffer_half_float`)||Ne.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new At(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Pe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:W.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(pe),me=M.getClearAlpha(),me<1&&M.setClearColor(16777215,.5),M.clear(),Ae&&Ye.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),we===!0&&Ke.setGlobalState(M.clippingPlanes,r),vt(e,n,r),L.updateMultisampleRenderTarget(a),L.updateRenderTargetMipmap(a),Ne.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,yt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(L.updateMultisampleRenderTarget(a),L.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(pe,me),p!==void 0&&(r.viewport=p),M.toneMapping=f}function vt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&yt(o,t,n,s,l,c)}}function yt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function bt(e,t,n){t.isScene!==!0&&(t=ke);let r=I.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ie.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ct),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return St(e,s),d}else s.uniforms=Ve.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ke.uniform),St(e,s),r.needsLights=Et(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function xt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Cs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function St(e,t){let n=I.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Ct(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function wt(e,t,n,r,i){t.isScene!==!0&&(t=ke),L.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:W.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ie.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=I.get(r),y=A.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;Ke.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ke.numPlanes||v.numIntersection!==Ke.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=bt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(F.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=Ct(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){F.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,De.setFromMatrixPosition(e.matrixWorld)),Pe.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,L),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,L),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,L)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,L))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,L),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,L),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,L));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Xe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Wc()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Tt(E,w),a&&r.fog===!0&&He.refreshFogUniforms(E,a),He.refreshMaterialUniforms(E,r,_e,ge,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Cs.upload(P,xt(v),E,L)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Cs.upload(P,xt(v),E,L),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];rt.update(n,x),rt.bind(n,x)}}return x}function Tt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Et(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=I.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),I.get(e.texture).__webglTexture=t,I.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=I.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Dt=P.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){N=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=I.get(e);if(o.__useDefaultFramebuffer!==void 0){F.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,F.viewport(ue),F.scissor(de),F.setScissorTest(fe),ce=-1;return}else if(o.__webglFramebuffer===void 0)L.setupRenderTarget(e);else if(o.__hasExternalTextures)L.rebindTextures(e,I.get(e.texture).__webglTexture,I.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&I.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);L.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=I.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&L.useMultisampledRTT(e)===!1?I.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=Dt),F.bindFramebuffer(P.FRAMEBUFFER,r)&&F.drawBuffers(e,r),F.viewport(ue),F.scissor(de),F.setScissorTest(fe),i){let r=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=I.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}ce=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){F.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Pe.textureFormatReadable(c)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Pe.textureTypeReadable(l)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,tt.convert(c),tt.convert(l),a)}finally{let e=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){F.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Pe.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Pe.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,tt.convert(l),tt.convert(u),0);let f=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await et(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;L.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),F.unbindTexture()};let kt=P.createFramebuffer(),jt=P.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=tt.convert(t.format),_=tt.convert(t.type),v;t.isData3DTexture?(L.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(L.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(L.setTexture2D(t,0),v=P.TEXTURE_2D),F.activeTexture(P.TEXTURE0),F.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),F.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),F.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=F.getParameter(P.UNPACK_ROW_LENGTH),b=F.getParameter(P.UNPACK_IMAGE_HEIGHT),x=F.getParameter(P.UNPACK_SKIP_PIXELS),S=F.getParameter(P.UNPACK_SKIP_ROWS),C=F.getParameter(P.UNPACK_SKIP_IMAGES);F.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),F.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),F.pixelStorei(P.UNPACK_SKIP_PIXELS,l),F.pixelStorei(P.UNPACK_SKIP_ROWS,u),F.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=I.get(e),r=I.get(t),h=I.get(n.__renderTarget),g=I.get(r.__renderTarget);F.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||I.has(e)){let n=I.get(e),r=I.get(t);F.bindFramebuffer(P.READ_FRAMEBUFFER,kt),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,jt);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);F.pixelStorei(P.UNPACK_ROW_LENGTH,y),F.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),F.pixelStorei(P.UNPACK_SKIP_PIXELS,x),F.pixelStorei(P.UNPACK_SKIP_ROWS,S),F.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),F.unbindTexture()},this.initRenderTarget=function(e){I.get(e).__webglFramebuffer===void 0&&L.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?L.setTextureCube(e,0):e.isData3DTexture?L.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?L.setTexture2DArray(e,0):L.setTexture2D(e,0),F.unbindTexture()},this.resetState=function(){oe=0,se=0,N=null,F.reset(),nt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return We}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=W._getDrawingBufferColorSpace(e),t.unpackColorSpace=W._getUnpackColorSpace()}};function Kc(){let e=null,t=null,n=null,r=!1,i=null,a=0,o=null,s=!1;function c(){if(r)return;r=!0;let a=window.AudioContext||window.webkitAudioContext;if(!a)return;e=new a,t=e.createGain(),t.gain.value=.022,t.connect(e.destination);let s=e.createOscillator();s.type=`sine`,s.frequency.value=58;let c=e.createOscillator();c.type=`triangle`,c.frequency.value=118;let l=e.createGain();l.gain.value=.55,s.connect(l),c.connect(l),l.connect(t);let u=e.sampleRate*2,d=e.createBuffer(1,u,e.sampleRate),f=d.getChannelData(0);for(let e=0;e<u;e+=1)f[e]=Math.random()*2-1;let p=e.createBufferSource();p.buffer=d,p.loop=!0;let m=e.createBiquadFilter();m.type=`bandpass`,m.frequency.value=840,m.Q.value=.8,n=e.createGain(),n.gain.value=.09,p.connect(m),m.connect(n),n.connect(t),s.start(),c.start(),p.start();let h=Math.floor(e.sampleRate*.08);o=e.createBuffer(1,h,e.sampleRate);let g=o.getChannelData(0);for(let e=0;e<h;e+=1)g[e]=(Math.random()*2-1)*(1-e/h);i=e.createBiquadFilter(),i.type=`lowpass`,i.frequency.value=1800,i.Q.value=.7,i.connect(t)}function l({sprinting:n}){if(!e||!i||!o)return;if(e.state===`suspended`)try{e.resume?.()}catch{}let r=e.currentTime,a=e.createBufferSource();a.buffer=o;let s=e.createGain();s.gain.setValueAtTime(0,r),s.gain.linearRampToValueAtTime(n?1.4:1,r+.01),s.gain.exponentialRampToValueAtTime(.001,r+(n?.18:.16)),a.connect(s),s.connect(i),a.start(r),a.stop(r+.22);let c=e.createOscillator();c.type=`sine`,c.frequency.setValueAtTime(n?88:72,r),c.frequency.exponentialRampToValueAtTime(n?52:44,r+.1);let l=e.createGain();l.gain.setValueAtTime(0,r),l.gain.linearRampToValueAtTime(n?.7:.55,r+.006),l.gain.exponentialRampToValueAtTime(.001,r+.14),c.connect(l),l.connect(t),c.start(r),c.stop(r+.16)}function u(t,r={}){if(!e||!n)return;if(e.state===`suspended`&&!s)try{e.resume?.()}catch{}let i=e.currentTime,o=.055+(1-t)*.08;if(n.gain.setTargetAtTime(o,i,.035),!(r.moving&&r.grounded)){a=Math.min(a,i);return}let c=Math.max(0,r.movementSpeed??0),u=!!r.sprinting,d=u?Math.max(.4,.5-c*.012):Math.max(.58,.72-c*.025);i-a>=d&&(l({sprinting:u}),a=i)}function d(){e&&(s=!0,e.state===`running`&&e.suspend?.())}function f(){e&&(s=!1,e.state===`suspended`&&e.resume?.())}function p(){return s}return{start:c,update:u,suspend:d,resume:f,isSuspended:p}}var Z=4,qc=3.72,Jc=.22,Yc=3.66,Xc=12,Zc=Z*4.25,Qc=3.2,$c=50,el=24,tl=18,nl=8,rl=.72,il=92,al=72,ol=.22,sl=.32,cl=.66,ll=3,ul=8,dl=36,fl=24,pl=3,ml=8,hl=84,gl=42,_l=.74,vl=Z*7,yl=Z*6.4,bl=.86,xl=10.5,Sl=3,Cl=8,wl=31,Tl=27,El=new Map([[0,{level:0,levelLabel:`LEVEL 0`,levelName:`NOCLIP ZONE`}],[1,{level:1,levelLabel:`LEVEL 1`,levelName:`HABITABLE ZONE`}],[2,{level:2,levelLabel:`LEVEL 2`,levelName:`PIPE DREAMS`}],[3,{level:3,levelLabel:`LEVEL 3`,levelName:`ELECTRICAL STATION`}],[4,{level:4,levelLabel:`LEVEL 4`,levelName:`ABANDONED OFFICE`}]]);function Dl(e=0){return El.get(Number(e))??El.get(0)}var Ol=[{col:19,row:1,width:10,height:7},{col:11,row:3,width:7,height:5},{col:10,row:10,width:9,height:6}],kl=[{col:1,row:20,width:6,height:5},{col:22,row:12,width:6,height:4},{col:3,row:8,width:5,height:5},{col:13,row:18,width:12,height:5},{col:2,row:13,width:4,height:3},{col:24,row:20,width:5,height:4}];function Al(){let e=Array.from({length:Tl},()=>Array.from({length:wl},()=>`#`)),t=(t,n)=>{n>0&&n<Tl-1&&t>0&&t<wl-1&&(e[n][t]=`.`)},n=(e,n,r,i)=>{for(let a=n;a<n+i;a+=1)for(let n=e;n<e+r;n+=1)t(n,a)},r=(e,n,r,i=1)=>{let a=Math.min(e,n),o=Math.max(e,n);for(let e=a;e<=o;e+=1)for(let n=0;n<i;n+=1)t(e,r+n)},i=(e,n,r,i=1)=>{let a=Math.min(n,r),o=Math.max(n,r);for(let n=a;n<=o;n+=1)for(let r=0;r<i;r+=1)t(e+r,n)};return[{col:1,row:20,width:6,height:5},{col:2,row:13,width:4,height:3},{col:3,row:8,width:5,height:5},{col:1,row:1,width:8,height:6},{col:11,row:3,width:7,height:5},{col:10,row:10,width:9,height:6},{col:13,row:18,width:12,height:5},{col:22,row:12,width:6,height:4},{col:19,row:1,width:10,height:7},{col:24,row:20,width:5,height:4}].forEach(e=>n(e.col,e.row,e.width,e.height)),i(3,15,22,1),r(3,14,15,1),i(14,7,15,1),r(14,23,7,2),i(23,5,8,1),r(23,28,5,1),r(5,13,21,2),i(13,15,21,2),r(18,24,14,1),i(24,14,22,1),r(5,11,10,1),i(11,5,10,1),r(8,12,4,1),r(17,22,4,1),[[13,12],[15,12],[17,12],[14,14],[20,4],[23,3],[26,5],[16,20],[20,20],[5,10]].forEach(([t,n])=>{e[n][t]=`#`}),e.map(e=>e.join(``))}var jl=Al(),Ml=jl.length,Nl=jl[0].length,Pl=-(Nl*Z)/2,Fl=-(Ml*Z)/2,Il={col:3,row:23,yaw:-Math.PI*.48},Ll={col:27,row:3},Rl=Z*.8,zl=new Nt,Bl=new dt,Vl=new H(1,1,1),Hl=new H,Ul=new H;function Wl(e,t){return t>=0&&t<Ml&&e>=0&&e<Nl&&jl[t][e]===`.`}function Gl(e,t,n){return e>=n.col&&e<n.col+n.width&&t>=n.row&&t<n.row+n.height}function Kl(e,t,n){return n.some(n=>Gl(e,t,n))}function ql(e,t){return[[0,-1],[0,1],[-1,0],[1,0]].filter(([n,r])=>Wl(e+n,t+r)).length}function Jl(e,t){return{x:Pl+e*Z+Z/2,z:Fl+t*Z+Z/2}}function Yl(e,t){return{col:Math.floor((e-Pl)/Z),row:Math.floor((t-Fl)/Z)}}function Xl(t,n,r,i){let a=document.createElement(`canvas`);a.width=t,a.height=t,n(a.getContext(`2d`),t);let o=new ti(a);return o.wrapS=e,o.wrapT=e,o.repeat.set(r,i),o.colorSpace=Re,o.anisotropy=6,o}function Zl(e){let t=e>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function Ql(e){return Math.max(0,Math.min(255,e))}function $l(e){return e*e*(3-2*e)}function eu(e,t,n){let r=Math.sin((e*127.1+t*311.7+n*74.7)*43758.5453);return r-Math.floor(r)}function tu(e,t,n,r,i){let a=e/n*r,o=t/n*r,s=Math.floor(a),c=Math.floor(o),l=(s+1)%r,u=(c+1)%r,d=$l(a-s),f=$l(o-c),p=eu(s%r,c%r,i),m=eu(l,c%r,i),h=eu(s%r,u,i),g=eu(l,u,i),_=p+(m-p)*d;return _+(h+(g-h)*d-_)*f}function nu(e,t,n,r,i=`0,0,0`,a=Math.random){for(let o=0;o<n;o+=1){let n=a()*t,o=a()*t,s=a()*2.4+.35;e.fillStyle=`rgba(${i},${a()*r})`,e.beginPath(),e.arc(n,o,s,0,Math.PI*2),e.fill()}}function ru(){let e=Zl(12241920),n=Xl(512,(t,n)=>{let r=t.createImageData(n,n),i=r.data;for(let t=0;t<n;t+=1)for(let r=0;r<n;r+=1){let a=(t*n+r)*4,o=Math.sin(r*.045)*2.2,s=(tu(r,t,n,18,2.7)-.5)*6+(e()-.5)*4,c=Math.max(0,Math.abs(t/n-.5)-.36)*5;i[a]=Ql(222+o+s-c),i[a+1]=Ql(214+o*.8+s-c),i[a+2]=Ql(153+o*.45+s*.55),i[a+3]=255}t.putImageData(r,0,0);for(let e=0;e<=n;e+=74)t.fillStyle=`rgba(112,100,55,0.08)`,t.fillRect(e-1,0,2,n),t.fillStyle=`rgba(245,235,174,0.08)`,t.fillRect(e+2,0,1,n);t.strokeStyle=`rgba(66,78,58,0.2)`,t.lineWidth=.9;for(let r=-38;r<n+38;r+=38)for(let i=-34;i<n+34;i+=34){let n=(e()-.5)*1.2;t.beginPath(),t.moveTo(i+10+n,r+4),t.lineTo(i+18+n,r+17),t.lineTo(i+10+n,r+31),t.moveTo(i+24-n,r+4),t.lineTo(i+16-n,r+17),t.lineTo(i+24-n,r+31),t.stroke(),t.fillStyle=`rgba(65,74,55,0.14)`,t.fillRect(i+16,r+18,1.2,1.2)}for(let r=0;r<12;r+=1){let r=e()*n,i=e()*n,a=18+e()*48,o=t.createRadialGradient(r,i,0,r,i,a);o.addColorStop(0,`rgba(96,82,44,0.035)`),o.addColorStop(1,`rgba(96,82,44,0)`),t.fillStyle=o,t.beginPath(),t.arc(r,i,a,0,Math.PI*2),t.fill()}nu(t,n,300,.07,`76,68,38`,e),nu(t,n,110,.06,`238,226,169`,e)},1.85,1.05);return n.wrapT=t,n.needsUpdate=!0,n}function iu(){let e=Zl(13278980);return Xl(512,(t,n)=>{let r=t.createImageData(n,n),i=r.data;for(let t=0;t<n;t+=1)for(let r=0;r<n;r+=1){let a=(t*n+r)*4,o=r/n,s=t/n,c=(tu(r,t,n,4,4.1)-.5)*12,l=(tu(r,t,n,11,8.7)-.5)*7,u=(e()-.5)*4,d=Math.sin(Math.PI*2*(o*18+s*2))*.55+Math.sin(Math.PI*2*(o*7-s*3))*.45,f=c+l+u+d;i[a]=Ql(185+f),i[a+1]=Ql(165+f*.78),i[a+2]=Ql(120+f*.5),i[a+3]=255}t.putImageData(r,0,0),t.globalAlpha=.028;for(let e=0;e<n;e+=5){let r=Math.sin(e/n*Math.PI*2*4)*.8;t.strokeStyle=e%10==0?`#8b774e`:`#ddc48c`,t.lineWidth=.55,t.beginPath(),t.moveTo(0,e+r),t.lineTo(n,e+r),t.stroke()}t.globalAlpha=1,nu(t,n,1500,.055,`72,58,32`,e)},7.5,7.5)}function au(){let e=Zl(13504793);return Xl(512,(t,n)=>{t.fillStyle=`#d6cfaa`,t.fillRect(0,0,n,n);let r=t.createLinearGradient(0,0,n,n);r.addColorStop(0,`rgba(255,250,224,0.12)`),r.addColorStop(1,`rgba(105,99,68,0.1)`),t.fillStyle=r,t.fillRect(0,0,n,n),t.strokeStyle=`rgba(85,82,58,0.24)`,t.lineWidth=5,t.strokeRect(0,0,n,n),t.strokeStyle=`rgba(245,239,200,0.12)`,t.lineWidth=1.5,t.strokeRect(9,9,n-18,n-18);for(let r=0;r<7;r+=1){let r=e()*n,i=e()*n,a=26+e()*58,o=t.createRadialGradient(r,i,0,r,i,a);o.addColorStop(0,`rgba(92,80,43,0.065)`),o.addColorStop(1,`rgba(92,80,43,0)`),t.fillStyle=o,t.beginPath(),t.arc(r,i,a,0,Math.PI*2),t.fill()}nu(t,n,1500,.08,`91,86,58`,e),nu(t,n,260,.05,`238,231,190`,e)},20,18)}function ou(e,t,n){let r=document.createElement(`canvas`);r.width=1024,r.height=410;let i=r.getContext(`2d`);i.fillStyle=t,i.fillRect(0,0,r.width,r.height),i.fillStyle=n;let a=r.width*.82,o=220;do i.font=`bold ${o}px Arial, sans-serif`,o-=8;while(i.measureText(e).width>a&&o>78);i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e,r.width/2,r.height/2+8),i.strokeStyle=`rgba(0,0,0,0.24)`,i.lineWidth=20,i.strokeRect(18,18,r.width-36,r.height-36);let s=new ti(r);return s.colorSpace=Re,s.anisotropy=6,s}function su(e,t,n,r,i){let a=new H(...e),o=new H(...t),s=a.clone().add(o).multiplyScalar(.5),c=o.clone().sub(a),l=new K(new si(n,r,c.length(),18,1),i);return l.position.copy(s),l.quaternion.setFromUnitVectors(new H(0,1,0),c.normalize()),l}function cu(e){return null}function lu(e){return e?`YELLOW HAZMAT`:`NONE`}function uu(e,t,n){if(!e)return;e.userData.previousPlayerPosition||(e.userData.previousPlayerPosition=n.clone());let r=e.userData.previousPlayerPosition,i=Math.hypot(n.x-r.x,n.z-r.z);r.copy(n);let a=Math.min(1,i*18),o=Math.sin(t*1.8)*.006,s=Math.sin(t*9.5)*.012*a,c=Math.sin(t*6.8)*.012*a;e.position.set(c,o+s,0),e.rotation.set(Math.sin(t*5.2)*.012*a,Math.sin(t*4.4)*.012*a,-c*.18)}function du(e,t,n,r){let i=new Gr(t,n,r.length);return r.forEach((e,t)=>{zl.compose(e,Bl,Vl),i.setMatrixAt(t,zl)}),i.instanceMatrix.needsUpdate=!0,e.add(i),i}function fu(e,t,{rangeScale:n,intensityScale:r,decay:i=2}){let a=new oa(e.color,e.baseIntensity*r,e.range*n,i);return a.position.set(e.x,t,e.z),a.userData.intensityScale=r,a}function pu(e,t,n=1){e.light&&(e.light.intensity=t*e.baseIntensity*(e.light.userData.intensityScale??n))}function mu(e,{dimBelow:t,normalAbove:n,dimDelay:r=.42,normalDelay:i=.62}){let a=e,o=0,s=i;return(c,l)=>(l<t?(o+=c,s=0):l>n?(s+=c,o=0):(o=0,s=0),o>=r&&(a=`DIM`),s>=i&&(a=e),a)}function hu(n=`normal`){let r=n===`super`,i=document.createElement(`canvas`);i.width=512,i.height=256;let a=i.getContext(`2d`);a.fillStyle=r?`#fff0a8`:`#f5f0d4`,a.fillRect(0,0,i.width,i.height),a.fillStyle=r?`#9f7216`:`#2f6f94`,a.fillRect(0,0,i.width,42),a.fillRect(0,i.height-44,i.width,44);let o=a.getImageData(0,0,i.width,i.height);for(let e=0;e<o.data.length;e+=4){let t=(Math.random()-.5)*12;o.data[e]=Ql(o.data[e]+t),o.data[e+1]=Ql(o.data[e+1]+t),o.data[e+2]=Ql(o.data[e+2]+t)}a.putImageData(o,0,0),a.fillStyle=r?`#fff8c4`:`#f9f5df`,a.fillRect(58,54,292,134),a.strokeStyle=r?`rgba(117, 74, 0, 0.5)`:`rgba(35, 76, 79, 0.42)`,a.lineWidth=4,a.strokeRect(58,54,292,134),a.fillStyle=r?`#754300`:`#234c4f`,a.font=r?`900 28px Arial, sans-serif`:`900 34px Arial, sans-serif`,a.fillText(r?`SUPER`:`ALMOND`,r?98:82,98),a.font=r?`900 27px Arial, sans-serif`:`900 32px Arial, sans-serif`,a.fillText(r?`ALMOND WATER`:`WATER`,r?74:102,138),a.font=`700 11px Arial, sans-serif`,a.fillStyle=r?`#8e5d05`:`#5f6542`,a.fillText(r?`RARE GOLDEN SUPPLY`:`LEVEL 0 SUPPLY`,r?91:106,164),a.fillText(r?`250 CAP / RECOVERY x2`:`+50 STAMINA BOOST`,r?74:83,181),a.fillStyle=r?`#ffd33f`:`#dccb83`,a.beginPath(),a.ellipse(304,120,28,45,-.12,0,Math.PI*2),a.fill(),a.strokeStyle=r?`rgba(116, 65, 0, 0.48)`:`rgba(96, 82, 38, 0.35)`,a.lineWidth=3,a.stroke(),a.strokeStyle=r?`rgba(125, 74, 0, 0.54)`:`rgba(86, 76, 34, 0.42)`,a.lineWidth=2;for(let e=0;e<5;e+=1)a.beginPath(),a.moveTo(286+e*7,84+e*6),a.bezierCurveTo(302,110,302,132,287+e*6,156-e*5),a.stroke();a.fillStyle=r?`#80520b`:`#18303a`;for(let e=384;e<462;e+=4){let t=e%12==0?3:1;a.fillRect(e,78,t,88)}a.font=`700 10px Arial, sans-serif`,a.fillStyle=r?`#9a6714`:`#24414a`,a.fillText(r?`NOT FOR EVERYONE`:`NOT FROM HERE`,r?366:374,190);let s=new ti(i);return s.colorSpace=Re,s.wrapS=e,s.wrapT=t,s.anisotropy=2,s.needsUpdate=!0,s}function gu(e=`normal`){let t=e===`super`,n=new cn;n.name=t?`super-almond-water-model`:`almond-water-model`;let r=new wi({color:t?16770410:14285823,emissive:t?10317064:2846586,emissiveIntensity:t?.18:.08,roughness:.12,metalness:0,transmission:t?.12:.18,transparent:!0,opacity:t?.5:.42,thickness:.22}),i=new J({color:t?16761919:12246992,emissive:t?16757795:9157539,emissiveIntensity:t?.32:.18,roughness:.38,transparent:!0,opacity:t?.78:.72}),a=new J({map:hu(e),color:16777215,emissive:t?16764756:14149309,emissiveIntensity:t?.18:.08,roughness:.62,side:2}),o=new J({color:t?11629832:2313840,emissive:t?3547648:464159,emissiveIntensity:t?.28:.22,roughness:.46,metalness:t?.2:.12}),s=new Sr({color:t?3350533:1910552,transparent:!0,opacity:t?.26:.2,depthWrite:!1}),c=new K(new li([new V(.108,.02),new V(.158,.06),new V(.174,.15),new V(.174,.52),new V(.138,.6),new V(.086,.66),new V(.084,.78),new V(.102,.81)],32),r);n.add(c);let l=new K(new li([new V(.098,.06),new V(.145,.09),new V(.151,.16),new V(.151,.48),new V(.116,.53),new V(.078,.58)],28),i);n.add(l);let u=new K(new si(.181,.181,.255,32,1,!0),a);u.position.y=.35,n.add(u);let d=new K(new si(.102,.108,.09,24),o);d.position.y=.855,n.add(d);for(let e=0;e<3;e+=1){let t=new K(new pi(.106,.0045,6,24),o);t.rotation.x=Math.PI/2,t.position.y=.824+e*.027,n.add(t)}let f=new K(new oi(.33,32),s);return f.rotation.x=-Math.PI/2,f.position.y=.012,n.add(f),n.traverse(e=>{e.isMesh&&(e.userData.itemId=t?`super-almond-water`:`almond-water`)}),n}function _u(e,{cols:t,rows:n,isCellOpen:r,getCellCenter:i,avoidPositions:a=[],blockedAabbs:o=[],variant:s=`normal`,respawnMin:c=el,respawnVariance:l=tl,initialSpawnChance:u=1,respawnChance:d=1}){let f=s===`super`,p=f?`super-almond-water`:`almond-water`,m=[];for(let e=0;e<n;e+=1)for(let n=0;n<t;n+=1){if(!r(n,e))continue;let t=i(n,e),s=a.every(e=>Math.hypot(t.x-e.x,t.z-e.z)>Z*4),c=o.every(e=>!hd(t.x,t.z,Qc,e));s&&c&&m.push({col:n,row:e,x:t.x,z:t.z})}let h=new cn;h.name=f?`super-almond-water-pickup`:`almond-water-pickup`;let g=gu(s);g.scale.setScalar(f?cl:rl),h.add(g);let _=new K(new di(f?.3:.26,f?.46:.38,32),new Sr({color:f?16767075:15662035,transparent:!0,opacity:f?.18:.13,depthWrite:!1,side:2}));_.rotation.x=-Math.PI/2,_.position.y=.02,h.add(_),e.add(h);let v=!1,y=0,b=0;function x(){return m[Math.floor(Math.random()*m.length)]??m[0]}function S(){h.visible=!1,v=!1,y=c+Math.random()*l}function C(){let e=x();if(!e){h.visible=!1,v=!1;return}h.position.set(e.x,0,e.z),h.rotation.y=Math.random()*Math.PI*2,h.visible=!0,v=!0}function w(e=1){if(Math.random()>e){S();return}C()}return w(u),{inspect(e){if(!v||!e)return null;e.getWorldDirection(Hl),Ul.set(h.position.x,h.position.y+.34,h.position.z).sub(e.position);let t=Ul.length();if(t>nl)return null;Ul.normalize();let n=Math.min(.13,Math.max(.048,Math.atan2(.42,t)));return Hl.dot(Ul)<Math.cos(n)?null:{id:p,name:f?`SUPER ALMOND WATER`:`ALMOND WATER`,effect:f?`250 STAMINA CAP / RECOVERY x2`:`+50 STAMINA CAPACITY / 45s`,action:`F / BUTTON PICK UP`,distance:t}},update(e,t,n){if(!v)return y-=e,y<=0&&w(d),{visible:!1,available:!1,distance:1/0,respawn:Math.max(0,y)};h.position.y=Math.sin(t*(f?2.8:2.4))*(f?.045:.035),h.rotation.y+=e*(f?.62:.45),_.material.opacity=(f?.14:.1)+Math.sin(t*(f?3.8:3.2))*.045+.045;let r=Math.hypot(n.x-h.position.x,n.z-h.position.z);return{visible:!0,available:r<=Qc,distance:r,respawn:0}},tryPickup(e){return!v||Math.hypot(e.x-h.position.x,e.z-h.position.z)>Qc?{pickedUp:!1}:(b+=1,v=!1,h.visible=!1,y=c+Math.random()*l,{pickedUp:!0,itemId:p,count:b,staminaBonus:f?void 0:$c})}}}function vu(){let e=new cn;e.name=`flashlight-model`;let t=new J({color:2040867,emissive:395271,emissiveIntensity:.12,roughness:.46,metalness:.42}),n=new J({color:724493,roughness:.78,metalness:.2}),r=new J({color:16318423,emissive:15525798,emissiveIntensity:.34,roughness:.2,metalness:.02}),i=new J({color:2107178,emissive:462870,emissiveIntensity:.08,roughness:.56,metalness:.18}),a=new Sr({color:395271,transparent:!0,opacity:.24,depthWrite:!1}),o=new K(new si(.09,.105,.62,20),t);o.rotation.z=Math.PI/2,o.position.set(0,.13,0),e.add(o);let s=new K(new si(.15,.112,.18,20),t);s.rotation.z=Math.PI/2,s.position.set(.39,.13,0),e.add(s);let c=new K(new si(.118,.118,.018,20),r);c.rotation.z=Math.PI/2,c.position.set(.49,.13,0),e.add(c);let l=new K(new si(.096,.088,.09,18),n);l.rotation.z=Math.PI/2,l.position.set(-.36,.13,0),e.add(l);for(let t=0;t<5;t+=1){let r=new K(new pi(.104,.0045,6,20),n);r.rotation.y=Math.PI/2,r.position.set(-.22+t*.074,.13,0),e.add(r)}let u=new K(new q(.12,.026,.06),i);u.position.set(.07,.235,0),e.add(u);let d=new K(new oi(.54,28),a);return d.rotation.x=-Math.PI/2,d.scale.z=.42,d.position.y=.011,e.add(d),e.traverse(e=>{e.isMesh&&(e.userData.itemId=`flashlight`)}),e}function yu(e,{cols:t,rows:n,isCellOpen:r,getCellCenter:i,avoidPositions:a=[],blockedAabbs:o=[]}){let s=[];for(let e=0;e<n;e+=1)for(let n=0;n<t;n+=1){if(!r(n,e))continue;let t=i(n,e),c=a.every(e=>Math.hypot(t.x-e.x,t.z-e.z)>Z*4.2),l=o.every(e=>!hd(t.x,t.z,ll,e));c&&l&&s.push({col:n,row:e,x:t.x,z:t.z})}let c=new cn;c.name=`flashlight-pickup`,c.add(vu());let l=new K(new di(.42,.58,32),new Sr({color:12051711,transparent:!0,opacity:.12,depthWrite:!1,side:2}));l.rotation.x=-Math.PI/2,l.position.y=.018,c.add(l),e.add(c);let u=!1,d=0,f=0;function p(){return s[Math.floor(Math.random()*s.length)]??s[0]}function m(){let e=p();if(!e){c.visible=!1,u=!1;return}c.position.set(e.x,0,e.z),c.rotation.y=Math.random()*Math.PI*2,c.visible=!0,u=!0}return m(),{inspect(e){if(!u||!e)return null;e.getWorldDirection(Hl),Ul.set(c.position.x,c.position.y+.2,c.position.z).sub(e.position);let t=Ul.length();if(t>ul)return null;Ul.normalize();let n=Math.min(.15,Math.max(.055,Math.atan2(.5,t)));return Hl.dot(Ul)<Math.cos(n)?null:{id:`flashlight`,name:`FLASHLIGHT`,effect:`FORWARD BEAM / LIMITED BATTERY`,action:`F / BUTTON PICK UP`,distance:t}},update(e,t,n){if(!u)return d-=e,d<=0&&m(),{visible:!1,available:!1,distance:1/0,respawn:Math.max(0,d)};c.position.y=Math.sin(t*1.9+1.6)*.018,l.material.opacity=.08+Math.sin(t*2.8)*.034+.034;let r=Math.hypot(n.x-c.position.x,n.z-c.position.z);return{visible:!0,available:r<=ll,distance:r,respawn:0}},tryPickup(e){return!u||Math.hypot(e.x-c.position.x,e.z-c.position.z)>ll?{pickedUp:!1}:(f+=1,u=!1,c.visible=!1,d=dl+Math.random()*fl,{pickedUp:!0,itemId:`flashlight`,count:f})}}}function bu(){let e=new cn;e.name=`entity-detector-model`;let t=new J({color:2762273,emissive:1181702,emissiveIntensity:.12,roughness:.64,metalness:.28}),n=new J({color:1121048,emissive:16737613,emissiveIntensity:.28,roughness:.38,metalness:.08}),r=new J({color:12080696,emissive:4591622,emissiveIntensity:.26,roughness:.5,metalness:.16}),i=new Sr({color:591108,transparent:!0,opacity:.24,depthWrite:!1}),a=new K(new q(.42,.2,.28),t);a.position.y=.17,e.add(a);let o=new K(new q(.25,.022,.16),n);o.position.set(.02,.286,0),e.add(o);let s=new K(new si(.012,.012,.42,8),r);s.position.set(-.16,.46,-.02),s.rotation.z=-.32,e.add(s);let c=new K(new pi(.11,.009,6,24),r);c.position.set(-.22,.66,-.03),c.rotation.x=Math.PI/2,e.add(c);for(let t=0;t<3;t+=1){let n=new K(new q(.035,.012,.035),r);n.position.set(-.05+t*.055,.304,-.055+t*.018),e.add(n)}let l=new K(new oi(.38,28),i);return l.rotation.x=-Math.PI/2,l.scale.z=.55,l.position.y=.011,e.add(l),e.traverse(e=>{e.isMesh&&(e.userData.itemId=`detector`)}),e}function xu(e,{cols:t,rows:n,isCellOpen:r,getCellCenter:i,avoidPositions:a=[],blockedAabbs:o=[]}){let s=[];for(let e=0;e<n;e+=1)for(let n=0;n<t;n+=1){if(!r(n,e))continue;let t=i(n,e),c=a.every(e=>Math.hypot(t.x-e.x,t.z-e.z)>Z*4.5),l=o.every(e=>!hd(t.x,t.z,pl,e));c&&l&&s.push({col:n,row:e,x:t.x,z:t.z})}let c=new cn;c.name=`entity-detector-pickup`,c.add(bu());let l=new K(new di(.38,.52,32),new Sr({color:16747368,transparent:!0,opacity:.12,depthWrite:!1,side:2}));l.rotation.x=-Math.PI/2,l.position.y=.018,c.add(l),e.add(c);let u=!1,d=0,f=0;function p(){return s[Math.floor(Math.random()*s.length)]??s[0]}function m(){let e=p();if(!e){c.visible=!1,u=!1;return}c.position.set(e.x,0,e.z),c.rotation.y=Math.random()*Math.PI*2,c.visible=!0,u=!0}return m(),{inspect(e){if(!u||!e)return null;e.getWorldDirection(Hl),Ul.set(c.position.x,c.position.y+.26,c.position.z).sub(e.position);let t=Ul.length();if(t>ml)return null;Ul.normalize();let n=Math.min(.15,Math.max(.055,Math.atan2(.5,t)));return Hl.dot(Ul)<Math.cos(n)?null:{id:`detector`,name:`ENTITY DETECTOR`,effect:`WIDE ENTITY PING / 5s SCAN`,action:`F / BUTTON PICK UP`,distance:t}},update(e,t,n){if(!u)return d-=e,d<=0&&m(),{visible:!1,available:!1,distance:1/0,respawn:Math.max(0,d)};c.position.y=Math.sin(t*2.1+.8)*.018,l.material.opacity=.08+Math.sin(t*3.4)*.038+.04;let r=Math.hypot(n.x-c.position.x,n.z-c.position.z);return{visible:!0,available:r<=pl,distance:r,respawn:0}},tryPickup(e){return!u||Math.hypot(e.x-c.position.x,e.z-c.position.z)>pl?{pickedUp:!1}:(f+=1,u=!1,c.visible=!1,d=hl+Math.random()*gl,{pickedUp:!0,itemId:`detector`,count:f})}}}function Su(){let e=new cn;e.name=`bacteria-lifeform`;let t=new J({color:328451,emissive:1508355,emissiveIntensity:.18,roughness:.86,metalness:0}),n=new J({color:1445902,emissive:3868934,emissiveIntensity:.22,roughness:.74,metalness:0}),r=new Sr({color:16727330,transparent:!0,opacity:.78}),i=new K(new si(.12,.2,1.45,10),t);i.position.y=1.12,i.rotation.z=.08,e.add(i);let a=new K(new fi(.18,16,10),t);a.position.set(.03,1.94,0),a.scale.set(.78,1.12,.7),e.add(a);let o=new K(new q(.16,.024,.035),r);o.position.set(.03,1.9,-.145),e.add(o),[[[-.12,1.58,0],[-.6,.72,-.12],.028,.02],[[.13,1.54,0],[.55,.68,-.1],.028,.02],[[-.08,.56,0],[-.36,.02,-.08],.036,.024],[[.09,.56,0],[.34,.02,-.07],.036,.024],[[.01,1.72,.02],[-.2,1.2,.34],.015,.009],[[.02,1.76,.02],[.26,1.12,.3],.015,.009]].forEach(([t,r,i,a])=>{e.add(su(t,r,i,a,n))});for(let t=0;t<7;t+=1){let t=su([(Math.random()-.5)*.16,1.4+Math.random()*.45,.03],[(Math.random()-.5)*.64,.55+Math.random()*.55,.18+Math.random()*.28],.009,.004,n);e.add(t)}return e}function Cu(){let e=new cn;e.name=`hound-entity`;let t=new J({color:722951,emissive:1377797,emissiveIntensity:.22,roughness:.9,metalness:0}),n=new J({color:2299154,emissive:2492166,emissiveIntensity:.18,roughness:.82}),r=new Sr({color:16730916,transparent:!0,opacity:.88}),i=new K(new ai(.22,.78,8,16),t);i.position.set(0,.72,0),i.rotation.z=Math.PI/2,i.scale.set(1.12,.78,.88),e.add(i);let a=new K(new fi(.24,18,12),t);a.position.set(0,.78,-.34),a.scale.set(.92,1.1,.82),e.add(a);let o=new K(new fi(.18,16,12),t);o.position.set(0,.94,-.62),o.scale.set(.82,.74,1.34),e.add(o);let s=new K(new si(.045,.09,.2,10),n);s.rotation.x=Math.PI/2,s.position.set(0,.9,-.78),e.add(s),[-1,1].forEach(n=>{let i=new K(new fi(.026,10,8),r);i.position.set(n*.064,.99,-.76),e.add(i);let a=new K(new ci(.055,.16,8),t);a.position.set(n*.11,1.08,-.6),a.rotation.z=-n*.34,e.add(a)}),[[-.18,-.32],[.18,-.32],[-.18,.32],[.18,.32]].forEach(([t,r],i)=>{let a=su([t,.62,r],[t*1.18,.32,r-(i<2?.18:-.1)],.042,.03,n),o=su([t*1.18,.32,r-(i<2?.18:-.1)],[t*1.34,.06,r-(i<2?.28:-.2)],.028,.02,n);e.add(a,o)});let c=su([0,.8,.48],[.08,.92,.84],.032,.012,n);return e.add(c),e}function wu({cols:e,rows:t,isCellOpen:n,getCellCenter:r,targetPosition:i,spawnPosition:a,avoidPositions:o=[],minSeparation:s=Z*5}){let c=[];for(let l=0;l<t;l+=1)for(let t=0;t<e;t+=1){if(!n(t,l))continue;let e=r(t,l),u=Math.hypot(e.x-i.x,e.z-i.z),d=Math.hypot(e.x-a.x,e.z-a.z),f=o.every(t=>Math.hypot(e.x-t.x,e.z-t.z)>=s);u<=yl&&d>=vl&&f&&c.push({...e,score:u+Math.random()*Z})}return c.sort((e,t)=>e.score-t.score),c}function Tu({cols:e,rows:t,isCellOpen:n,getCellCenter:r,targetPosition:i,spawnPosition:a,count:o}){let s=wu({cols:e,rows:t,isCellOpen:n,getCellCenter:r,targetPosition:i,spawnPosition:a}),c=[];for(let e of s){if(c.length>=o)break;c.every(t=>Math.hypot(e.x-t.x,e.z-t.z)>=Z*6)&&c.push(e)}for(;c.length<o&&s.length>0;)c.push(s[c.length%s.length]);return c}function Eu(e,t,n,r){let i=e.x+t,a=e.z+n;if(r(i,a,.32))return{x:i,z:a};if(Math.abs(t)>Math.abs(n)){if(r(i,e.z,.32))return{x:i,z:e.z};if(r(e.x,a,.32))return{x:e.x,z:a}}else{if(r(e.x,a,.32))return{x:e.x,z:a};if(r(i,e.z,.32))return{x:i,z:e.z}}return{x:e.x,z:e.z}}function Du(e,{spawnPosition:t,isWalkable:n,speed:r=1.05,id:i=`bacteria`}){let a=Su();a.position.set(t.x,0,t.z),a.rotation.y=Math.random()*Math.PI*2,e.add(a);let o=!1;return{update(e,t,s){let c=s.x-a.position.x,l=s.z-a.position.z,u=Math.hypot(c,l);if(u>.001&&!o){let t=Math.min(u,r*e),i=Eu(a.position,c/u*t,l/u*t,n);a.position.x=i.x,a.position.z=i.z,a.rotation.y=Math.atan2(c,l)}let d=Math.sin(t*2.1)*.04;return a.position.y=Math.sin(t*3.6)*.025,a.rotation.z=d,o||=u<=_l,{id:i,active:!0,contact:o,distance:u,x:a.position.x,y:1.45,z:a.position.z}}}}function Ou(e,{spawnPosition:t,isWalkable:n,speed:r=1.45,id:i=`hound`}){let a=Cu();a.position.set(t.x,0,t.z),a.rotation.y=Math.random()*Math.PI*2,e.add(a);let o=!1;return{update(e,t,s){let c=s.x-a.position.x,l=s.z-a.position.z,u=Math.hypot(c,l);if(u>.001&&!o){let i=.78+Math.sin(t*1.9)*.12,o=Math.min(u,r*i*e),s=Eu(a.position,c/u*o,l/u*o,n);a.position.x=s.x,a.position.z=s.z,a.rotation.y=Math.atan2(c,l)}let d=Math.sin(t*7.2)*.035;return a.position.y=Math.abs(Math.sin(t*5.4))*.028,a.rotation.z=d,o||=u<=bl,{id:i,active:!0,contact:o,distance:u,x:a.position.x,y:.9,z:a.position.z}}}}function ku(e,t,{distanceLimit:n,height:r=1.2,radius:i=.55}){if(!e||!t)return null;e.getWorldDirection(Hl),Ul.set(t.x,(t.y??0)+r,t.z).sub(e.position);let a=Ul.length();if(a>n)return null;Ul.normalize();let o=Math.min(.18,Math.max(.045,Math.atan2(i,a)));return Hl.dot(Ul)<Math.cos(o)?null:a}function Au(e,t=[]){return t.filter(e=>e?.active).map(t=>{let n=ku(e,{x:t.x,y:0,z:t.z},{distanceLimit:xl,height:t.y??1.2,radius:t.id===`hound`?.8:.58});return n===null?null:{id:t.id,type:`entity`,distance:n,active:t.active}}).filter(Boolean).sort((e,t)=>e.distance-t.distance)[0]??null}function ju({id:e,position:t,radius:n=Sl,inspectDistance:r=Cl,inspectHeight:i=1.18,inspectRadius:a=.68,responseKey:o}){let s=0;return{id:e,inspect(o,s){let c=ku(o,t,{distanceLimit:r,height:i,radius:a});if(c===null)return null;let l=Math.hypot(s.x-t.x,s.z-t.z);return{id:e,type:`interaction`,distance:c,available:l<=n,rangeDistance:l}},interact(r){return Math.hypot(r.x-t.x,r.z-t.z)>n?{interacted:!1}:(s+=1,{interacted:!0,id:e,textKey:o??`${e}Response`,count:s})}}}function Mu(e,t,n=[]){return n.map(n=>n.inspect(e,t)).filter(Boolean).sort((e,t)=>e.distance-t.distance)[0]??null}function Nu(e,...t){for(let n of t){let t=n.interact(e);if(t?.interacted)return t}return{interacted:!1}}function Pu(...e){return e.filter(Boolean).sort((e,t)=>e.distance-t.distance)[0]??null}function Fu(e,...t){for(let n of t){let t=n.tryPickup(e);if(t?.pickedUp)return t}return{pickedUp:!1}}function Iu(e,t){let n=[],r=new Set(t.map((e,t)=>({index:t,priority:e.priority})).sort((e,t)=>t.priority-e.priority).slice(0,Xc).map(({index:e})=>e)),i=new q(1,.035,.36),a=new q(1,.03,.52),o=new J({color:10326616,emissive:4866080,emissiveIntensity:.12,roughness:.88,metalness:.02});return t.forEach((t,s)=>{let c=new J({color:t.color,emissive:t.color,emissiveIntensity:t.baseIntensity,roughness:.28}),l=new K(a,o);l.position.set(t.x,Yc-.055,t.z),l.rotation.y=t.rotation,l.scale.x=t.panelWidth+.24,e.add(l);let u=new K(i,c);u.position.set(t.x,Yc-.09,t.z),u.rotation.y=t.rotation,u.scale.x=t.panelWidth,e.add(u);let d=null;t.hasPointLight&&r.has(s)&&(d=fu(t,Yc-.25,{rangeScale:1.48,intensityScale:1.22}),e.add(d)),n.push({panel:u,material:c,light:d,phase:t.phase,speed:t.speed,baseIntensity:t.baseIntensity,weak:t.weak})}),n}function Lu(e){let t=Yl(e.x,e.z),n=[{col:t.col,row:t.row-1,x:e.x,z:e.z-Z/2+Jc*.62,rotation:0},{col:t.col,row:t.row+1,x:e.x,z:e.z+Z/2-Jc*.62,rotation:Math.PI},{col:t.col-1,row:t.row,x:e.x-Z/2+Jc*.62,z:e.z,rotation:Math.PI/2},{col:t.col+1,row:t.row,x:e.x+Z/2-Jc*.62,z:e.z,rotation:-Math.PI/2}];return n.find(e=>!Wl(e.col,e.row))??n[1]}function Ru(e,t){let n=new J({map:ou(`EXIT`,`#172d1d`,`#a5ffba`),color:16777215,emissive:4194162,emissiveIntensity:.55,roughness:.42,side:2}),r=Lu(t),i=new K(new ui(2.15,.78),n);i.position.set(r.x,1.72,r.z),i.rotation.y=r.rotation,e.add(i);let a=new Sr({color:8257425,transparent:!0,opacity:.18,depthWrite:!1,side:2}),o=new K(new ui(Z*.82,Z*.82),a);o.rotation.x=-Math.PI/2,o.position.set(t.x,.034,t.z),e.add(o);let s=new oa(7208847,1.15,8.4,2.1);s.position.set(t.x,1.35,t.z),e.add(s)}function zu(e){let t=new Sr({color:4864534,transparent:!0,opacity:.035,depthWrite:!1}),n=new Sr({color:16772506,transparent:!0,opacity:.055,depthWrite:!1}),r=(t,n,r)=>{let i=t.width*Z,a=t.height*Z,o=new K(new ui(i,a),n);o.rotation.x=-Math.PI/2,o.position.set(Pl+t.col*Z+i/2,r,Fl+t.row*Z+a/2),e.add(o)};kl.forEach(e=>r(e,t,.018)),Ol.forEach(e=>r(e,n,.022))}function Bu(){let e=[],t=[],n=[];for(let r=0;r<Ml;r+=1)for(let i=0;i<Nl;i+=1){if(!Wl(i,r))continue;let a=Jl(i,r),o=Kl(i,r,Ol),s=Kl(i,r,kl),c=ql(i,r)>=3;if(!Wl(i,r-1)){let t=new H(a.x,qc/2,a.z-Z/2);e.push(t)}if(!Wl(i,r+1)){let t=new H(a.x,qc/2,a.z+Z/2);e.push(t)}if(!Wl(i-1,r)){let e=new H(a.x-Z/2,qc/2,a.z);t.push(e)}if(!Wl(i+1,r)){let e=new H(a.x+Z/2,qc/2,a.z);t.push(e)}let l=(i*37+r*19)%11,u=i%6==3&&r%4==1,d=i%5==2&&r%4==1,f=Wl(i-1,r)&&Wl(i+1,r),p=Wl(i,r-1)&&Wl(i,r+1),m=!c&&(f||p)&&r%5==2&&i%6==3;(o&&d||!s&&c&&u||!s&&m||s&&u&&(r+i)%2==0)&&n.push({x:a.x,z:a.z,rotation:0,phase:i*.83+r*1.17,speed:s?5+i*r%5:2.6+i*r%4*.45,weak:s?.18:o?0:c?.04:.08,range:o?14.8:s?8.6:11.4,baseIntensity:o?1.78:s?.74:1.24,panelWidth:o?2.95:c?2.58:2.08,color:s?15194015:16775647,hasPointLight:o||c||m&&l<=2,priority:(o?4:0)+(c?2:0)-!!s})}let r=[],i=Jl(Il.col,Il.row),a=Jl(Ll.col,Ll.row);return n.push({x:i.x,z:i.z,rotation:0,phase:.2,speed:2.2,weak:.02,range:13.6,baseIntensity:1.46,panelWidth:2.72,color:16775647,hasPointLight:!0,priority:8},{x:a.x,z:a.z,rotation:0,phase:1.4,speed:2.4,weak:.02,range:13.2,baseIntensity:1.42,panelWidth:2.72,color:16775647,hasPointLight:!0,priority:7}),n.sort((e,t)=>t.priority-e.priority).forEach(e=>{r.some(t=>Math.hypot(t.x-e.x,t.z-e.z)<Zc)||r.push(e)}),{northSouth:e,eastWest:t,fixturePositions:r}}function Vu(){let e=new _n,t=14209184;e.background=new G(t),e.fog=new gn(t,.0095);let n=new na(72,1,.05,Math.hypot(Nl*Z,Ml*Z)+Z*2),r=cu(n);e.add(n);let i=Jl(Il.col,Il.row),a={x:i.x,z:i.z,yaw:Il.yaw},o=Jl(Ll.col,Ll.row),s=iu(),c=ru(),l=au(),u=new J({map:s,color:16181702,emissive:9073737,emissiveIntensity:.2,roughness:.98}),d=new J({map:c,color:16776419,emissive:6642484,emissiveIntensity:.11,roughness:.92,metalness:0}),f=new J({map:l,color:16775135,emissive:12628090,emissiveIntensity:.4,roughness:.86}),p=new J({color:13088632,emissive:5786660,emissiveIntensity:.1,roughness:.98,metalness:0}),m=[d,d,p,p,d,d],h=new K(new ui(Nl*Z,Ml*Z),u);h.rotation.x=-Math.PI/2,h.position.set(0,0,0),e.add(h);let g=new K(new ui(Nl*Z,Ml*Z),f);g.rotation.x=Math.PI/2,g.position.set(0,Yc,0),e.add(g);let{northSouth:_,eastWest:v,fixturePositions:y}=Bu();du(e,new q(4.22,qc,Jc),m,_),du(e,new q(Jc,qc,4.22),m,v);let b=new Wi(16775388,12164456,1.44);e.add(b);let x=new la(16775384,.32);x.position.set(-18,Yc-.45,12),e.add(x);let S=Iu(e,y),C=mu(`HUM`,{dimBelow:.5,normalAbove:.66});Ru(e,o),zu(e);let w=_u(e,{cols:Nl,rows:Ml,isCellOpen:Wl,getCellCenter:Jl,avoidPositions:[i,o]}),T=_u(e,{cols:Nl,rows:Ml,isCellOpen:Wl,getCellCenter:Jl,avoidPositions:[i,o],variant:`super`,respawnMin:il,respawnVariance:al,initialSpawnChance:ol,respawnChance:sl}),E=yu(e,{cols:Nl,rows:Ml,isCellOpen:Wl,getCellCenter:Jl,avoidPositions:[i,o]}),D=!1;function ee(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=Yl(e+n,t+r);return Wl(i.col,i.row)})}function O(t,i,a){let s=0;S.forEach(e=>{let t=.92+Math.sin(i*1.45+e.phase)*.035,n=Math.sin(i*e.speed+e.phase*2.4)>.965?.72:1,r=Math.max(.58,t*n-e.weak);e.material.emissiveIntensity=r*e.baseIntensity*1.56,pu(e,r,1.1),s+=r});let c=S.length>0?s/S.length:.9,l=Math.hypot(a.x-o.x,a.z-o.z);l<Rl&&(D=!0),e.fog.density=.0095+(1-c)*.004,uu(r,i,a);let u=w.update(t,i,a),d=T.update(t,i,a),f=E.update(t,i,a);return{exitDistance:Math.round(l),exitReached:D,flicker:c,lightState:C(t,c),focusItem:Pu(w.inspect(n),T.inspect(n),E.inspect(n)),almondWater:u,superAlmondWater:d,flashlight:f}}return{level:0,levelLabel:`LEVEL 0`,levelName:`NOCLIP ZONE`,viewModelName:lu(r),nextLevel:1,scene:e,camera:n,spawn:a,isWalkable:ee,update:O,tryPickup:e=>Fu(e,T,E,w)}}var Hu=35,Uu=25,Wu=Z*.86,Gu={col:4,row:22,yaw:-Math.PI*.18},Ku={col:31,row:1},qu=10,Ju=Z*4.15,Yu=[{col:1,row:16,width:8,height:5},{col:23,row:11,width:10,height:6},{col:9,row:19,width:8,height:4},{col:18,row:4,width:6,height:5}],Xu=[{col:11,row:7,width:6,height:4},{col:25,row:17,width:6,height:4}];function Zu(){let e=Array.from({length:Uu},()=>Array.from({length:Hu},()=>`#`)),t=(t,n)=>{n>0&&n<Uu-1&&t>0&&t<Hu-1&&(e[n][t]=`.`)};((e,n,r,i)=>{for(let a=n;a<n+i;a+=1)for(let n=e;n<e+r;n+=1)t(n,a)})(1,1,Hu-2,Uu-2);let n=[{col:2,row:2,width:5,height:3},{col:13,row:2,width:8,height:2},{col:27,row:5,width:5,height:3},{col:3,row:17,width:5,height:3},{col:18,row:18,width:5,height:3},{col:28,row:14,width:4,height:4}],r=[];for(let e=6;e<=20;e+=5)for(let t=8;t<=26;t+=6)r.push({col:t,row:e,width:1,height:1});return[...n,...r].forEach(t=>{for(let n=t.row;n<t.row+t.height;n+=1)for(let r=t.col;r<t.col+t.width;r+=1)n>0&&n<Uu-1&&r>0&&r<Hu-1&&!(r===Gu.col&&n===Gu.row)&&!(r===Ku.col&&n===Ku.row)&&(e[n][r]=`#`)}),e.map(e=>e.join(``))}var Qu=Zu(),$u=-140/2,ed=-100/2;function td(e,t){return t>=0&&t<Uu&&e>=0&&e<Hu&&Qu[t][e]===`.`}function nd(e,t){return{x:$u+e*Z+Z/2,z:ed+t*Z+Z/2}}function rd(e,t){return{col:Math.floor((e-$u)/Z),row:Math.floor((t-ed)/Z)}}function id(e,t,n){return n.some(n=>Gl(e,t,n))}function ad(e,t){return[[0,-1],[0,1],[-1,0],[1,0]].filter(([n,r])=>td(e+n,t+r)).length}function od(e,t,n,r,i=1){let a=Zl(e);return Xl(512,(t,n)=>{let o=t.createImageData(n,n),s=o.data;for(let t=0;t<n;t+=1)for(let o=0;o<n;o+=1){let c=(t*n+o)*4,l=(tu(o,t,n,4,e*.03)-.5)*30*i,u=(tu(o,t,n,15,e*.07)-.5)*12*i,d=(a()-.5)*9*i,f=Math.max(0,tu(o,t,n,7,e*.11)-.62)*-32,p=l+u+d+f;s[c]=Ql(r[0]+p),s[c+1]=Ql(r[1]+p*.94),s[c+2]=Ql(r[2]+p*.86),s[c+3]=255}t.putImageData(o,0,0);let c=e===1973776,l=e===1973777,u=e===1973778;if(c){t.strokeStyle=`rgba(20,23,21,0.24)`,t.lineWidth=2;for(let e=0;e<=n;e+=128)t.beginPath(),t.moveTo(e,0),t.lineTo(e+(a()-.5)*14,n),t.stroke();t.globalAlpha=.14,t.strokeStyle=`#202823`,t.lineWidth=9;for(let e=0;e<5;e+=1){let e=60+a()*(n-120);t.beginPath(),t.moveTo(-40,e),t.bezierCurveTo(n*.28,e+a()*30,n*.7,e-a()*26,n+40,e+a()*12),t.stroke()}t.globalAlpha=1}else if(l){t.globalAlpha=.18,t.fillStyle=`#2d3832`;for(let e=0;e<18;e+=1){let e=a()*n,r=4+a()*18,i=80+a()*240;t.fillRect(e,a()*70,r,i)}t.globalAlpha=1}else if(u){t.strokeStyle=`rgba(22,27,24,0.22)`,t.lineWidth=2;for(let e=0;e<=n;e+=128)t.beginPath(),t.moveTo(e,0),t.lineTo(e,n),t.stroke();for(let e=0;e<=n;e+=128)t.beginPath(),t.moveTo(0,e),t.lineTo(n,e),t.stroke()}t.strokeStyle=`rgba(28,31,30,0.28)`,t.lineWidth=1.2;for(let e=0;e<34;e+=1){let e=a()*n,r=a()*n,i=18+a()*86,o=a()*Math.PI;t.beginPath(),t.moveTo(e,r),t.lineTo(e+Math.cos(o)*i,r+Math.sin(o)*i),t.stroke()}nu(t,n,900,.09,`18,20,19`,a),nu(t,n,180,.06,`190,197,184`,a)},t,n)}function sd(){return od(1973776,13,10,[84,88,82],1.08)}function cd(){return od(1973777,2.8,1.15,[102,107,101],.9)}function ld(){let e=od(1973778,10,7,[76,80,77],.82);return e.needsUpdate=!0,e}function ud(e,t){let n=[],r=new Set(t.map((e,t)=>({index:t,priority:e.priority})).sort((e,t)=>t.priority-e.priority).slice(0,qu).map(({index:e})=>e)),i=new q(1,.04,.34),a=new q(1,.04,.48),o=new J({color:5660763,emissive:1909793,emissiveIntensity:.16,roughness:.72,metalness:.22});return t.forEach((t,s)=>{let c=new K(a,o);c.position.set(t.x,Yc-.075,t.z),c.rotation.y=t.rotation,c.scale.x=t.panelWidth+.32,e.add(c);let l=new J({color:t.color,emissive:t.color,emissiveIntensity:t.baseIntensity,roughness:.22}),u=new K(i,l);u.position.set(t.x,Yc-.12,t.z),u.rotation.y=t.rotation,u.scale.x=t.panelWidth,e.add(u);let d=null;t.hasPointLight&&r.has(s)&&(d=fu(t,Yc-.32,{rangeScale:1.52,intensityScale:1.2}),e.add(d)),n.push({material:l,light:d,phase:t.phase,speed:t.speed,baseIntensity:t.baseIntensity,weak:t.weak,broken:t.broken})}),n}function dd(e){let t=rd(e.x,e.z),n=[{col:t.col,row:t.row-1,x:e.x,z:e.z-Z/2+Jc*.65,rotation:0},{col:t.col,row:t.row+1,x:e.x,z:e.z+Z/2-Jc*.65,rotation:Math.PI},{col:t.col-1,row:t.row,x:e.x-Z/2+Jc*.65,z:e.z,rotation:Math.PI/2},{col:t.col+1,row:t.row,x:e.x+Z/2-Jc*.65,z:e.z,rotation:-Math.PI/2}];return n.find(e=>!td(e.col,e.row))??n[0]}function fd(e,t){let n=dd(t),r=new J({color:4870992,emissive:1119765,emissiveIntensity:.16,roughness:.58,metalness:.18}),i=new J({map:ou(`ELEVATOR`,`#15231f`,`#c9ffd5`),color:16777215,emissive:2182967,emissiveIntensity:.42,roughness:.5,side:2}),a=new K(new ui(2.4,2.28),r);a.position.set(n.x,1.24,n.z),a.rotation.y=n.rotation,e.add(a);let o=new K(new q(.035,2.16,.022),new J({color:2106916,roughness:.7,metalness:.26}));o.position.set(t.x,1.24,n.z+(n.rotation===0?.014:-.014)),o.rotation.y=n.rotation,e.add(o);let s=new K(new ui(2.35,.72),i);s.position.set(n.x,2.67,n.z),s.rotation.y=n.rotation,e.add(s);let c=new Sr({color:10682321,transparent:!0,opacity:.12,depthWrite:!1,side:2}),l=new K(new ui(Z*.9,Z*.9),c);l.rotation.x=-Math.PI/2,l.position.set(t.x,.032,t.z),e.add(l);let u=new oa(9764808,.65,7.2,2.25);u.position.set(t.x,1.55,t.z),e.add(u)}function pd(e){let t=new J({color:2503214,roughness:.7,metalness:.28}),n=new si(.07,.07,Z*9.5,14);[{col:9,row:4,axis:`x`},{col:18,row:10,axis:`z`},{col:27,row:20,axis:`x`},{col:6,row:18,axis:`z`}].forEach(r=>{let i=nd(r.col,r.row),a=new K(n,t);a.position.set(i.x,Yc-.42,i.z),r.axis===`x`&&(a.rotation.z=Math.PI/2),r.axis===`z`&&(a.rotation.x=Math.PI/2),e.add(a)})}function md(e){let t=new J({color:6969408,emissive:2168847,emissiveIntensity:.08,roughness:.86}),n=new J({color:3948858,emissive:1119505,emissiveIntensity:.06,roughness:.82}),r=new q(1.25,.86,1.15),i=[];return[{col:12,row:8,x:-.72,z:-.5,rot:.18,dark:!1},{col:14,row:8,x:.45,z:.45,rot:-.12,dark:!0},{col:16,row:10,x:-.3,z:.65,rot:.08,dark:!1},{col:25,row:18,x:-.54,z:-.52,rot:.2,dark:!0},{col:27,row:19,x:.58,z:.1,rot:-.26,dark:!1},{col:29,row:18,x:-.2,z:.4,rot:.08,dark:!0}].forEach(a=>{let o=nd(a.col,a.row),s=new K(r,a.dark?n:t);s.position.set(o.x+a.x,.43,o.z+a.z),s.rotation.y=a.rot,e.add(s);let c={minX:s.position.x-.86,maxX:s.position.x+.86,minZ:s.position.z-.82,maxZ:s.position.z+.82};s.userData.collider=c,i.push(c)}),i}function hd(e,t,n,r){let i=Math.max(r.minX,Math.min(e,r.maxX)),a=Math.max(r.minZ,Math.min(t,r.maxZ));return(e-i)**2+(t-a)**2<n**2}function gd(e){let t=new Sr({color:1054742,transparent:!0,opacity:.28,depthWrite:!1,side:2});[{col:7,row:18,width:5.4,height:2.1,rot:-.18},{col:20,row:12,width:4.5,height:1.7,rot:.14},{col:29,row:9,width:3.9,height:1.35,rot:-.06}].forEach(n=>{let r=nd(n.col,n.row),i=new K(new ui(n.width,n.height),t);i.rotation.x=-Math.PI/2,i.rotation.z=n.rot,i.position.set(r.x,.026,r.z),e.add(i)})}function _d(e){let t=new Sr({color:1909536,transparent:!0,opacity:.11,depthWrite:!1}),n=new Sr({color:13095347,transparent:!0,opacity:.055,depthWrite:!1}),r=(t,n,r)=>{let i=t.width*Z,a=t.height*Z,o=new K(new ui(i,a),n);o.rotation.x=-Math.PI/2,o.position.set($u+t.col*Z+i/2,r,ed+t.row*Z+a/2),e.add(o)};Yu.forEach(e=>r(e,t,.018)),Xu.forEach(e=>r(e,n,.02))}function vd(e){let t=new Sr({color:14147272,transparent:!0,opacity:.18,depthWrite:!1,side:2}),n=new Sr({color:14076250,transparent:!0,opacity:.18,depthWrite:!1,side:2});[{col:5,row:21,width:9.4,height:.09,rot:0,hazard:!1},{col:5,row:23,width:7.8,height:.08,rot:0,hazard:!1},{col:13,row:8,width:6.4,height:.1,rot:Math.PI/2,hazard:!0},{col:16,row:9,width:5.2,height:.08,rot:0,hazard:!1},{col:27,row:18,width:7.2,height:.1,rot:0,hazard:!0},{col:30,row:19,width:5.8,height:.08,rot:Math.PI/2,hazard:!1}].forEach(r=>{let i=nd(r.col,r.row),a=new K(new ui(r.width,r.height),r.hazard?n:t);a.rotation.x=-Math.PI/2,a.rotation.z=r.rot,a.position.set(i.x,.033,i.z),e.add(a)})}function yd(e){[{col:12,row:7,text:`M.E.G. BASE`,bg:`#101f1a`,fg:`#c9ffd5`},{col:25,row:17,text:`SUPPLY`,bg:`#263022`,fg:`#e9ffbd`},{col:30,row:4,text:`ELEVATOR AHEAD`,bg:`#101f1a`,fg:`#9dffbe`},{col:7,row:18,text:`NO ENTRY`,bg:`#221814`,fg:`#ffd1a1`}].forEach(t=>{let n=dd(nd(t.col,t.row)),r=new J({map:ou(t.text,t.bg,t.fg),color:16777215,emissive:1782568,emissiveIntensity:.24,roughness:.55,side:2}),i=new K(new ui(1.9,.54),r);i.position.set(n.x,1.74,n.z),i.rotation.y=n.rotation,e.add(i)})}function bd(e){let t=new J({color:3094837,emissive:857105,emissiveIntensity:.08,roughness:.68,metalness:.28}),n=new J({color:7034423,emissive:1905416,emissiveIntensity:.08,roughness:.88}),r=new J({color:7692872,emissive:2234382,emissiveIntensity:.06,roughness:.86}),i=[];return[{col:12,row:9,rot:.04},{col:15,row:8,rot:-.05},{col:26,row:18,rot:Math.PI/2+.06},{col:29,row:18,rot:Math.PI/2-.04}].forEach(a=>{let o=nd(a.col,a.row),s=new cn;s.position.set(o.x,0,o.z),s.rotation.y=a.rot;let c=new K(new q(2.2,1.38,.08),t);c.position.set(0,.78,.32),s.add(c);for(let e=0;e<3;e+=1){let n=new K(new q(2.3,.08,.72),t);n.position.set(0,.34+e*.47,0),s.add(n)}for(let e=-1;e<=1;e+=2){let n=new K(new q(.08,1.45,.08),t);n.position.set(e*1.12,.72,-.32),s.add(n)}let l=new K(new q(1.86,.18,.72),n);l.position.set(0,.09,-.72),s.add(l);let u=new K(new q(.58,.42,.46),r);u.position.set(-.42,.59,-.06),u.rotation.y=.08,s.add(u),e.add(s);let d={minX:o.x-1.42,maxX:o.x+1.42,minZ:o.z-1.05,maxZ:o.z+1.05};s.userData.collider=d,i.push(d)}),i}function xd(){let e=[],t=[],n=[];for(let r=0;r<Uu;r+=1)for(let i=0;i<Hu;i+=1){if(!td(i,r))continue;let a=nd(i,r),o=id(i,r,Yu),s=id(i,r,Xu),c=ad(i,r)>=3;td(i,r-1)||e.push(new H(a.x,qc/2,a.z-Z/2)),td(i,r+1)||e.push(new H(a.x,qc/2,a.z+Z/2)),td(i-1,r)||t.push(new H(a.x-Z/2,qc/2,a.z)),td(i+1,r)||t.push(new H(a.x+Z/2,qc/2,a.z));let l=i%7==3&&r%5==2,u=i%9==5&&r%6==4;(l&&!o||u&&c)&&n.push({x:a.x,z:a.z,rotation:0,phase:i*.74+r*1.31,speed:o?6.2:3.1+(i+r)%5*.34,weak:o?.28:s?.06:.14,broken:o||(i+r)%13==0,range:s?15:c?12.8:9.8,baseIntensity:s?1.8:c?1.22:.92,panelWidth:s?2.95:2.35,color:s?15661020:14477270,hasPointLight:s||c,priority:(s?3:0)+(c?2:0)-(o?2:0)})}let r=[],i=nd(Gu.col,Gu.row),a=nd(Ku.col,Ku.row);return n.push({x:i.x,z:i.z,rotation:0,phase:.4,speed:2.6,weak:.03,broken:!1,range:15.8,baseIntensity:1.72,panelWidth:2.7,color:15661023,hasPointLight:!0,priority:8},{x:a.x,z:a.z,rotation:0,phase:1.7,speed:2.9,weak:.04,broken:!1,range:15.2,baseIntensity:1.66,panelWidth:2.8,color:14677468,hasPointLight:!0,priority:7}),n.sort((e,t)=>t.priority-e.priority).forEach(e=>{r.some(t=>Math.hypot(t.x-e.x,t.z-e.z)<Ju)||r.push(e)}),{northSouth:e,eastWest:t,fixturePositions:r}}function Sd(){let e=new _n,t=9214094;e.background=new G(t),e.fog=new gn(t,.0115);let n=new na(76,1,.05,Math.hypot(Hu*Z,Uu*Z)+Z*2),r=cu(n);e.add(n);let i=nd(Gu.col,Gu.row),a={x:i.x,z:i.z,yaw:Gu.yaw},o=nd(Ku.col,Ku.row),s=new J({map:sd(),color:14015692,emissive:3884605,emissiveIntensity:.32,roughness:.96}),c=new J({map:cd(),color:14147028,emissive:3489846,emissiveIntensity:.27,roughness:.94}),l=new J({map:ld(),color:13357768,emissive:4279877,emissiveIntensity:.34,roughness:.9}),u=new J({color:7831414,emissive:2436392,emissiveIntensity:.12,roughness:.96}),d=[c,c,u,u,c,c],f=new K(new ui(Hu*Z,Uu*Z),s);f.rotation.x=-Math.PI/2,e.add(f);let p=new K(new ui(Hu*Z,Uu*Z),l);p.rotation.x=Math.PI/2,p.position.set(0,Yc,0),e.add(p);let{northSouth:m,eastWest:h,fixturePositions:g}=xd();du(e,new q(4.22,qc,Jc),d,m),du(e,new q(Jc,qc,4.22),d,h),e.add(new Wi(14936799,7108203,1.68));let _=new la(14214356,.22);_.position.set(18,Yc-.55,-10),e.add(_);let v=ud(e,g),y=mu(`HUM`,{dimBelow:.48,normalAbove:.62});fd(e,o),pd(e);let b=md(e);b=b.concat(bd(e)),gd(e),_d(e),vd(e),yd(e);let x=_u(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b}),S=_u(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b,variant:`super`,respawnMin:il,respawnVariance:al,initialSpawnChance:ol,respawnChance:sl}),C=yu(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b}),w=xu(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b}),T=[ju({id:`level-one-elevator-panel`,position:o,inspectHeight:1.6,inspectRadius:.75,responseKey:`levelOneElevatorResponse`})],E=Du(e,{spawnPosition:wu({cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,targetPosition:o,spawnPosition:i})[0]??i,isWalkable:ee,speed:1.16}),D=!1;function ee(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=rd(e+n,t+r);return td(i.col,i.row)})?!b.some(r=>hd(e,t,n,r)):!1}function O(t,i,a){let s=0;v.forEach(e=>{let t=.84+Math.sin(i*1.18+e.phase)*.055,n=e.broken&&Math.sin(i*e.speed+e.phase)>.93?.52:1,r=Math.max(.38,t*n-e.weak);e.material.emissiveIntensity=r*e.baseIntensity*1.55,pu(e,r,1.05),s+=r});let c=v.length>0?s/v.length:.76,l=Math.hypot(a.x-o.x,a.z-o.z);l<Wu&&(D=!0),e.fog.density=.012+(1-c)*.009,uu(r,i,a);let u=x.update(t,i,a),d=S.update(t,i,a),f=C.update(t,i,a),p=w.update(t,i,a),m=[E.update(t,i,a)];return{exitDistance:Math.round(l),exitReached:D,entityContact:m.some(e=>e.contact),flicker:c,almondWater:u,superAlmondWater:d,flashlight:f,detector:p,entities:m,focusEntity:Au(n,m),focusInteraction:Mu(n,a,T),focusItem:Pu(x.inspect(n),S.inspect(n),w.inspect(n),C.inspect(n)),lightState:y(t,c),statusText:D?`ELEVATOR ONLINE`:l<9?`ELEVATOR TRACE`:`HABITABLE ZONE`}}return{level:1,levelLabel:`LEVEL 1`,levelName:`HABITABLE ZONE`,viewModelName:lu(r),colliderCount:b.length,nextLevel:2,scene:e,camera:n,spawn:a,isWalkable:ee,update:O,tryPickup:e=>Fu(e,w,S,C,x),interact:e=>Nu(e,...T)}}var Cd=39,wd=23,Td={col:3,row:3,yaw:-Math.PI*.44},Ed={col:36,row:20},Dd=Z*.74,Od=8,kd=Z*5.25,Ad=[{col:4,row:7,width:4,height:3},{col:12,row:13,width:5,height:4},{col:24,row:14,width:4,height:4},{col:31,row:17,width:4,height:3},{col:18,row:5,width:5,height:5},{col:7,row:17,width:5,height:4}];function jd(){let e=Array.from({length:wd},()=>Array.from({length:Cd},()=>`#`)),t=(t,n)=>{n>0&&n<wd-1&&t>0&&t<Cd-1&&(e[n][t]=`.`)},n=(e,n,r,i)=>{for(let a=n;a<n+i;a+=1)for(let n=e;n<e+r;n+=1)t(n,a)},r=(e,n,r,i=1)=>{let a=Math.min(e,n),o=Math.max(e,n);for(let e=a;e<=o;e+=1)for(let n=0;n<i;n+=1)t(e,r+n)},i=(e,n,r,i=1)=>{let a=Math.min(n,r),o=Math.max(n,r);for(let n=a;n<=o;n+=1)for(let r=0;r<i;r+=1)t(e+r,n)};return r(2,15,3,2),i(14,3,11,2),r(8,28,10,2),i(8,10,20,2),r(8,36,19,2),i(30,11,20,2),r(24,34,11,2),n(3,6,5,4),n(18,5,6,5),n(12,13,5,4),n(25,14,6,4),n(31,17,6,4),[{col:20,row:7},{col:22,row:7},{col:12,row:15},{col:28,row:16},{col:33,row:18}].forEach(({col:t,row:n})=>{!(t===Td.col&&n===Td.row)&&!(t===Ed.col&&n===Ed.row)&&(e[n][t]=`#`)}),e.map(e=>e.join(``))}var Md=jd(),Nd=-156/2,Pd=-92/2;function Fd(e,t){return t>=0&&t<wd&&e>=0&&e<Cd&&Md[t][e]===`.`}function Id(e,t){return{x:Nd+e*Z+Z/2,z:Pd+t*Z+Z/2}}function Ld(e,t){return{col:Math.floor((e-Nd)/Z),row:Math.floor((t-Pd)/Z)}}function Rd(e,t){return[[0,-1],[0,1],[-1,0],[1,0]].filter(([n,r])=>Fd(e+n,t+r)).length}function zd(e,t,n,r,i=1){let a=Zl(e);return Xl(512,(t,n)=>{let o=t.createImageData(n,n),s=o.data;for(let t=0;t<n;t+=1)for(let o=0;o<n;o+=1){let c=(t*n+o)*4,l=(tu(o,t,n,5,e*.021)-.5)*36,u=Math.max(0,tu(o,t,n,11,e*.047)-.58)*-46,d=Math.max(0,tu(o,t,n,8,e*.091)-.68)*28*i,f=(a()-.5)*10;s[c]=Ql(r[0]+l+u+d+f),s[c+1]=Ql(r[1]+l*.84+u*.72+d*.42+f),s[c+2]=Ql(r[2]+l*.58+u*.62+d*.18+f*.7),s[c+3]=255}t.putImageData(o,0,0);let c=e===3088387,l=e===3088388;if(c){t.globalAlpha=.24;for(let e=0;e<18;e+=1){let e=a()*n,r=a()*n*.38,i=70+a()*210,o=4+a()*12,s=t.createLinearGradient(e,r,e,r+i);s.addColorStop(0,`rgba(124,63,25,0.52)`),s.addColorStop(1,`rgba(124,63,25,0)`),t.fillStyle=s,t.fillRect(e,r,o,i)}t.globalAlpha=1}else if(l){t.strokeStyle=`rgba(7,8,7,0.34)`,t.lineWidth=3;for(let e=24;e<n;e+=76)t.beginPath(),t.moveTo(0,e),t.lineTo(n,e+(a()-.5)*14),t.stroke()}t.globalAlpha=.18,t.strokeStyle=`#15140f`,t.lineWidth=1.3;for(let e=0;e<28;e+=1){let e=a()*n,r=a()*n,i=24+a()*120,o=a()*Math.PI;t.beginPath(),t.moveTo(e,r),t.lineTo(e+Math.cos(o)*i,r+Math.sin(o)*i),t.stroke()}t.globalAlpha=1;for(let e=0;e<=n;e+=86)t.fillStyle=`rgba(28,24,18,0.18)`,t.fillRect(e-1,0,2,n);nu(t,n,980,.1,`13,12,9`,a),nu(t,n,210,.08,`173,104,50`,a)},t,n)}function Bd(){let e=Zl(3088386);return Xl(512,(t,n)=>{t.fillStyle=`#3d3d30`,t.fillRect(0,0,n,n);for(let e=0;e<n;e+=1)t.fillStyle=`rgba(0,0,0,${.05+Math.sin(e*.08)*.018})`,t.fillRect(0,e,n,1);t.strokeStyle=`rgba(15,14,10,0.46)`,t.lineWidth=2;for(let e=0;e<=n;e+=64)t.beginPath(),t.moveTo(e,0),t.lineTo(e,n),t.stroke();for(let e=0;e<=n;e+=96)t.beginPath(),t.moveTo(0,e),t.lineTo(n,e),t.stroke();t.globalAlpha=.2,t.strokeStyle=`#b15d2d`,t.lineWidth=2.2;for(let r=0;r<16;r+=1){let r=e()*n;t.beginPath(),t.moveTo(e()*80,r),t.lineTo(n-e()*80,r+(e()-.5)*18),t.stroke()}t.globalAlpha=1,t.globalAlpha=.22,t.fillStyle=`#0d0d0a`;for(let e=44;e<n;e+=132){t.fillRect(0,e,n,18),t.fillStyle=`#7b4a24`;for(let r=0;r<n;r+=42)t.fillRect(r,e,22,18);t.fillStyle=`#0d0d0a`}t.globalAlpha=1,nu(t,n,1050,.1,`12,12,9`,e),nu(t,n,360,.12,`153,92,43`,e)},11,9)}function Vd(){return zd(3088387,2.4,1.1,[84,78,61],1.15)}function Hd(){return zd(3088388,8,6,[56,54,44],.8)}function Ud(){let e=[],t=[],n=[];for(let r=0;r<wd;r+=1)for(let i=0;i<Cd;i+=1){if(!Fd(i,r))continue;let a=Id(i,r),o=Kl(i,r,Ad);Fd(i,r-1)||e.push(new H(a.x,qc/2,a.z-Z/2)),Fd(i,r+1)||e.push(new H(a.x,qc/2,a.z+Z/2)),Fd(i-1,r)||t.push(new H(a.x-Z/2,qc/2,a.z)),Fd(i+1,r)||t.push(new H(a.x+Z/2,qc/2,a.z));let s=Rd(i,r),c=Fd(i-1,r)||Fd(i+1,r),l=s<=2,u=(i*11+r*7)%17==0;o&&!(i===3&&r===3||i===36&&r===20)||(l&&u||i===3&&r===3||i===36&&r===20)&&n.push({x:a.x,z:a.z,rotation:c?0:Math.PI/2,phase:i*.57+r*1.17,speed:3.8+(i+r)%5*.62,weak:.2+(i+r)%3*.04,range:i===3||i===36?12.6:9.6,baseIntensity:i===3||i===36?1.36:.95,panelWidth:1.35+(i+r)%2*.38,color:(i+r)%4==0?16742973:16756828,hasPointLight:!0,priority:i===3||i===36?8:l?3:1})}let r=[];return n.sort((e,t)=>t.priority-e.priority).forEach(e=>{r.some(t=>Math.hypot(t.x-e.x,t.z-e.z)<kd)||r.push(e)}),{northSouth:e,eastWest:t,fixturePositions:r}}function Wd(e,t){let n=[],r=new Set(t.map((e,t)=>({index:t,priority:e.priority})).sort((e,t)=>t.priority-e.priority).slice(0,Od).map(({index:e})=>e)),i=new q(1,.045,.34),a=new q(1,.05,.48),o=new J({color:2826776,emissive:1313541,emissiveIntensity:.24,roughness:.82,metalness:.36});return t.forEach((t,s)=>{let c=new K(a,o);c.position.set(t.x,Yc-.095,t.z),c.rotation.y=t.rotation,c.scale.x=t.panelWidth+.2,e.add(c);let l=new J({color:t.color,emissive:t.color,emissiveIntensity:t.baseIntensity,roughness:.34}),u=new K(i,l);u.position.set(t.x,Yc-.145,t.z),u.rotation.y=t.rotation,u.scale.x=t.panelWidth,e.add(u);let d=null;r.has(s)&&(d=fu(t,Yc-.44,{rangeScale:1.62,intensityScale:1.32,decay:2.05}),e.add(d)),n.push({material:l,light:d,phase:t.phase,speed:t.speed,weak:t.weak,baseIntensity:t.baseIntensity})}),n}function Gd(e,t,n){let r=Id(n.col,n.row),i=new K(new si(n.radius,n.radius,n.length,14),t);if(i.position.set(r.x+(n.offsetX??0),n.y,r.z+(n.offsetZ??0)),n.axis===`x`&&(i.rotation.z=Math.PI/2),n.axis===`z`&&(i.rotation.x=Math.PI/2),e.add(i),n.joint){let r=new K(new fi(n.radius*1.35,12,8),t);r.position.copy(i.position),e.add(r)}}function Kd(e){let t=new J({color:3813930,emissive:1051141,emissiveIntensity:.12,roughness:.76,metalness:.36}),n=new J({color:5713948,emissive:2821380,emissiveIntensity:.2,roughness:.7,metalness:.32});[{col:8,row:3,axis:`x`,length:Z*11,radius:.08,y:Yc-.48,offsetZ:-.9},{col:14,row:8,axis:`z`,length:Z*8.5,radius:.11,y:Yc-.36,offsetX:-.95,hot:!0,joint:!0},{col:20,row:10,axis:`x`,length:Z*9,radius:.07,y:2.55,offsetZ:1},{col:8,row:16,axis:`z`,length:Z*7,radius:.1,y:2.8,offsetX:.88,hot:!0},{col:22,row:19,axis:`x`,length:Z*17,radius:.09,y:Yc-.52,offsetZ:-1.05},{col:30,row:15,axis:`z`,length:Z*9,radius:.12,y:2.38,offsetX:1.05,joint:!0},{col:32,row:11,axis:`x`,length:Z*8,radius:.065,y:Yc-.68,offsetZ:.82}].forEach(r=>Gd(e,r.hot?n:t,r))}function qd(e){let t=new J({color:2565407,emissive:591620,emissiveIntensity:.1,roughness:.8,metalness:.26}),n=new J({color:5912097,emissive:1443844,emissiveIntensity:.1,roughness:.88,metalness:.18}),r=new Sr({color:16752730}),i=[];return[{col:5,row:7,width:1.35,height:1.15,depth:1,x:.6,z:-.5,rot:.05},{col:20,row:7,width:1.65,height:1.35,depth:.85,x:-.4,z:.5,rot:-.12,rust:!0},{col:13,row:15,width:1.2,height:1,depth:1.25,x:.45,z:-.35,rot:.16},{col:27,row:15,width:1.6,height:1.55,depth:1.15,x:-.55,z:.42,rot:-.06,rust:!0},{col:33,row:19,width:1.28,height:1.08,depth:1,x:.2,z:.3,rot:.18}].forEach(a=>{let o=Id(a.col,a.row),s=new K(new q(a.width,a.height,a.depth),a.rust?n:t);s.position.set(o.x+a.x,a.height/2,o.z+a.z),s.rotation.y=a.rot,e.add(s);let c=new K(new q(.3,.08,.018),r);c.position.set(s.position.x,s.position.y+a.height*.18,s.position.z-a.depth/2-.012),c.rotation.y=a.rot,e.add(c),i.push({minX:s.position.x-a.width*.62,maxX:s.position.x+a.width*.62,minZ:s.position.z-a.depth*.62,maxZ:s.position.z+a.depth*.62})}),i}function Jd(e){let t=[],n=new fi(.34,12,8);return[{col:14,row:8,x:-1.05,z:.48,phase:.2},{col:8,row:16,x:.9,z:-.35,phase:1.6},{col:30,row:15,x:1,z:.42,phase:2.7},{col:23,row:19,x:-.4,z:-1,phase:3.3}].forEach(r=>{let i=Id(r.col,r.row),a=new K(n,new Sr({color:14208438,transparent:!0,opacity:.08,depthWrite:!1}));a.position.set(i.x+r.x,1.22,i.z+r.z),a.scale.set(1,.8,1),a.userData.phase=r.phase,e.add(a),t.push(a)}),t}function Yd(e){let t=Ld(e.x,e.z),n=[{col:t.col,row:t.row-1,x:e.x,z:e.z-Z/2+Jc*.7,rotation:0},{col:t.col,row:t.row+1,x:e.x,z:e.z+Z/2-Jc*.7,rotation:Math.PI},{col:t.col-1,row:t.row,x:e.x-Z/2+Jc*.7,z:e.z,rotation:Math.PI/2},{col:t.col+1,row:t.row,x:e.x+Z/2-Jc*.7,z:e.z,rotation:-Math.PI/2}];return n.find(e=>!Fd(e.col,e.row))??n[0]}function Xd(e,t){let n=Yd(t),r=new J({color:2827552,emissive:1181700,emissiveIntensity:.18,roughness:.72,metalness:.34}),i=new J({map:ou(`PIPE EXIT`,`#241108`,`#ffbc73`),color:16777215,emissive:8006923,emissiveIntensity:.55,roughness:.5,side:2}),a=new K(new ui(2.35,2.35),r);a.position.set(n.x,1.28,n.z),a.rotation.y=n.rotation,e.add(a);let o=new K(new ui(2.22,.62),i);o.position.set(n.x,2.62,n.z),o.rotation.y=n.rotation,e.add(o);let s=new K(new di(Z*.32,Z*.52,32),new Sr({color:16747325,transparent:!0,opacity:.13,depthWrite:!1,side:2}));s.rotation.x=-Math.PI/2,s.position.set(t.x,.035,t.z),e.add(s);let c=new oa(16747325,.52,6.8,2.2);c.position.set(t.x,1.6,t.z),e.add(c)}function Zd(e){let t=new Sr({color:16742960,transparent:!0,opacity:.055,depthWrite:!1,side:2});[{col:13,row:9,width:3.2,height:5.8,rot:.08},{col:29,row:16,width:3.6,height:4.8,rot:-.11},{col:21,row:19,width:6.4,height:2,rot:.02}].forEach(n=>{let r=Id(n.col,n.row),i=new K(new ui(n.width,n.height),t);i.rotation.x=-Math.PI/2,i.rotation.z=n.rot,i.position.set(r.x,.028,r.z),e.add(i)})}function Qd(e){let t=new Sr({color:328707,transparent:!0,opacity:.2,depthWrite:!1,side:2}),n=new Sr({color:328707,transparent:!0,opacity:.1,depthWrite:!1,side:2});Ad.forEach(r=>{let i=r.width*Z,a=r.height*Z,o=Nd+r.col*Z+i/2,s=Pd+r.row*Z+a/2,c=new K(new ui(i,a),t);c.rotation.x=-Math.PI/2,c.position.set(o,.04,s),e.add(c);let l=new K(new ui(i,a),n);l.rotation.x=Math.PI/2,l.position.set(o,Yc-.035,s),e.add(l)})}function $d(e){let t=new J({color:329222,emissive:66050,emissiveIntensity:.12,roughness:.7,metalness:.2}),n=new si(.028,.028,1,8);[{col:4,row:3,axis:`x`,length:Z*9.5,y:Yc-.18,offsetZ:.86},{col:14,row:10,axis:`z`,length:Z*8,y:Yc-.2,offsetX:.78},{col:21,row:19,axis:`x`,length:Z*14,y:Yc-.16,offsetZ:-.9},{col:30,row:14,axis:`z`,length:Z*6.5,y:Yc-.2,offsetX:-.82}].forEach(r=>{let i=Id(r.col,r.row),a=new K(n,t);a.scale.y=r.length,a.position.set(i.x+(r.offsetX??0),r.y,i.z+(r.offsetZ??0)),r.axis===`x`&&(a.rotation.z=Math.PI/2),r.axis===`z`&&(a.rotation.x=Math.PI/2),e.add(a)}),[{col:14,row:4,text:`LOW PRESSURE`,bg:`#251308`,fg:`#ffbd73`},{col:20,row:10,text:`MAINTENANCE`,bg:`#17130d`,fg:`#ffd78a`},{col:29,row:18,text:`PIPE DREAMS`,bg:`#211006`,fg:`#ff945c`},{col:34,row:19,text:`KEEP MOVING`,bg:`#1b1109`,fg:`#ffca8f`}].forEach(t=>{let n=Yd(Id(t.col,t.row)),r=new J({map:ou(t.text,t.bg,t.fg),color:16777215,emissive:4988170,emissiveIntensity:.28,roughness:.64,side:2}),i=new K(new ui(1.8,.5),r);i.position.set(n.x,1.62,n.z),i.rotation.y=n.rotation,e.add(i)});let r=new J({color:7025952,emissive:1705731,emissiveIntensity:.16,roughness:.72,metalness:.22});[{col:14,row:8},{col:8,row:16},{col:30,row:15},{col:23,row:19}].forEach(t=>{let n=Yd(Id(t.col,t.row)),i=new K(new pi(.26,.026,8,24),r);i.position.set(n.x,1.44,n.z),i.rotation.y=n.rotation,e.add(i);let a=new K(new si(.055,.055,.04,12),r);a.position.copy(i.position),a.rotation.x=Math.PI/2,a.rotation.y=n.rotation,e.add(a)});let i=new Sr({color:328964,transparent:!0,opacity:.22,depthWrite:!1,side:2});[{col:14,row:10,width:2.6,height:1.1,rot:0},{col:8,row:19,width:2.2,height:1.2,rot:Math.PI/2},{col:30,row:12,width:2.7,height:1.15,rot:0}].forEach(t=>{let n=Id(t.col,t.row),r=new K(new ui(t.width,t.height),i);r.rotation.x=-Math.PI/2,r.rotation.z=t.rot,r.position.set(n.x,.036,n.z),e.add(r)})}function ef(e){let t=new J({color:5189922,emissive:1312516,emissiveIntensity:.12,roughness:.78,metalness:.24}),n=new J({color:1776407,emissive:328964,emissiveIntensity:.1,roughness:.82,metalness:.26}),r=new J({color:8014371,emissive:2165764,emissiveIntensity:.14,roughness:.72,metalness:.12}),i=[];return[{col:5,row:7,x:-.65,z:.5},{col:19,row:6,x:.54,z:-.62},{col:26,row:14,x:-.48,z:.56},{col:32,row:18,x:.58,z:-.48}].forEach((r,a)=>{let o=Id(r.col,r.row),s=new K(new si(.3,.32,.82,18),a%2==0?t:n);s.position.set(o.x+r.x,.41,o.z+r.z),s.rotation.y=a*.28,e.add(s);for(let t=.17;t<=.67;t+=.25){let r=new K(new pi(.305,.012,6,18),n);r.position.set(s.position.x,t,s.position.z),r.rotation.x=Math.PI/2,e.add(r)}i.push({minX:s.position.x-.42,maxX:s.position.x+.42,minZ:s.position.z-.42,maxZ:s.position.z+.42})}),[{col:13,row:15,x:.24,z:.6,rot:.22},{col:28,row:16,x:-.36,z:-.48,rot:-.2}].forEach(t=>{let n=Id(t.col,t.row),a=new K(new q(1.55,.68,.16),r);a.position.set(n.x+t.x,.38,n.z+t.z),a.rotation.y=t.rot,e.add(a),i.push({minX:a.position.x-.88,maxX:a.position.x+.88,minZ:a.position.z-.52,maxZ:a.position.z+.52})}),i}function tf(){let e=new _n,t=5588279;e.background=new G(t),e.fog=new gn(t,.0165);let n=new na(76,1,.05,Math.hypot(Cd*Z,wd*Z)+Z*2),r=cu(n);e.add(n);let i=Id(Td.col,Td.row),a={x:i.x,z:i.z,yaw:Td.yaw},o=Id(Ed.col,Ed.row),s=new J({map:Bd(),color:13220240,emissive:3023122,emissiveIntensity:.4,roughness:.94,metalness:.08}),c=new J({map:Vd(),color:13681307,emissive:2891023,emissiveIntensity:.32,roughness:.94,metalness:.04}),l=new J({map:Hd(),color:9142640,emissive:2628626,emissiveIntensity:.36,roughness:.9,metalness:.08}),u=new J({color:4932405,emissive:1248776,emissiveIntensity:.16,roughness:.92,metalness:.08}),d=[c,c,u,u,c,c],f=new K(new ui(Cd*Z,wd*Z),s);f.rotation.x=-Math.PI/2,e.add(f);let p=new K(new ui(Cd*Z,wd*Z),l);p.rotation.x=Math.PI/2,p.position.set(0,Yc,0),e.add(p);let{northSouth:m,eastWest:h,fixturePositions:g}=Ud();du(e,new q(4.22,qc,Jc),d,m),du(e,new q(Jc,qc,4.22),d,h),e.add(new Wi(16760194,3351062,.96));let _=new la(16751444,.16);_.position.set(-8,Yc-.3,18),e.add(_);let v=Wd(e,g),y=mu(`HEAT`,{dimBelow:.34,normalAbove:.52,dimDelay:.5,normalDelay:.78});Xd(e,o),Kd(e);let b=qd(e);b=b.concat(ef(e));let x=Jd(e);Zd(e),Qd(e),$d(e);let S=_u(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[i,o],blockedAabbs:b}),C=_u(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[i,o],blockedAabbs:b,variant:`super`,respawnMin:il,respawnVariance:al,initialSpawnChance:ol,respawnChance:sl}),w=yu(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[i,o],blockedAabbs:b}),T=xu(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[i,o],blockedAabbs:b}),E=[ju({id:`level-two-valve`,position:Id(28,5),inspectHeight:1.45,inspectRadius:.72,responseKey:`levelTwoValveResponse`}),ju({id:`level-two-service-door`,position:o,inspectHeight:1.65,inspectRadius:.8,responseKey:`levelTwoServiceDoorResponse`})],D=wu({cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,targetPosition:o,spawnPosition:i})[0]??o,ee=Du(e,{spawnPosition:D,isWalkable:te,speed:1.22}),O=Ou(e,{spawnPosition:wu({cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,targetPosition:o,spawnPosition:i,avoidPositions:[D],minSeparation:Z*7})[0]??o,isWalkable:te,speed:1.34}),k=!1;function te(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=Ld(e+n,t+r);return Fd(i.col,i.row)})?!b.some(r=>hd(e,t,n,r)):!1}function A(t,i,a){let s=0;v.forEach(e=>{let t=.78+Math.sin(i*1.7+e.phase)*.07,n=Math.sin(i*e.speed+e.phase*1.7)>.91?.48:1,r=Math.max(.24,t*n-e.weak);e.material.emissiveIntensity=r*e.baseIntensity*1.8,pu(e,r,1.08),s+=r}),x.forEach(e=>{let t=e.userData.phase??0,n=.5+Math.sin(i*1.8+t)*.5,r=.8+n*.9;e.scale.set(r*.78,.65+n*.9,r),e.position.y=1.12+n*.18,e.material.opacity=.035+n*.07});let c=v.length>0?s/v.length:.56,l=Math.hypot(a.x-o.x,a.z-o.z);l<Dd&&(k=!0),e.fog.density=.016+(1-c)*.01,uu(r,i,a);let u=S.update(t,i,a),d=C.update(t,i,a),f=w.update(t,i,a),p=T.update(t,i,a),m=[ee.update(t,i,a),O.update(t,i,a)];return{exitDistance:Math.round(l),exitReached:k,entityContact:m.some(e=>e.contact),flicker:c,almondWater:u,superAlmondWater:d,flashlight:f,detector:p,entities:m,focusEntity:Au(n,m),focusInteraction:Mu(n,a,E),focusItem:Pu(S.inspect(n),C.inspect(n),T.inspect(n),w.inspect(n)),lightState:y(t,c),statusText:k?`SERVICE LOCKED`:l<8?`PIPE EXIT TRACE`:`PIPE DREAMS`}}return{level:2,levelLabel:`LEVEL 2`,levelName:`PIPE DREAMS`,viewModelName:lu(r),colliderCount:b.length,nextLevel:3,scene:e,camera:n,spawn:a,isWalkable:te,update:A,tryPickup:e=>Fu(e,T,C,w,S),interact:e=>Nu(e,...E)}}function nf(){return Xl(512,(e,t)=>{e.fillStyle=`#514334`,e.fillRect(0,0,t,t);let n=Zl(4075521);for(let r=0;r<t;r+=48){let i=r/48%2==0?0:64;for(let a=-i;a<t;a+=128)e.fillStyle=`rgba(${70+n()*34},${54+n()*24},${38+n()*20},0.5)`,e.fillRect(a+1,r+1,126,46)}e.strokeStyle=`rgba(18,16,13,0.42)`,e.lineWidth=3;for(let n=0;n<=t;n+=48)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke();for(let n=0;n<t;n+=48){let r=n/48%2==0?0:64;for(let i=-r;i<t;i+=128)e.beginPath(),e.moveTo(i,n),e.lineTo(i,n+48),e.stroke()}nu(e,t,900,.13,`10,8,6`,n),nu(e,t,260,.1,`154,102,62`,n)},2.8,2.1)}function rf(){return Xl(512,(e,t)=>{let n=Zl(4075522);e.fillStyle=`#393b34`,e.fillRect(0,0,t,t),e.strokeStyle=`rgba(12,13,12,0.5)`,e.lineWidth=3;for(let r=0;r<=t;r+=96)e.beginPath(),e.moveTo(r,0),e.lineTo(r+(n()-.5)*10,t),e.stroke();for(let r=0;r<=t;r+=96)e.beginPath(),e.moveTo(0,r),e.lineTo(t,r+(n()-.5)*10),e.stroke();e.globalAlpha=.22,e.fillStyle=`#1d1f1c`;for(let r=0;r<18;r+=1)e.fillRect(n()*t,n()*t,90+n()*190,10+n()*32);e.globalAlpha=1,nu(e,t,1200,.16,`8,8,7`,n),nu(e,t,260,.08,`181,126,70`,n)},12,8)}function af(){return Xl(512,(e,t)=>{let n=Zl(4075523);e.fillStyle=`#282c27`,e.fillRect(0,0,t,t),e.strokeStyle=`rgba(8,9,8,0.45)`,e.lineWidth=3;for(let n=0;n<=t;n+=96)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke();for(let n=0;n<=t;n+=128)e.beginPath(),e.moveTo(n,0),e.lineTo(n,t),e.stroke();nu(e,t,850,.13,`8,8,8`,n),nu(e,t,180,.08,`104,96,72`,n)},8,6)}function of(e){let t=[],n=new J({color:2568237,emissive:463887,emissiveIntensity:.18,roughness:.62,metalness:.32}),r=new J({color:12151842,emissive:3806722,emissiveIntensity:.2,roughness:.58,metalness:.18}),i=new J({color:328965,emissive:131329,emissiveIntensity:.1,roughness:.72,metalness:.28});[{col:7,row:3},{col:14,row:8},{col:21,row:10},{col:30,row:19},{col:34,row:19}].forEach((t,i)=>{let a=Yd(Id(t.col,t.row)),o=new K(new q(1.05,1.18,.12),n);o.position.set(a.x,1.25,a.z),o.rotation.y=a.rotation,e.add(o);for(let t=0;t<4;t+=1){let n=new K(new q(.13,.04,.035),r);n.position.copy(o.position),n.position.y=.88+t*.18,n.position.x+=Math.cos(a.rotation)*(-.26+t%2*.52),n.position.z-=Math.sin(a.rotation)*(-.26+t%2*.52),n.rotation.y=a.rotation,e.add(n)}if(i%2==0){let t=new K(new ui(1.25,.36),new J({map:ou(`HIGH VOLTAGE`,`#2a1705`,`#ffcf5e`),emissive:4859140,emissiveIntensity:.3,roughness:.58,side:2}));t.position.set(a.x,2.12,a.z),t.rotation.y=a.rotation,e.add(t)}}),[{col:12,row:13,x:-.35,z:.48,rot:.12},{col:26,row:14,x:.52,z:-.4,rot:-.2},{col:8,row:18,x:-.2,z:.48,rot:.32}].forEach(i=>{let a=Id(i.col,i.row),o=new K(new q(1.3,.82,.78),n);o.position.set(a.x+i.x,.43,a.z+i.z),o.rotation.y=i.rot,e.add(o),t.push({minX:o.position.x-.78,maxX:o.position.x+.78,minZ:o.position.z-.68,maxZ:o.position.z+.68});let s=new K(new pi(.28,.018,8,28),r);s.position.set(o.position.x,.72,o.position.z-.41),s.rotation.y=i.rot,e.add(s)});let a=new si(.035,.035,1,8);return[{col:5,row:3,axis:`x`,length:Z*9,y:Yc-.22,offsetZ:.88},{col:14,row:7,axis:`z`,length:Z*8,y:Yc-.26,offsetX:-.9},{col:19,row:19,axis:`x`,length:Z*18,y:Yc-.24,offsetZ:-.88},{col:30,row:15,axis:`z`,length:Z*8,y:2.62,offsetX:1.05}].forEach(t=>{let n=Id(t.col,t.row),r=new K(a,i);r.scale.y=t.length,r.position.set(n.x+(t.offsetX??0),t.y,n.z+(t.offsetZ??0)),t.axis===`x`&&(r.rotation.z=Math.PI/2),t.axis===`z`&&(r.rotation.x=Math.PI/2),e.add(r)}),t}function sf(e,t){let n=Yd(t),r=new J({color:1514264,emissive:397837,emissiveIntensity:.2,roughness:.62,metalness:.34}),i=new K(new q(1.55,2.1,.14),r);i.position.set(n.x,1.06,n.z),i.rotation.y=n.rotation,e.add(i);let a=new K(new ui(1.65,.45),new J({map:ou(`BREAKER EXIT`,`#1a1508`,`#ffe77a`),emissive:6308360,emissiveIntensity:.36,roughness:.56,side:2}));a.position.set(n.x,2.42,n.z),a.rotation.y=n.rotation,e.add(a)}function cf(){let e=new _n,t=2369056;e.background=new G(t),e.fog=new gn(t,.017);let n=new na(72,window.innerWidth/window.innerHeight,.1,78),r=Id(3,3),i=Id(36,20),a={x:r.x,z:r.z,yaw:-Math.PI*.34};n.position.set(a.x,1.62,a.z),n.rotation.order=`YXZ`,n.rotation.y=a.yaw;let o=cu(n);e.add(n);let{northSouth:s,eastWest:c,fixturePositions:l}=Ud();l.forEach((e,t)=>{e.color=t%5==0?16731446:16766602,e.baseIntensity*=t%4==0?.72:.92,e.range*=t%4==0?.78:.9});let u=new K(new ui(Cd*Z,wd*Z),new J({map:rf(),color:16777215,roughness:.92}));u.rotation.x=-Math.PI/2,u.position.set(0,0,0),e.add(u);let d=new K(new ui(Cd*Z,wd*Z),new J({map:af(),color:16777215,roughness:.82}));d.rotation.x=Math.PI/2,d.position.set(0,Yc,0),e.add(d);let f=new J({map:nf(),color:16777215,roughness:.88});du(e,new q(4.22,qc,Jc),f,s),du(e,new q(Jc,qc,4.22),f,c),e.add(new Wi(16769194,2106655,.72));let p=new la(16758894,.12);p.position.set(-8,Yc-.4,12),e.add(p);let m=Wd(e,l),h=mu(`VOLT`,{dimBelow:.32,normalAbove:.5,dimDelay:.45,normalDelay:.8});sf(e,i),Qd(e);let g=of(e),_=_u(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[r,i],blockedAabbs:g}),v=_u(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[r,i],blockedAabbs:g,variant:`super`,respawnMin:il,respawnVariance:al,initialSpawnChance:ol,respawnChance:sl}),y=yu(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[r,i],blockedAabbs:g}),b=xu(e,{cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,avoidPositions:[r,i],blockedAabbs:g}),x=[ju({id:`level-three-breaker`,position:i,inspectHeight:1.72,inspectRadius:.86,responseKey:`levelThreeBreakerResponse`}),ju({id:`level-three-generator`,position:Id(14,12),inspectHeight:.78,inspectRadius:.9,responseKey:`levelThreeGeneratorResponse`})],S=Tu({cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,targetPosition:i,spawnPosition:r,count:2}),C=S.map(t=>Du(e,{spawnPosition:t,isWalkable:E,speed:1.48,id:`super-bacteria`})),w=Ou(e,{spawnPosition:wu({cols:Cd,rows:wd,isCellOpen:Fd,getCellCenter:Id,targetPosition:i,spawnPosition:r,avoidPositions:S,minSeparation:Z*7})[0]??i,isWalkable:E,speed:1.62}),T=!1;function E(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=Ld(e+n,t+r);return Fd(i.col,i.row)})?!g.some(r=>hd(e,t,n,r)):!1}function D(t,r,a){let s=0;m.forEach((e,t)=>{let n=.74+Math.sin(r*1.42+e.phase)*.08,i=Math.sin(r*e.speed+e.phase*1.3)>.94?1.32:1,a=t%4==0&&Math.sin(r*2.1+e.phase)>.72?.44:1,o=Math.max(.18,n*i*a-e.weak);e.material.emissiveIntensity=o*e.baseIntensity*1.7,pu(e,o,1.02),s+=o});let c=m.length>0?s/m.length:.42,l=Math.hypot(a.x-i.x,a.z-i.z);l<Dd&&(T=!0),e.fog.density=.017+(1-c)*.012,uu(o,r,a);let u=_.update(t,r,a),d=v.update(t,r,a),f=y.update(t,r,a),p=b.update(t,r,a),g=C.map(e=>e.update(t,r,a)),S=w.update(t,r,a),E=[...g,S],D=E.some(e=>e.contact);return{exitDistance:Math.round(l),exitReached:T,entityContact:D,flicker:c,almondWater:u,superAlmondWater:d,flashlight:f,detector:p,entities:E,focusEntity:Au(n,E),focusInteraction:Mu(n,a,x),focusItem:Pu(_.inspect(n),v.inspect(n),b.inspect(n),y.inspect(n)),lightState:h(t,c),statusText:T?`BREAKER OPEN`:l<8?`BREAKER TRACE`:`ELECTRICAL STATION`}}return{level:3,levelLabel:`LEVEL 3`,levelName:`ELECTRICAL STATION`,viewModelName:lu(o),colliderCount:g.length,nextLevel:4,scene:e,camera:n,spawn:a,isWalkable:E,update:D,tryPickup:e=>Fu(e,b,v,y,_),interact:e=>Nu(e,...x)}}function lf(){let e=Zl(5197572);return Xl(512,(t,n)=>{t.fillStyle=`#858f86`,t.fillRect(0,0,n,n);for(let e=0;e<n;e+=42)t.fillStyle=`rgba(42,48,44,0.12)`,t.fillRect(0,e,n,2);for(let e=0;e<n;e+=42)t.fillStyle=`rgba(220,224,210,0.08)`,t.fillRect(e,0,1,n);for(let r=0;r<24;r+=1){let r=e()*n,i=e()*n,a=28+e()*72,o=t.createRadialGradient(r,i,0,r,i,a);o.addColorStop(0,`rgba(32,38,34,0.11)`),o.addColorStop(1,`rgba(32,38,34,0)`),t.fillStyle=o,t.beginPath(),t.arc(r,i,a,0,Math.PI*2),t.fill()}nu(t,n,1800,.07,`36,42,38`,e),nu(t,n,520,.05,`210,214,200`,e)},12,10)}function uf(){let e=Zl(1044942);return Xl(512,(t,n)=>{t.fillStyle=`#c9c4ae`,t.fillRect(0,0,n,n);for(let e=0;e<n;e+=128)t.fillStyle=`rgba(90,84,68,0.08)`,t.fillRect(e,0,2,n);for(let r=0;r<10;r+=1){let r=e()*n,i=e()*n,a=20+e()*50,o=t.createRadialGradient(r,i,0,r,i,a);o.addColorStop(0,`rgba(88,80,60,0.08)`),o.addColorStop(1,`rgba(88,80,60,0)`),t.fillStyle=o,t.beginPath(),t.arc(r,i,a,0,Math.PI*2),t.fill()}nu(t,n,520,.08,`80,74,58`,e)},2.6,1.15)}function df(){let e=Zl(13505556);return Xl(512,(t,n)=>{t.fillStyle=`#d8d4bf`,t.fillRect(0,0,n,n),t.strokeStyle=`rgba(72,70,58,0.32)`,t.lineWidth=6,t.strokeRect(0,0,n,n),t.strokeStyle=`rgba(255,255,240,0.13)`,t.lineWidth=1.4,t.strokeRect(10,10,n-20,n-20),nu(t,n,1700,.08,`92,88,72`,e)},18,16)}function ff(e,t){let n=dd(t),r=new J({color:2569018,emissive:462867,emissiveIntensity:.16,roughness:.7,metalness:.18}),i=new K(new q(1.72,2.45,.09),r);i.position.set(n.x,1.22,n.z),i.rotation.y=n.rotation,e.add(i);let a=new K(new ui(2.25,.58),new J({map:ou(`STAIRS`,`#102316`,`#c7ffd6`),color:16777215,emissive:4915067,emissiveIntensity:.38,roughness:.44,side:2}));a.position.set(n.x,2.58,n.z),a.rotation.y=n.rotation,e.add(a)}function pf(e){let t=[],n=[],r=new J({color:10462875,emissive:2107424,emissiveIntensity:.12,roughness:.9}),i=new J({color:4930092,emissive:985349,emissiveIntensity:.08,roughness:.76}),a=new J({color:1382169,roughness:.72,metalness:.18}),o=new Sr({color:329222,transparent:!0,opacity:.72,depthWrite:!1}),s=(e,n,r,i)=>{t.push({minX:e-r,maxX:e+r,minZ:n-i,maxZ:n+i})};return[{col:7,row:19},{col:11,row:19},{col:15,row:18},{col:20,row:20},{col:24,row:18},{col:7,row:11},{col:12,row:10},{col:18,row:11},{col:23,row:9},{col:27,row:13}].forEach((t,o)=>{let c=nd(t.col,t.row),l=new cn;l.position.set(c.x,0,c.z);let u=new K(new q(2.35,1.24,.09),r);u.position.set(0,.62,-.92),l.add(u);let d=new K(new q(.09,1.24,1.86),r);d.position.set(-1.12,.62,0),l.add(d);let f=new K(new q(1.35,.16,.62),i);f.position.set(.24,.68,-.46),l.add(f);let p=new K(new q(.46,.58,.44),a);p.position.set(.38,.32,.32),l.add(p),e.add(l),s(c.x-.45,c.z-.44,1.3,.8),(o===2||o===8)&&n.push(ju({id:o===2?`level-four-terminal`:`level-four-files`,position:{x:c.x+.24,z:c.z-.46},inspectHeight:.78,inspectRadius:.75,responseKey:o===2?`levelFourTerminalResponse`:`levelFourFilesResponse`}))}),[{col:4,row:6,id:`level-four-vending`,color:2376266},{col:29,row:6,id:`level-four-water-cooler`,color:12048098}].forEach(t=>{let r=nd(t.col,t.row),i=new K(new q(.88,1.72,.52),new J({color:t.color,emissive:t.id.includes(`water`)?1783874:728096,emissiveIntensity:.18,roughness:.58,metalness:.08}));i.position.set(r.x,.86,r.z),e.add(i),s(r.x,r.z,.48,.34),n.push(ju({id:t.id,position:r,inspectHeight:.95,inspectRadius:.74,responseKey:t.id===`level-four-water-cooler`?`levelFourWaterCoolerResponse`:`levelFourVendingResponse`}))}),[{col:2,row:4,rotation:0},{col:11,row:2,rotation:0},{col:21,row:2,rotation:0},{col:30,row:8,rotation:-Math.PI/2},{col:30,row:17,rotation:-Math.PI/2}].forEach(t=>{let n=dd(nd(t.col,t.row)),r=new K(new ui(2.2,1.08),o);r.position.set(n.x,1.82,n.z),r.rotation.y=n.rotation,e.add(r)}),[{col:5,row:21,text:`M.E.G. OUTPOST`,bg:`#17231f`,fg:`#c8ffe0`},{col:26,row:15,text:`NO WINDOWS`,bg:`#201a16`,fg:`#ffd2a4`}].forEach(t=>{let n=dd(nd(t.col,t.row)),r=new K(new ui(2.42,.58),new J({map:ou(t.text,t.bg,t.fg),color:16777215,emissive:2832686,emissiveIntensity:.16,roughness:.62,side:2}));r.position.set(n.x,2.22,n.z),r.rotation.y=n.rotation,e.add(r)}),{colliders:t,interactions:n}}function mf(){let e=new _n,t=12106151;e.background=new G(t),e.fog=new gn(t,.0088);let n=new na(74,1,.05,Math.hypot(Hu*Z,Uu*Z)+Z*2),r=cu(n);e.add(n);let i=nd(Gu.col,Gu.row),a={x:i.x,z:i.z,yaw:-Math.PI*.12},o=nd(Ku.col,Ku.row),s=new J({map:lf(),color:14673111,emissive:5858388,emissiveIntensity:.18,roughness:.97}),c=new J({map:uf(),color:15854809,emissive:5525574,emissiveIntensity:.16,roughness:.92}),l=new J({map:df(),color:16052441,emissive:8419936,emissiveIntensity:.32,roughness:.86}),u=new J({color:11182473,emissive:3354406,emissiveIntensity:.08,roughness:.96}),d=new K(new ui(Hu*Z,Uu*Z),s);d.rotation.x=-Math.PI/2,e.add(d);let f=new K(new ui(Hu*Z,Uu*Z),l);f.rotation.x=Math.PI/2,f.position.set(0,Yc,0),e.add(f);let{northSouth:p,eastWest:m,fixturePositions:h}=xd();h.forEach((e,t)=>{e.color=t%6==0?14221296:16775130,e.baseIntensity*=t%5==0?.66:.9,e.range*=.92,e.weak=Math.max(e.weak,t%5==0?.18:.05)});let g=[c,c,u,u,c,c];du(e,new q(4.22,qc,Jc),g,p),du(e,new q(Jc,qc,4.22),g,m),e.add(new Wi(16777198,9280394,1.28));let _=new la(15990756,.18);_.position.set(12,Yc-.3,-14),e.add(_);let v=ud(e,h),y=mu(`QUIET`,{dimBelow:.46,normalAbove:.62,dimDelay:.62,normalDelay:.86});ff(e,o);let{colliders:b,interactions:x}=pf(e),S=[...x,ju({id:`level-four-stair-door`,position:o,inspectHeight:1.58,inspectRadius:.82,responseKey:`levelFourStairDoorResponse`})],C=_u(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b}),w=_u(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b,variant:`super`,respawnMin:il,respawnVariance:al,initialSpawnChance:ol,respawnChance:sl}),T=yu(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b}),E=xu(e,{cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,avoidPositions:[i,o],blockedAabbs:b}),D=Ou(e,{spawnPosition:wu({cols:Hu,rows:Uu,isCellOpen:td,getCellCenter:nd,targetPosition:o,spawnPosition:i})[0]??o,isWalkable:O,speed:1.06}),ee=!1;function O(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=rd(e+n,t+r);return td(i.col,i.row)})?!b.some(r=>hd(e,t,n,r)):!1}function k(t,i,a){let s=0;v.forEach((e,t)=>{let n=.88+Math.sin(i*1.05+e.phase)*.035,r=t%5==0&&Math.sin(i*e.speed+e.phase)>.94?.55:1,a=Math.max(.42,n*r-e.weak);e.material.emissiveIntensity=a*e.baseIntensity*1.4,pu(e,a,.96),s+=a});let c=v.length>0?s/v.length:.82,l=Math.hypot(a.x-o.x,a.z-o.z);l<Wu&&(ee=!0),e.fog.density=.0086+(1-c)*.006,uu(r,i,a);let u=C.update(t,i,a),d=w.update(t,i,a),f=T.update(t,i,a),p=E.update(t,i,a),m=[D.update(t,i,a)];return{exitDistance:Math.round(l),exitReached:ee,entityContact:m.some(e=>e.contact),flicker:c,almondWater:u,superAlmondWater:d,flashlight:f,detector:p,entities:m,focusEntity:Au(n,m),focusInteraction:Mu(n,a,S),focusItem:Pu(C.inspect(n),w.inspect(n),E.inspect(n),T.inspect(n)),lightState:y(t,c),statusText:ee?`STAIRWELL CLEAR`:l<8?`STAIR TRACE`:`ABANDONED OFFICE`}}return{level:4,levelLabel:`LEVEL 4`,levelName:`ABANDONED OFFICE`,viewModelName:lu(r),colliderCount:b.length,nextLevel:null,scene:e,camera:n,spawn:a,isWalkable:O,update:k,tryPickup:e=>Fu(e,E,w,T,C),interact:e=>Nu(e,...S)}}function hf(e=0){let t=Dl(e);return t.level===1?Sd():t.level===2?tf():t.level===3?cf():t.level===4?mf():Vu()}var gf=.36,_f=11.5,vf=4.4,yf=150,bf=30,xf=20,Sf=.55,Cf=0,wf=50,Tf=45,Ef=200,Df=250,Of=25,kf=2,Af=1,jf=.5;function Mf(e,t,n){return Math.max(t,Math.min(n,e))}function Nf(e){return Mf(e,-Math.PI*.47,Math.PI*.47)}var Pf=class{constructor({camera:e,canvas:t,joystick:n,jumpButton:r,isWalkable:i,spawn:a}){this.camera=e,this.canvas=t,this.joystick=n,this.joystickKnob=n?.querySelector(`.joystick__knob`),this.jumpButton=r,this.isWalkable=i,this.spawn=a,this.eyeHeight=1.62,this.moveSpeed=3.05,this.sprintMultiplier=1.65,this.lookSensitivity=.0028,this.touchSensitivity=.004,this.yaw=a.yaw,this.pitch=-.02,this.lookPointerId=null,this.lookLast=new V,this.joystickPointerId=null,this.joystickInput=new V,this.keys=new Set,this.forward=new H,this.right=new H,this.move=new H,this.isLocked=!1,this.verticalVelocity=0,this.groundY=this.eyeHeight,this.bodyY=this.eyeHeight,this.isGrounded=!0,this.jumpQueued=!1,this.staminaMax=yf,this.stamina=yf,this.staminaRecoveryDelay=0,this.almondWaterTimer=0,this.superAlmondWaterTimer=0,this.isSprinting=!1,this.isDrinking=!1,this.drinkTimer=0,this.drinkItemId=null,this.drinkStaminaBonus=wf,this.drinkCancelled=!1,this.walkCycle=0,this.walkBobStrength=0,this.headBobY=0,this.rollOffset=0,this.isMoving=!1,this.movementSpeed=0,this.onCanvasPointerDown=this.onCanvasPointerDown.bind(this),this.onCanvasPointerMove=this.onCanvasPointerMove.bind(this),this.onCanvasPointerUp=this.onCanvasPointerUp.bind(this),this.onKeyDown=this.onKeyDown.bind(this),this.onKeyUp=this.onKeyUp.bind(this),this.onBlur=this.onBlur.bind(this),this.onPointerLockChange=this.onPointerLockChange.bind(this),this.onPointerLockError=this.onPointerLockError.bind(this),this.onMouseMove=this.onMouseMove.bind(this),this.onJoystickDown=this.onJoystickDown.bind(this),this.onJoystickMove=this.onJoystickMove.bind(this),this.onJoystickUp=this.onJoystickUp.bind(this),this.onJumpButtonDown=this.onJumpButtonDown.bind(this),this.onJumpButtonUp=this.onJumpButtonUp.bind(this),t.addEventListener(`pointerdown`,this.onCanvasPointerDown),t.addEventListener(`pointermove`,this.onCanvasPointerMove),t.addEventListener(`pointerup`,this.onCanvasPointerUp),t.addEventListener(`pointercancel`,this.onCanvasPointerUp),window.addEventListener(`keydown`,this.onKeyDown),window.addEventListener(`keyup`,this.onKeyUp),window.addEventListener(`blur`,this.onBlur),document.addEventListener(`pointerlockchange`,this.onPointerLockChange),document.addEventListener(`pointerlockerror`,this.onPointerLockError),window.addEventListener(`mousemove`,this.onMouseMove),n&&(n.addEventListener(`pointerdown`,this.onJoystickDown),n.addEventListener(`pointermove`,this.onJoystickMove),n.addEventListener(`pointerup`,this.onJoystickUp),n.addEventListener(`pointercancel`,this.onJoystickUp)),r&&(r.addEventListener(`pointerdown`,this.onJumpButtonDown),r.addEventListener(`pointerup`,this.onJumpButtonUp),r.addEventListener(`pointercancel`,this.onJumpButtonUp),r.addEventListener(`pointerleave`,this.onJumpButtonUp)),this.reset()}reset(){this.bodyY=this.eyeHeight,this.headBobY=0,this.rollOffset=0,this.walkCycle=0,this.walkBobStrength=0,this.camera.position.set(this.spawn.x,this.bodyY,this.spawn.z),this.verticalVelocity=0,this.isGrounded=!0,this.jumpQueued=!1,this.refreshStaminaModifiers({fill:!0}),this.staminaRecoveryDelay=0,this.isSprinting=!1,this.isDrinking=!1,this.drinkTimer=0,this.drinkItemId=null,this.drinkCancelled=!1,this.isMoving=!1,this.movementSpeed=0,this.yaw=this.spawn.yaw,this.pitch=-.025,this.applyRotation(),this.syncCameraState()}setWorld({camera:e,isWalkable:t,spawn:n}){this.camera=e,this.isWalkable=t,this.spawn=n,this.keys.clear(),this.resetJoystick(),this.reset()}canRequestPointerLock(){if(typeof this.canvas.requestPointerLock!=`function`||!document.hasFocus())return!1;try{return window.self===window.top}catch{return!1}}startDragLook(e){this.lookPointerId=e.pointerId,this.lookLast.set(e.clientX,e.clientY);try{this.canvas.setPointerCapture(e.pointerId)}catch{this.lookPointerId=null;return}this.canvas.classList.add(`is-dragging`)}applyRotation(){this.camera.rotation.order=`YXZ`,this.camera.rotation.y=this.yaw,this.camera.rotation.x=this.pitch,this.camera.rotation.z=this.rollOffset,this.syncCameraState()}syncCameraState(){this.canvas.dataset.cameraX=this.camera.position.x.toFixed(3),this.canvas.dataset.cameraY=this.camera.position.y.toFixed(3),this.canvas.dataset.cameraZ=this.camera.position.z.toFixed(3),this.canvas.dataset.cameraYaw=this.yaw.toFixed(3),this.canvas.dataset.cameraPitch=this.pitch.toFixed(3),this.canvas.dataset.grounded=String(this.isGrounded),this.canvas.dataset.stamina=this.stamina.toFixed(0),this.canvas.dataset.staminaMax=this.staminaMax.toFixed(0),this.canvas.dataset.staminaBaseMax=yf.toFixed(0),this.canvas.dataset.almondWaterActive=String(this.almondWaterTimer>0),this.canvas.dataset.almondWaterRemaining=this.almondWaterTimer.toFixed(1),this.canvas.dataset.superAlmondWaterActive=String(this.superAlmondWaterTimer>0),this.canvas.dataset.superAlmondWaterRemaining=this.superAlmondWaterTimer.toFixed(1),this.canvas.dataset.staminaRecoveryMultiplier=this.getStaminaRecoveryMultiplier().toFixed(1),this.canvas.dataset.sprinting=String(this.isSprinting),this.canvas.dataset.moving=String(this.isMoving),this.canvas.dataset.movementSpeed=this.movementSpeed.toFixed(3),this.canvas.dataset.headBob=this.headBobY.toFixed(3),this.canvas.dataset.drinking=String(this.isDrinking),this.canvas.dataset.drinkItemId=this.drinkItemId??``,this.canvas.dataset.drinkProgress=this.isDrinking?(1-this.drinkTimer/Af).toFixed(3):`0`}clearDrinkCancelled(){this.drinkCancelled=!1}queueJump(){this.jumpQueued=!0}canStandAt(e,t){return this.isWalkable(e,t,gf)}resolveMove(e,t){let n=this.camera.position.x,r=this.camera.position.z;return this.canStandAt(e,t)?{x:e,z:t}:this.canStandAt(e,r)?{x:e,z:r}:this.canStandAt(n,t)?{x:n,z:t}:{x:n,z:r}}onCanvasPointerDown(e){if(e.pointerType===`touch`){if(this.lookPointerId!==null)return;this.startDragLook(e);return}if(document.pointerLockElement!==this.canvas&&this.lookPointerId===null){if(this.canRequestPointerLock()){try{let t=this.canvas.requestPointerLock({unadjustedMovement:!0});t&&typeof t.catch==`function`&&t.catch(()=>{this.startDragLook(e)})}catch{this.startDragLook(e)}return}this.startDragLook(e)}}onCanvasPointerMove(e){if(e.pointerId!==this.lookPointerId)return;let t=e.clientX-this.lookLast.x,n=e.clientY-this.lookLast.y;this.lookLast.set(e.clientX,e.clientY);let r=e.pointerType===`touch`?this.touchSensitivity:this.lookSensitivity;this.yaw-=t*r,this.pitch=Nf(this.pitch-n*r),this.applyRotation()}onCanvasPointerUp(e){e.pointerId===this.lookPointerId&&(this.canvas.hasPointerCapture(e.pointerId)&&this.canvas.releasePointerCapture(e.pointerId),this.lookPointerId=null,this.canvas.classList.remove(`is-dragging`))}onPointerLockChange(){this.isLocked=document.pointerLockElement===this.canvas,this.canvas.classList.toggle(`is-locked`,this.isLocked),this.canvas.dataset.mouseLocked=String(this.isLocked),this.isLocked||(this.keys.clear(),this.resetJoystick())}onPointerLockError(){this.isLocked=!1,this.canvas.classList.remove(`is-locked`),this.canvas.dataset.mouseLocked=`false`}onMouseMove(e){this.isLocked&&(this.yaw-=e.movementX*this.lookSensitivity,this.pitch=Nf(this.pitch-e.movementY*this.lookSensitivity),this.applyRotation())}onKeyDown(e){if(e.code===`Space`){e.preventDefault(),e.repeat||this.queueJump();return}[`KeyW`,`KeyA`,`KeyS`,`KeyD`,`ShiftLeft`,`ShiftRight`].includes(e.code)&&(e.preventDefault(),this.keys.add(e.code))}onKeyUp(e){this.keys.delete(e.code)}onBlur(){this.keys.clear(),this.isSprinting=!1,this.isMoving=!1,this.movementSpeed=0,this.resetJoystick()}onJoystickDown(e){this.joystickPointerId===null&&(e.preventDefault(),e.stopPropagation(),this.joystickPointerId=e.pointerId,this.joystick.setPointerCapture(e.pointerId),this.updateJoystick(e))}onJoystickMove(e){e.pointerId===this.joystickPointerId&&(e.preventDefault(),e.stopPropagation(),this.updateJoystick(e))}onJoystickUp(e){e.pointerId===this.joystickPointerId&&(e.preventDefault(),e.stopPropagation(),this.joystick.hasPointerCapture(e.pointerId)&&this.joystick.releasePointerCapture(e.pointerId),this.joystickPointerId=null,this.resetJoystick())}updateJoystick(e){let t=this.joystick.getBoundingClientRect(),n=t.width*.32,r=e.clientX-(t.left+t.width/2),i=e.clientY-(t.top+t.height/2),a=Math.hypot(r,i),o=a>n?n/a:1,s=r*o,c=i*o;this.joystickInput.set(s/n,-c/n),this.joystickKnob.style.transform=`translate(${s}px, ${c}px)`,this.joystick.classList.add(`is-active`)}resetJoystick(){this.joystickInput.set(0,0),this.joystickKnob&&(this.joystickKnob.style.transform=`translate(0, 0)`),this.joystick?.classList.remove(`is-active`)}onJumpButtonDown(e){e.preventDefault(),e.stopPropagation(),this.queueJump(),this.jumpButton.classList.add(`is-active`),this.jumpButton.setPointerCapture(e.pointerId)}onJumpButtonUp(e){e.preventDefault(),e.stopPropagation(),this.jumpButton.hasPointerCapture(e.pointerId)&&this.jumpButton.releasePointerCapture(e.pointerId),this.jumpButton.classList.remove(`is-active`)}updateVerticalMotion(e){this.jumpQueued&&this.isGrounded&&(this.verticalVelocity=vf,this.isGrounded=!1),this.jumpQueued=!1,this.verticalVelocity-=_f*e,this.bodyY+=this.verticalVelocity*e,this.bodyY<=this.groundY&&(this.bodyY=this.groundY,this.verticalVelocity=0,this.isGrounded=!0)}getStaminaRecoveryMultiplier(){return this.superAlmondWaterTimer>0?kf:1}getCurrentStaminaMax(){return this.superAlmondWaterTimer>0?Df:this.almondWaterTimer>0?Ef:yf}refreshStaminaModifiers({fill:e=!1}={}){this.staminaMax=this.getCurrentStaminaMax(),this.stamina=e?this.staminaMax:Math.min(this.stamina,this.staminaMax)}updateStaminaEffects(e){let t=this.staminaMax;this.almondWaterTimer>0&&(this.almondWaterTimer=Math.max(0,this.almondWaterTimer-e)),this.superAlmondWaterTimer>0&&(this.superAlmondWaterTimer=Math.max(0,this.superAlmondWaterTimer-e)),this.refreshStaminaModifiers({fill:!1}),this.staminaMax<t&&(this.stamina=Math.min(this.stamina,this.staminaMax))}updateHeadBob(e,t,n){let r=n&&t>1e-4&&this.isGrounded;this.isMoving=r,this.movementSpeed=e>0?t/e:0;let i=+!!r,a=Math.min(1,e*(r?10:7));if(this.walkBobStrength+=(i-this.walkBobStrength)*a,r){let n=this.moveSpeed*(this.isSprinting?this.sprintMultiplier:1),r=t/Math.max(e*n,1e-4),i=(this.isSprinting?10.35:9.4)*Math.min(1.18,Math.max(.55,r));this.walkCycle+=i*e}let o=this.isSprinting?.038:.032,s=this.isSprinting?.014:.012;this.headBobY=Math.sin(this.walkCycle*2)*o*this.walkBobStrength,this.rollOffset=Math.sin(this.walkCycle)*s*this.walkBobStrength,this.camera.position.y=this.bodyY+this.headBobY}update(e){this.updateStaminaEffects(e),this.updateDrinking(e);let t=this.joystickInput.x,n=this.joystickInput.y;this.isSprinting=!1;let r=0;this.keys.has(`KeyA`)&&--t,this.keys.has(`KeyD`)&&(t+=1),this.keys.has(`KeyW`)&&(n+=1),this.keys.has(`KeyS`)&&--n;let i=Math.hypot(t,n),a=!1;if(i>=.01){a=!0,i>1&&(t/=i,n/=i),this.forward.set(-Math.sin(this.yaw),0,-Math.cos(this.yaw)).normalize(),this.right.set(Math.cos(this.yaw),0,-Math.sin(this.yaw)).normalize(),this.move.copy(this.forward).multiplyScalar(n).addScaledVector(this.right,t);let o=n>.35&&this.keys.has(`KeyW`)&&(this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`)),s=this.joystickPointerId!==null&&this.joystickInput.y>.88,c=o||s;this.isDrinking&&c?this.cancelDrink(!0):(this.isSprinting=c&&this.stamina>Cf,this.isSprinting&&(this.stamina=Math.max(0,this.stamina-bf*e),this.staminaRecoveryDelay=Sf));let l=this.isDrinking?jf:1,u=this.moveSpeed*(this.isSprinting?this.sprintMultiplier:1)*l*e;this.move.normalize().multiplyScalar(u);let d=this.camera.position.x,f=this.camera.position.z,p=this.resolveMove(d+this.move.x,f+this.move.z);r=Math.hypot(p.x-d,p.z-f),this.camera.position.x=p.x,this.camera.position.z=p.z}if(!this.isSprinting&&(this.staminaRecoveryDelay=Math.max(0,this.staminaRecoveryDelay-e),this.staminaRecoveryDelay===0)){let t=(a?xf*.72:xf)*this.getStaminaRecoveryMultiplier();this.stamina=Math.min(this.staminaMax,this.stamina+t*e)}this.updateVerticalMotion(e),this.updateHeadBob(e,r,a),this.applyRotation()}getState(){return{stamina:this.stamina,staminaMax:this.staminaMax,staminaBaseMax:yf,sprinting:this.isSprinting,moving:this.isMoving,grounded:this.isGrounded,movementSpeed:this.movementSpeed,almondWaterActive:this.almondWaterTimer>0,almondWaterRemaining:this.almondWaterTimer,almondWaterDuration:Tf,superAlmondWaterActive:this.superAlmondWaterTimer>0,superAlmondWaterRemaining:this.superAlmondWaterTimer,superAlmondWaterDuration:Of,staminaRecoveryMultiplier:this.getStaminaRecoveryMultiplier(),activeBuffs:this.getActiveBuffs(),isDrinking:this.isDrinking,drinkItemId:this.drinkItemId,drinkProgress:this.isDrinking?1-this.drinkTimer/Af:0,drinkCancelled:this.drinkCancelled}}getActiveBuffs(){return this.superAlmondWaterTimer>0?[{id:`super-almond-water`,remaining:this.superAlmondWaterTimer,duration:Of,staminaMax:Df,recoveryMultiplier:kf}]:this.almondWaterTimer>0?[{id:`almond-water`,remaining:this.almondWaterTimer,duration:Tf,staminaMax:Ef,recoveryMultiplier:1}]:[]}startDrink(e,{staminaBonus:t=wf}={}){return this.isDrinking||e!==`almond-water`&&e!==`super-almond-water`?!1:(this.isDrinking=!0,this.drinkTimer=Af,this.drinkItemId=e,this.drinkStaminaBonus=t,this.drinkCancelled=!1,this.isSprinting=!1,this.staminaRecoveryDelay=0,this.syncCameraState(),!0)}cancelDrink(e=!0){return this.isDrinking?(this.isDrinking=!1,this.drinkTimer=0,e&&(this.drinkCancelled=!0),this.syncCameraState(),!0):!1}updateDrinking(e){if(this.isDrinking&&(this.drinkTimer=Math.max(0,this.drinkTimer-e),this.drinkTimer<=0)){let e=this.drinkItemId,t=this.drinkStaminaBonus;this.isDrinking=!1,this.drinkTimer=0,e===`super-almond-water`?this.drinkSuperAlmondWater():this.drinkAlmondWater(t),this.notifyDrinkComplete?.(e)}}drinkAlmondWater(e=wf){if(this.superAlmondWaterTimer<=0){let t=Math.max(0,Math.min(e,Ef-yf));this.almondWaterTimer=Tf,this.staminaMax=Math.min(Ef,yf+t)}return this.stamina=this.staminaMax,this.staminaRecoveryDelay=0,this.isSprinting=!1,this.syncCameraState(),this.getState()}drinkSuperAlmondWater(){return this.superAlmondWaterTimer=Of,this.almondWaterTimer=0,this.refreshStaminaModifiers({fill:!0}),this.staminaRecoveryDelay=0,this.isSprinting=!1,this.syncCameraState(),this.getState()}},Q=document.querySelector(`#scene`),Ff=document.querySelector(`#joystick`),If=document.querySelector(`#jump-button`),Lf=document.querySelector(`#use-button`),$=document.querySelector(`#action-button`),Rf=document.querySelector(`#flashlight-button`),zf=document.querySelector(`#detector-button`),Bf=document.querySelector(`#pause-button`),Vf=document.querySelector(`#status-text`),Hf=document.querySelector(`#level-select`),Uf=document.querySelector(`#language-select`),Wf=document.querySelector(`#distance-readout`),Gf=document.querySelector(`#light-readout`),Kf=document.querySelector(`#fps-readout`),qf=document.querySelector(`.hud`),Jf=document.querySelector(`.stamina-meter`),Yf=document.querySelector(`#stamina-fill`),Xf=document.querySelector(`#stamina-readout`),Zf=document.querySelector(`#flashlight-meter`),Qf=document.querySelector(`#flashlight-fill`),$f=document.querySelector(`#flashlight-readout`),ep=document.querySelector(`#detector-meter`),tp=document.querySelector(`#detector-fill`),np=document.querySelector(`#detector-readout`),rp=document.querySelector(`#drinking-meter`),ip=document.querySelector(`#drinking-fill`),ap=document.querySelector(`#drinking-readout`),op=document.querySelector(`#loading-overlay`),sp=document.querySelector(`#loading-fill`),cp=document.querySelector(`#loading-status`),lp=document.querySelector(`#exit-overlay`),up=lp?.querySelector(`strong`),dp=lp?.querySelector(`span`),fp=op?.querySelector(`.loading-overlay__panel span`),pp=document.querySelector(`#item-info`),mp=document.querySelector(`#item-info-name`),hp=document.querySelector(`#item-info-effect`),gp=document.querySelector(`#item-info-action`),_p=document.querySelector(`#buff-list`),vp=document.querySelector(`#entity-markers`),yp=document.querySelector(`#pause-overlay`),bp=document.querySelector(`#pause-title`),xp=document.querySelector(`#pause-subtitle`),Sp=document.querySelector(`#inventory-bar`),Cp=document.querySelector(`#inventory-slots`),wp=document.querySelector(`#inventory-prev`),Tp=document.querySelector(`#inventory-next`),Ep=document.querySelector(`#tutorial-overlay`),Dp=document.querySelector(`#tutorial-skip`),Op=document.querySelector(`#tutorial-prev`),kp=document.querySelector(`#tutorial-next`),Ap=document.querySelector(`.tutorial-pages`),jp=document.querySelectorAll(`.tutorial-pagination__dot`),Mp=`backrooms-tutorial-seen`,Np=4,Pp=0,Fp=1.25,Ip=.75,Lp=.75,Rp=48,zp=58,Bp=460,Vp=1250,Hp=100,Up=4.2,Wp=5,Gp=60,Kp=72,qp=`backrooms-language`,Jp=45,Yp=25,Xp=50,Zp=1,Qp=600,$p={"zh-CN":{"almond-water":{name:`杏仁水`,effect:`+50 疾跑上限 / 45秒`,action:`F / 按钮拾取并饮用`},"super-almond-water":{name:`超级杏仁水`,effect:`体力上限 250 / 恢复速度 x2`,action:`F / 按钮拾取并饮用`},flashlight:{name:`手电筒`,effect:`照亮前方 / 电量有限`,action:`F / 按钮拾取 · 拾取后按 E 开关`},detector:{name:`实体探测仪`,effect:`标记大范围实体 / 5秒扫描`,action:`F / 按钮拾取 · 拾取后按 R 扫描`}},en:{"almond-water":{name:`ALMOND WATER`,effect:`+50 STAMINA CAPACITY / 45s`,action:`F / BUTTON PICK UP`},"super-almond-water":{name:`SUPER ALMOND WATER`,effect:`250 STAMINA CAP / RECOVERY x2`,action:`F / BUTTON DRINK`},flashlight:{name:`FLASHLIGHT`,effect:`FORWARD BEAM / LIMITED BATTERY`,action:`F / BUTTON PICK UP · E TO TOGGLE AFTER PICKUP`},detector:{name:`ENTITY DETECTOR`,effect:`WIDE ENTITY PING / 5s SCAN`,action:`F / BUTTON PICK UP · R TO SCAN AFTER PICKUP`}}},em={"zh-CN":{bacteria:{name:`细菌实体`,marker:`细菌`,effect:`瘦长、低速追击；接触即失败`,action:`保持距离`,failSubtitle:`接触细菌实体`},"super-bacteria":{name:`超级细菌`,marker:`超级细菌`,effect:`更强的电站实体；接触即失败`,action:`保持距离`,failSubtitle:`接触超级细菌实体`},hound:{name:`猎犬实体`,marker:`猎犬`,effect:`四足追击；速度比细菌更快`,action:`避开直线距离`,failSubtitle:`被猎犬实体捕获`}},en:{bacteria:{name:`BACTERIA ENTITY`,marker:`BACTERIA`,effect:`Tall slow pursuer; contact is fatal.`,action:`KEEP DISTANCE`,failSubtitle:`BACTERIA CONTACT`},"super-bacteria":{name:`SUPER BACTERIA`,marker:`SUPER BACTERIA`,effect:`Stronger station entity; contact is fatal.`,action:`KEEP DISTANCE`,failSubtitle:`SUPER BACTERIA CONTACT`},hound:{name:`HOUND`,marker:`HOUND`,effect:`Quadruped pursuer; faster than Bacteria.`,action:`BREAK LINE OF SIGHT`,failSubtitle:`HOUND CONTACT`}}},tm={"zh-CN":{"level-one-elevator-panel":{name:`电梯面板`,effect:`显示出口同步状态`,action:`F / 按钮检查`,response:`电梯还在等待稳定信号`},"level-two-valve":{name:`压力阀`,effect:`管道压力不稳定`,action:`F / 按钮转动`,response:`阀门只是发出空洞的摩擦声`},"level-two-service-door":{name:`维修门`,effect:`门锁被管道热气卡住`,action:`F / 按钮检查`,response:`门后传来低频管道声`},"level-three-breaker":{name:`断路器`,effect:`出口供电点`,action:`F / 按钮检查`,response:`电弧闪过，出口信号短暂增强`},"level-three-generator":{name:`发电机`,effect:`声音不稳，但仍在运行`,action:`F / 按钮倾听`,response:`发电机节奏忽然乱了一拍`},"level-four-terminal":{name:`办公终端`,effect:`屏幕只剩一行警告`,action:`F / 按钮阅读`,response:`终端显示：不要相信窗外的光`},"level-four-files":{name:`文件堆`,effect:`上面只有重复的楼层图`,action:`F / 按钮翻看`,response:`每张图的出口都被手写圈掉`},"level-four-vending":{name:`自动售货机`,effect:`已无货，仍在轻声运转`,action:`F / 按钮检查`,response:`退币口里只有灰尘`},"level-four-water-cooler":{name:`饮水机`,effect:`框体温冷，水桶已空`,action:`F / 按钮检查`,response:`水泡声停了，像是有人在听`},"level-four-stair-door":{name:`楼梯门`,effect:`通往更深的办公区`,action:`F / 按钮检查`,response:`门把手很冷，楼梯间里没有回声`}},en:{"level-one-elevator-panel":{name:`ELEVATOR PANEL`,effect:`Shows unstable exit synchronization.`,action:`F / BUTTON INSPECT`,response:`The elevator is still waiting for a stable signal.`},"level-two-valve":{name:`PRESSURE VALVE`,effect:`Pipe pressure is unstable.`,action:`F / BUTTON TURN`,response:`The valve answers with a hollow scrape.`},"level-two-service-door":{name:`SERVICE DOOR`,effect:`Heat and pressure have jammed the lock.`,action:`F / BUTTON INSPECT`,response:`A low pipe drone leaks through the door.`},"level-three-breaker":{name:`BREAKER`,effect:`Exit power junction.`,action:`F / BUTTON INSPECT`,response:`An arc snaps across the breaker; the exit signal spikes.`},"level-three-generator":{name:`GENERATOR`,effect:`Unsteady, but still running.`,action:`F / BUTTON LISTEN`,response:`The generator rhythm skips for one beat.`},"level-four-terminal":{name:`OFFICE TERMINAL`,effect:`Only one warning line remains.`,action:`F / BUTTON READ`,response:`Terminal: DO NOT TRUST THE LIGHT OUTSIDE.`},"level-four-files":{name:`FILE STACK`,effect:`Repeated floor plans with no dates.`,action:`F / BUTTON READ`,response:`Every printed exit is circled by hand.`},"level-four-vending":{name:`VENDING MACHINE`,effect:`Empty, still humming.`,action:`F / BUTTON INSPECT`,response:`Only dust sits in the coin return.`},"level-four-water-cooler":{name:`WATER COOLER`,effect:`Cold frame, empty bottle.`,action:`F / BUTTON INSPECT`,response:`The bubbling stops, as if something is listening.`},"level-four-stair-door":{name:`STAIR DOOR`,effect:`Leads deeper into the office level.`,action:`F / BUTTON INSPECT`,response:`The handle is cold; no echo comes back.`}}},nm={"zh-CN":{"almond-water":{name:`杏仁水`,detail:`+50 体力上限`},"super-almond-water":{name:`超级杏仁水`,detail:`体力上限 250 · 恢复 x2`}},en:{"almond-water":{name:`ALMOND WATER`,detail:`+50 STAMINA CAP`},"super-almond-water":{name:`SUPER ALMOND WATER`,detail:`250 STAMINA CAP · RECOVERY x2`}}},rm={"zh-CN":{"almond-water":`杏仁水`,"super-almond-water":`超级杏仁水`,flashlight:`手电筒`,detector:`探测仪`,flashlightAcquired:`已获得手电筒`,flashlightRefilled:`手电筒电量已满`,detectorAcquired:`探测仪已激活`,detectorReady:`就绪`,detectorReadyHint:`按 E 使用`,detectorScan:`扫描 {seconds}秒`,detectorCharge:`充能 {seconds}秒`,bacteriaMarker:`细菌实体`,bacteriaFailTitle:`失联`,bacteriaFailSubtitle:`接触细菌实体`,superBacteriaMarker:`超级细菌`,superBacteriaFailSubtitle:`接触超级细菌实体`,almondWaterUsed:`杏仁水 {seconds}秒`,superAlmondWaterUsed:`超级杏仁水 {seconds}秒`,almondWaterDrinking:`饮用中`,almondWaterCancelled:`饮用取消`,pauseTitle:`已暂停`,pauseSubtitle:`按 ESC 或点击继续`,inventoryHint:`← → 切换 / E 使用`,inventoryEmpty:`背包为空`,pickupEmpty:`无物品可拾取`},en:{"almond-water":`ALMOND WATER`,"super-almond-water":`SUPER ALMOND WATER`,flashlight:`FLASHLIGHT`,detector:`DETECTOR`,flashlightAcquired:`FLASHLIGHT ACQUIRED`,flashlightRefilled:`FLASHLIGHT BATTERY FULL`,detectorAcquired:`DETECTOR ONLINE`,detectorReady:`READY`,detectorReadyHint:`PRESS E TO USE`,detectorScan:`SCAN {seconds}s`,detectorCharge:`CHARGE {seconds}s`,bacteriaMarker:`BACTERIA`,bacteriaFailTitle:`SIGNAL LOST`,bacteriaFailSubtitle:`BACTERIA CONTACT`,superBacteriaMarker:`SUPER BACTERIA`,superBacteriaFailSubtitle:`SUPER BACTERIA CONTACT`,almondWaterUsed:`ALMOND WATER {seconds}s`,superAlmondWaterUsed:`SUPER ALMOND WATER {seconds}s`,almondWaterDrinking:`DRINKING`,almondWaterCancelled:`DRINK CANCELLED`,pauseTitle:`PAUSED`,pauseSubtitle:`ESC / TAP TO RESUME`,inventoryHint:`← → SWITCH / E USE`,inventoryEmpty:`INVENTORY EMPTY`,pickupEmpty:`NO ITEM IN RANGE`}};[qf,Ff,If,Lf,$,Rf,zf,Bf,op,Sp].forEach(e=>{e?.removeAttribute(`hidden`)}),lp?.setAttribute(`hidden`,``);var im=new Gc({canvas:Q,antialias:!0,powerPreference:`high-performance`}),am=Math.min(window.devicePixelRatio,Fp);im.setPixelRatio(am),im.outputColorSpace=Re,im.toneMapping=4,im.toneMappingExposure=1.18;var om=new ia(16773829,0,46,.5,.72,1.68);om.position.set(.18,-.12,-.16),om.name=`player-flashlight`;var sm=new sn;sm.position.set(0,-.16,-1);function cm(){return Dl(Number(new URLSearchParams(window.location.search).get(`level`))).level}var lm=hf(cm());function um(e){e.add(om),e.add(sm),om.target=sm}um(lm.camera);var dm=new Pf({camera:lm.camera,canvas:Q,joystick:Ff,jumpButton:If,isWalkable:lm.isWalkable,spawn:lm.spawn}),fm=Kc(),pm=new Ea;dm.notifyDrinkComplete=e=>{(e===`almond-water`||e===`super-almond-water`)&&(Ym(e),Ch())};var mm=0,hm=0,gm=0,_m=0,vm=!1,ym=!1,bm=!1,xm=null,Sm=0,Cm=``,wm=!1,Tm=!1,Em=0,Dm=!1,Om=0,km=0,Am=`zh-CN`,jm=new H,Mm=null,Nm={flashlight:{id:`flashlight`,type:`toggle`,unique:!0,stackable:!1},detector:{id:`detector`,type:`scan`,unique:!0,stackable:!1},"almond-water":{id:`almond-water`,type:`consumable`,unique:!1,stackable:!0},"super-almond-water":{id:`super-almond-water`,type:`consumable`,unique:!1,stackable:!0}},Pm={flashlight:`<defs>
    ...
    <path d="M 92 38 L 100 30 M 92 50 L 100 50 M 92 62 L 100 70" stroke="#fffbe0" stroke-width="0.8" opacity="0.35" fill="none"/>`,"almond-water":`<defs>
    ...
    <rect x="62" y="28" width="2" height="58" fill="#000" opacity="0.15"/>`,"super-almond-water":`<defs>
    ...
    <rect x="62" y="28" width="2" height="58" fill="#000" opacity="0.15"/>`,detector:`<defs>
    ...
    <rect x="14" y="84" width="72" height="4" rx="2" fill="#1a1410"/>`},Fm=0;function Im(e){let t=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);t.setAttribute(`viewBox`,`0 0 100 100`),t.setAttribute(`preserveAspectRatio`,`xMidYMid meet`),t.classList.add(`inventory-slot__svg`);let n=Fm++,r=Pm[e];return r&&(r=r.replace(/id="(fl-body|fl-lens|aw-body|saw-body|det-body|det-screen|det-glow)"/g,`id="$1-${n}"`).replace(/url\(#(fl-body|fl-lens|aw-body|saw-body|det-body|det-screen|det-glow)\)/g,`url(#$1-${n})`),t.innerHTML=r),t}var Lm=[],Rm=-1,zm=!1,Bm=!1,Vm=!1,Hm=!1,Um=0,Wm=!1,Gm=!1;try{let e=window.localStorage?.getItem(qp);(e===`zh-CN`||e===`en`)&&(Am=e)}catch{Am=`zh-CN`}Uf&&(Uf.value=Am),document.documentElement.lang=Am,Q.dataset.language=Am;function Km(e,t){return e[Am]?.[t]??e.en?.[t]??e[`zh-CN`]?.[t]??{}}function qm(e){return Lm.findIndex(t=>t.id===e)}function Jm(e,{silent:t=!1}={}){let n=Nm[e];if(!n)return!1;let r=Lm[qm(e)];return r?(n.stackable&&(r.count+=1),!0):(Lm.push({id:e,count:(n.unique,1),type:n.type}),Rm=Lm.length-1,!0)}function Ym(e){let t=qm(e);return t===-1?!1:(--Lm[t].count,Lm[t].count<=0&&(Lm.splice(t,1),Lm.length===0?Rm=-1:Rm>=Lm.length?Rm=Lm.length-1:Rm>t&&--Rm),!0)}function Xm(e){if(Lm.length===0){Rm=-1;return}Rm=(Rm+e+Lm.length)%Lm.length}function Zm(){return Rm>=0?Lm[Rm]:null}function Qm(e,t={}){let n=Km(rm,e);return typeof n==`string`?n.replace(/\{(\w+)\}/g,(e,n)=>String(t[n]??``)):String(e)}function $m(){Hf&&(Hf.value=String(lm.level)),fp&&(fp.textContent=lm.levelLabel),Q.dataset.level=String(lm.level),Q.dataset.levelName=lm.levelName,Q.dataset.viewModel=lm.viewModelName??`NONE`,Q.dataset.colliderCount=String(lm.colliderCount??0)}function eh(e){if(Array.isArray(e)){e.forEach(eh);return}Object.values(e).forEach(e=>{e?.isTexture&&e.dispose()}),e.dispose()}function th(e){e.scene.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&eh(e.material)})}function nh(e){let t=new URL(window.location.href);t.searchParams.set(`level`,String(e)),window.history.replaceState(null,``,t)}function rh(e,{updateUrl:t=!1}={}){let n=lm;lm=hf(e),um(lm.camera),dm.setWorld({camera:lm.camera,isWalkable:lm.isWalkable,spawn:lm.spawn}),ym=!1,bm=!1,Q.dataset.exitReached=`false`,Q.dataset.gameFailed=`false`,vp?.replaceChildren(),$m(),t&&nh(lm.level),lh(),th(n)}function ih(e,t){up&&(up.textContent=e),dp&&(dp.textContent=t)}function ah(e,t){ih(e,t),lp?.removeAttribute(`hidden`),lp?.classList.add(`is-visible`)}function oh(){lp?.classList.remove(`is-visible`),window.setTimeout(()=>lp?.setAttribute(`hidden`,``),Bp)}function sh(e){let t=Dl(e);xm={nextLevel:t.level,elapsed:0},Q.dataset.transitioning=`true`,Q.dataset.exitReached=`true`,ah(t.levelLabel,t.levelName)}function ch(e){if(!xm||(xm.elapsed+=e*1e3,xm.elapsed<Vp))return;let t=xm.nextLevel;xm=null,rh(t,{updateUrl:!0}),Q.dataset.transitioning=`false`,Q.dataset.exitReached=`false`,oh()}Hf?.addEventListener(`change`,()=>{let e=Number(Hf.value);e!==lm.level&&(xm=null,ym=!1,bm=!1,Q.dataset.transitioning=`false`,Q.dataset.exitReached=`false`,Q.dataset.gameFailed=`false`,oh(),rh(e,{updateUrl:!0}))}),Uf?.addEventListener(`change`,()=>{let e=Uf.value===`en`?`en`:`zh-CN`;Am=e,document.documentElement.lang=e,Q.dataset.language=e,mh(dm.getState()),vh(),Ch(),Th(),Mm&&Lh(Mm),Bm&&(bp&&(bp.textContent=Qm(`pauseTitle`)),xp&&(xp.textContent=Qm(`pauseSubtitle`)));try{window.localStorage?.setItem(qp,e)}catch{}});function lh(){let e=window.innerWidth,t=window.innerHeight;im.setSize(e,t,!1),lm.camera.aspect=e/t,lm.camera.updateProjectionMatrix()}function uh(e){let t=Math.max(Ip,Math.min(Math.min(window.devicePixelRatio,Fp),e));Math.abs(t-am)<.01||(am=t,im.setPixelRatio(am),lh())}function dh(e){hm+=1,gm+=e,!(gm<Lp)&&(_m=Math.round(hm/gm),_m<Rp?uh(am-.1):_m>zp&&uh(am+.05),Kf.textContent=`${_m} FPS`,Kf.dataset.quality=am<1?`LOW`:`HIGH`,Q.dataset.fps=String(_m),Q.dataset.pixelRatio=am.toFixed(2),hm=0,gm=0)}function fh(){if(vm)return;let e=Math.min(1,.18+mm/42);sp&&(sp.style.transform=`scaleX(${e.toFixed(3)})`),cp&&(cp.textContent=e>.7?`SIGNAL LOCK`:`NOCLIP SYNC`),e>=1&&Q.dataset.sceneReady===`true`&&(vm=!0,op?.classList.add(`is-hidden`),window.setTimeout(()=>op?.setAttribute(`hidden`,``),Bp))}function ph(e){if(!e)return;let t=Math.max(0,Math.min(1,e.stamina/e.staminaMax)),n=e.activeBuffs??[],r=n.find(e=>e.id===`almond-water`||e.id===`super-almond-water`),i=Math.max(0,r?.remaining??0),a=!!r;if(Yf&&(Yf.style.transform=`scaleX(${t.toFixed(3)})`),Xf){let t=`${Math.round(e.stamina)}/${Math.round(e.staminaMax)}`;Xf.textContent=a?`${t} ${Math.ceil(i)}s`:t}Jf?.dataset&&(Jf.dataset.state=t<.24?`low`:a?`boosted`:`ready`),Q.dataset.stamina=String(Math.round(t*100)),Q.dataset.staminaValue=String(Math.round(e.stamina)),Q.dataset.staminaMax=String(Math.round(e.staminaMax)),Q.dataset.staminaBaseMax=String(Math.round(e.staminaBaseMax)),Q.dataset.almondWaterActive=String(a),Q.dataset.almondWaterRemaining=i.toFixed(1),Q.dataset.superAlmondWaterActive=String(e.superAlmondWaterActive),Q.dataset.superAlmondWaterRemaining=(e.superAlmondWaterRemaining??0).toFixed(1),Q.dataset.staminaRecoveryMultiplier=String(e.staminaRecoveryMultiplier??1),Q.dataset.activeBuffs=n.map(e=>e.id).join(`,`),Q.dataset.sprinting=String(e.sprinting)}function mh(e){if(!_p)return;let t=e?.activeBuffs??[];_p.hidden=t.length===0,_p.replaceChildren(...t.map(e=>{let t=Km(nm,e.id),n=document.createElement(`div`);n.className=`buff-card`,n.dataset.buff=e.id;let r=document.createElement(`div`);r.className=`buff-card__top`;let i=document.createElement(`span`);i.className=`buff-card__name`,i.textContent=t.name??e.id;let a=document.createElement(`span`);a.className=`buff-card__time`,a.textContent=`${Math.ceil(Math.max(0,e.remaining))}s`,r.append(i,a);let o=document.createElement(`strong`);o.className=`buff-card__detail`,o.textContent=t.detail??``;let s=document.createElement(`div`);s.className=`buff-card__bar`;let c=document.createElement(`div`);c.className=`buff-card__fill`;let l=e.duration>0?Math.max(0,Math.min(1,e.remaining/e.duration)):0;return c.style.transform=`scaleX(${l.toFixed(3)})`,s.append(c),n.append(r,o,s),n}))}function hh(){let e=Em/Hp;Zf&&(Zf.hidden=!wm,Zf.dataset.state=e<.18?`low`:Tm?`on`:`ready`),Qf&&(Qf.style.transform=`scaleX(${Math.max(0,e).toFixed(3)})`),$f&&($f.textContent=wm?`${Math.round(Em)}%`:`--`),Rf&&(Rf.classList.toggle(`is-visible`,wm),Rf.classList.toggle(`is-active`,Tm),Rf.disabled=!wm||Em<=0),Q.dataset.flashlightOwned=String(wm),Q.dataset.flashlightOn=String(Tm),Q.dataset.flashlightBattery=String(Math.round(Em))}function gh(e){Tm&&(Em=Math.max(0,Em-Up*e),Em<=0&&(Tm=!1));let t=Em/Hp;om.intensity=wm&&Tm&&Em>0?22.8*Math.max(.46,t):0,om.distance=28+t*24,hh()}function _h(){!wm||Em<=0||(Tm=!Tm,hh())}function vh(){ep&&(ep.hidden=!Dm,ep.dataset.state=Om>0?`active`:km>0?`cooldown`:`ready`);let e=1;Om>0?e=Om/Wp:km>0&&(e=1-km/Gp),tp&&(tp.style.transform=`scaleX(${Math.max(0,Math.min(1,e)).toFixed(3)})`),np&&(Dm?Om>0?np.textContent=Qm(`detectorScan`,{seconds:Math.ceil(Om)}):km>0?np.textContent=Qm(`detectorCharge`,{seconds:Math.ceil(km)}):np.textContent=Qm(`detectorReady`):np.textContent=`--`),zf&&(zf.classList.toggle(`is-visible`,Dm),zf.classList.toggle(`is-active`,Om>0),zf.disabled=!Dm||Om>0||km>0),Q.dataset.detectorOwned=String(Dm),Q.dataset.detectorActive=String(Om>0),Q.dataset.detectorActiveRemaining=Om.toFixed(1),Q.dataset.detectorCooldown=km.toFixed(1)}function yh(){vp?.replaceChildren()}function bh(e){let t=e.entities??[],n=t.map(e=>e.distance).filter(Number.isFinite).sort((e,t)=>e-t)[0];if(Q.dataset.entityCount=String(t.length),Q.dataset.nearestEntityDistance=Number.isFinite(n)?String(Math.round(n*10)/10):``,Q.dataset.entityContact=String(!!e.entityContact),!vp||!Dm||Om<=0){yh();return}let r=t.filter(e=>e?.active&&Number.isFinite(e.distance)&&e.distance<=Kp);vp.replaceChildren(...r.map(e=>{if(jm.set(e.x,e.y??1.5,e.z).project(lm.camera),jm.z<-1||jm.z>1)return null;let t=(jm.x*.5+.5)*window.innerWidth,n=(-jm.y*.5+.5)*window.innerHeight;if(t<-80||t>window.innerWidth+80||n<-80||n>window.innerHeight+80)return null;let r=document.createElement(`div`);r.className=`entity-marker`,e.id===`super-bacteria`&&r.classList.add(`entity-marker--super`),e.id===`hound`&&r.classList.add(`entity-marker--hound`);let i=document.createElement(`strong`);i.textContent=Km(em,e.id)?.marker??e.id.toUpperCase();let a=document.createElement(`span`);return a.textContent=`${Math.round(e.distance)}m`,r.style.left=`${t}px`,r.style.top=`${n}px`,r.append(i,a),r}).filter(Boolean))}function xh(){!Dm||Om>0||km>0||(Om=Wp,km=0,vh())}function Sh(e,t){let n=Om>0;Om>0?Om=Math.max(0,Om-e):km>0&&(km=Math.max(0,km-e)),n&&Om===0&&(km=Gp),vh(),bh(t)}function Ch(){if(!Sp||!Cp)return;let e=Lm.length>0;if(Sp.classList.toggle(`is-visible`,!0),Sp.classList.toggle(`is-empty`,!e),Cp&&(Cp.dataset.emptyText=Qm(`inventoryEmpty`)),!e){Cp.replaceChildren(),wp?.setAttribute(`hidden`,``),Tp?.setAttribute(`hidden`,``),Th();return}wp?.removeAttribute(`hidden`),Tp?.removeAttribute(`hidden`);let t=Rm>=0&&Rm<Lm.length?Rm:0,n=document.createDocumentFragment();for(let e=1;e<=t;e+=1)n.append(wh(Lm[t-e],-e));n.append(wh(Lm[t],0));for(let e=1;e<Lm.length-t;e+=1)n.append(wh(Lm[t+e],e));Cp.replaceChildren(n),Th()}function wh(e,t){let n=Nm[e.id],r=document.createElement(`div`);r.className=`inventory-slot`,r.dataset.type=e.id,r.dataset.position=String(t);let i=document.createElement(`div`);if(i.className=`inventory-slot__icon`,i.appendChild(Im(e.id)),r.append(i),n?.stackable&&e.count>1){let t=document.createElement(`span`);t.className=`inventory-slot__count`,t.textContent=String(e.count),r.append(t)}if(t===0){let t=document.createElement(`span`);t.className=`inventory-slot__name`,t.textContent=Km(rm,e.id)||e.id,r.append(t)}return r}function Th(){if(!$)return;let e=!!Zm();$.classList.toggle(`is-visible`,e),$.disabled=!e}function Eh(e){if(!rp)return;let t=!!e?.isDrinking;rp.hidden=!t&&!zm,rp.dataset.state=t?`active`:`cancelled`;let n=Math.max(0,Math.min(1,e?.drinkProgress??0));ip&&(ip.style.transform=t?`scaleX(${n.toFixed(3)})`:`scaleX(0)`),ap&&(t?ap.textContent=`${Math.max(0,Zp-n*Zp).toFixed(1)}s`:zm?ap.textContent=Qm(`almondWaterCancelled`):ap.textContent=`--`),zm&&!t&&pm.elapsedTime>Dh&&(zm=!1,rp.hidden=!0)}var Dh=0;function Oh(e,{fromUnlock:t=!1}={}){if(Bm!==e)if(Bm=e,Vm=t,Hm=!1,Q.dataset.paused=String(Bm),yp&&(yp.classList.toggle(`is-visible`,Bm),Bm&&yp.removeAttribute(`hidden`)),bp&&(bp.textContent=Qm(`pauseTitle`)),xp&&(xp.textContent=Qm(`pauseSubtitle`)),Bm){if(pm.getDelta(),document.pointerLockElement===Q&&document.exitPointerLock)try{document.exitPointerLock()}catch{}fm.suspend()}else pm.getDelta(),fm.resume()}function kh(){if(document.pointerLockElement!==Q&&(Hm=!1,!(Bm||ym||bm||xm))){if(Vm){Vm=!1,Oh(!0,{fromUnlock:!0});return}Oh(!0,{fromUnlock:!0})}}function Ah(){if(Ap&&(Ap.style.transform=`translateX(-${Pp*100}%)`,jp.forEach((e,t)=>{e.classList.toggle(`is-active`,t===Pp)}),Op&&(Op.disabled=Pp===0),kp)){let e=Pp===Np-1;kp.textContent=e?`开始游戏`:`下一步 →`,kp.classList.toggle(`tutorial-nav__btn--primary`,e)}}function jh(){Ep&&(Pp=0,Ah(),Ep.removeAttribute(`hidden`),Ep.classList.add(`is-visible`),Q.dataset.tutorial=`true`)}function Mh({markSeen:e=!0}={}){if(Ep&&(Ep.classList.remove(`is-visible`),Ep.setAttribute(`hidden`,``),delete Q.dataset.tutorial,e))try{window.localStorage?.setItem(Mp,`true`)}catch{}}function Nh(e){let t=wm;Jm(`flashlight`),wm=!0,Tm=!1,Em=Hp,Cm=Qm(t?`flashlightRefilled`:`flashlightAcquired`),Sm=pm.elapsedTime+1.7,Q.dataset.flashlightPickups=String(e??1),hh(),Ch()}function Ph(e){let t=!Dm;Jm(`detector`),Dm=!0,Cm=Qm(t?`detectorAcquired`:`detectorReadyHint`),Sm=pm.elapsedTime+1.7,Q.dataset.detectorPickups=String(e??1),vh(),Ch()}function Fh(e){let t=e.almondWater,n=e.superAlmondWater,r=e.flashlight,i=e.detector,a=!!t?.available,o=!!n?.available,s=!!r?.available,c=!!i?.available,l=!!e.focusInteraction?.available,u=a||o||s||c||l;Lf?.classList.toggle(`is-visible`,u),Lf&&(Lf.disabled=!u),Q.dataset.almondWaterVisible=String(!!t?.visible),Q.dataset.almondWaterAvailable=String(a),Q.dataset.almondWaterDistance=Number.isFinite(t?.distance)?String(Math.round(t.distance)):``,Q.dataset.superAlmondWaterVisible=String(!!n?.visible),Q.dataset.superAlmondWaterAvailable=String(o),Q.dataset.superAlmondWaterDistance=Number.isFinite(n?.distance)?String(Math.round(n.distance)):``,Q.dataset.flashlightVisible=String(!!r?.visible),Q.dataset.flashlightAvailable=String(s),Q.dataset.flashlightDistance=Number.isFinite(r?.distance)?String(Math.round(r.distance)):``,Q.dataset.detectorVisible=String(!!i?.visible),Q.dataset.detectorAvailable=String(c),Q.dataset.detectorDistance=Number.isFinite(i?.distance)?String(Math.round(i.distance)):``,Q.dataset.focusInteraction=e.focusInteraction?.id??``,Q.dataset.focusInteractionAvailable=String(l)}function Ih(e){let t=[e.almondWater,e.superAlmondWater,e.flashlight,e.detector].filter(e=>e&&Number.isFinite(e.distance)&&e.available);return t.length===0?null:(t.sort((e,t)=>e.distance-t.distance),t[0])}function Lh(e){let t=e.focusItem??e.focusInteraction??e.focusEntity,n=Ih(e),r=!!e.focusInteraction?.available,i=!!t,a=!!n;if(pp&&(i&&(pp.hidden=!1),pp.classList.toggle(`is-visible`,i),pp.classList.toggle(`is-pickup-ready`,a||r),pp.dataset.infoType=t?.type??`item`,i||(pp.hidden=!0)),i){let e=Km(t.type===`entity`?em:t.type===`interaction`?tm:$p,t.id)??t;mp&&(mp.textContent=e.name??t.name),hp&&(hp.textContent=e.effect??t.effect),gp&&(gp.textContent=e.action??t.action)}Q.dataset.focusItem=e.focusItem?.id??``,Q.dataset.focusEntity=e.focusEntity?.id??``,Q.dataset.focusInfoType=t?.type??``,Q.dataset.focusItemDistance=Number.isFinite(t?.distance)?String(Math.round(t.distance*10)/10):``,Q.dataset.pickupAvailable=String(a)}function Rh(e){if(!pp)return;let t=pp.querySelector(`.item-info__pickup-key`);if(!e){t?.remove();return}if(t)return;let n=document.createElement(`span`);n.className=`item-info__pickup-key`,n.textContent=`F`,pp.prepend(n)}function zh(e,t=1100){Cm=Qm(e),Sm=pm.elapsedTime+t/1e3}function Bh(){if(ym||xm||Bm)return;let e=lm.tryPickup?.(lm.camera.position);if(!e?.pickedUp){if(Mm?.focusInteraction?.available){let e=lm.interact?.(lm.camera.position);if(e?.interacted){let t=Km(tm,e.id);Cm=t.response??t.name??`INTERACTION`,Sm=pm.elapsedTime+1.9,Lf?.classList.add(`is-active`),window.setTimeout(()=>Lf?.classList.remove(`is-active`),140),Q.dataset.lastInteraction=e.id,Q.dataset.lastInteractionCount=String(e.count??1);return}}zh(`pickupEmpty`,900);return}e.itemId===`flashlight`?Nh(e.count):e.itemId===`detector`?Ph(e.count):e.itemId===`super-almond-water`?(Jm(`super-almond-water`),Cm=Qm(`superAlmondWaterUsed`,{seconds:Yp}),Sm=pm.elapsedTime+1.9,Q.dataset.superAlmondWaterDrinks=String(e.count)):e.itemId===`almond-water`&&(Jm(`almond-water`),Cm=Qm(`almondWaterUsed`,{seconds:Jp}),Sm=pm.elapsedTime+1.7,Q.dataset.almondWaterDrinks=String(e.count)),Lf?.classList.add(`is-active`),window.setTimeout(()=>Lf?.classList.remove(`is-active`),140),Ch()}function Vh(){if(ym||xm||Bm)return;let e=Zm();e&&(e.id===`flashlight`?(_h(),$?.classList.add(`is-active`),window.setTimeout(()=>$?.classList.remove(`is-active`),140)):e.id===`detector`&&(xh(),$?.classList.add(`is-active`),window.setTimeout(()=>$?.classList.remove(`is-active`),140)))}function Hh(){if(ym||xm||Bm)return;let e=Zm();e&&(e.id===`almond-water`?dm.startDrink(`almond-water`,{staminaBonus:Xp})&&($?.classList.add(`is-active`),window.setTimeout(()=>$?.classList.remove(`is-active`),140)):e.id===`super-almond-water`&&dm.startDrink(`super-almond-water`)&&($?.classList.add(`is-active`),window.setTimeout(()=>$?.classList.remove(`is-active`),140)))}function Uh(e){return e===`almond-water`||e===`super-almond-water`}function Wh(){ym||xm||Bm||Wm||(Wm=!0,Um=performance.now(),Gm=!1,$&&($.classList.add(`is-pressing`),$.dataset.longPress=`true`,$.style.setProperty(`--long-press-progress`,`0`)))}function Gh(e){if(!Wm)return;let t=performance.now()-Um;if(Wm=!1,$&&($.classList.remove(`is-pressing`),delete $.dataset.longPress,$.style.removeProperty(`--long-press-progress`)),ym||xm||Bm)return;let n=Zm();if(n){if(Uh(n.id)){t>=Qp&&!Gm&&(Gm=!0,Hh());return}t<Qp&&Vh()}}function Kh(){if(!Wm||!$)return;let e=Zm(),t=performance.now()-Um,n=Math.max(0,Math.min(1,t/Qp));$.style.setProperty(`--long-press-progress`,n.toFixed(3)),n>=1&&Uh(e?.id)&&!Gm&&(Gm=!0,Hh())}function qh(e,t,n){Wf.textContent=`${e.exitDistance}m`,Gf.textContent=e.lightState??(e.flicker<.62?`DIM`:`HUM`),Vf.textContent=n<Sm?Cm:e.superAlmondWater?.available?Qm(`super-almond-water`):e.detector?.available?Qm(`detector`):e.flashlight?.available?Qm(`flashlight`):e.almondWater?.available?Qm(`almond-water`):e.statusText??(e.exitReached?`EXIT STABILIZED`:e.exitDistance<7?`SIGNAL FOUND`:`NO SIGNAL`),Fh(e),Lh(e),Rh(!!e.focusItem&&!!Ih(e)||!!e.focusInteraction?.available),ph(t),mh(t)}function Jh(){let e=pm.getDelta();if(Bm){Kh(),requestAnimationFrame(Jh);return}let t=Math.min(e,.05),n=pm.elapsedTime;Kh(),ch(t),!ym&&!bm&&!xm&&dm.update(t);let r=dm.getState();r.drinkCancelled&&!r.isDrinking?(zm=!0,Dh=pm.elapsedTime+1.4,Cm=Qm(`almondWaterCancelled`),Sm=pm.elapsedTime+1.2,dm.clearDrinkCancelled()):zm&&!r.isDrinking&&(Cm=Qm(`almondWaterCancelled`),Sm=pm.elapsedTime+1.2,Dh=pm.elapsedTime+1.4);let i=lm.update(t,n,lm.camera.position);if(Mm=i,gh(t),Sh(t,i),i.entityContact&&!bm&&!ym&&!xm){let e=Km(em,(i.entities??[]).find(e=>e?.contact)?.id);bm=!0,Q.dataset.gameFailed=`true`,ah(Qm(`bacteriaFailTitle`),e.failSubtitle??Qm(`bacteriaFailSubtitle`))}i.exitReached&&!bm&&!ym&&!xm&&(lm.nextLevel!==null&&lm.nextLevel!==void 0?sh(lm.nextLevel):(ym=!0,ah(`EXIT STABILIZED`,`${lm.levelLabel} SIGNAL LOST`),Q.dataset.exitReached=`true`)),fm.update(i.flicker,r),qh(i,r,n),dh(t),fh(),Eh(r),im.render(lm.scene,lm.camera),mm+=1,Q.dataset.sceneReady=`true`,Q.dataset.frameCount=String(mm),requestAnimationFrame(Jh)}function Yh(){fm.start(),window.removeEventListener(`pointerdown`,Yh),window.removeEventListener(`keydown`,Yh)}function Xh(e){if(Bm){e.code===`Escape`&&(e.preventDefault(),Oh(!1));return}let t=e.target?.tagName;if(!(t===`INPUT`||t===`SELECT`||t===`TEXTAREA`)){if(e.code===`KeyF`){e.preventDefault(),Bh();return}if(e.code===`KeyE`){e.preventDefault(),e.repeat||Wh();return}if(e.code===`ArrowLeft`){e.preventDefault(),Xm(-1),Ch();return}if(e.code===`ArrowRight`){e.preventDefault(),Xm(1),Ch();return}if(e.code===`Escape`)if(e.preventDefault(),document.pointerLockElement===Q){Vm=!0,Hm=!0;try{document.exitPointerLock()}catch{Hm=!1,Vm=!1,Oh(!0)}}else Oh(!0)}}function Zh(e){e.code===`KeyE`&&(e.preventDefault(),Gh())}Lf?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Bh()}),$?.addEventListener(`pointerdown`,e=>{if(e.preventDefault(),e.stopPropagation(),Wh(),$&&e.pointerId!==void 0)try{$.setPointerCapture(e.pointerId)}catch{}}),$?.addEventListener(`pointerup`,e=>{e.preventDefault(),e.stopPropagation(),$&&$.hasPointerCapture?.(e.pointerId)&&$.releasePointerCapture(e.pointerId),Gh()}),$?.addEventListener(`pointercancel`,e=>{e.preventDefault(),e.stopPropagation(),$&&$.hasPointerCapture?.(e.pointerId)&&$.releasePointerCapture(e.pointerId),Wm=!1,Gm=!1,$&&($.classList.remove(`is-pressing`),delete $.dataset.longPress,$.style.removeProperty(`--long-press-progress`))}),$?.addEventListener(`pointerleave`,e=>{Wm&&Gh()}),wp?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Xm(-1),wp.classList.add(`is-active`),window.setTimeout(()=>wp?.classList.remove(`is-active`),140),Ch()}),Tp?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Xm(1),Tp.classList.add(`is-active`),window.setTimeout(()=>Tp?.classList.remove(`is-active`),140),Ch()}),Bf?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Oh(!Bm)}),yp?.addEventListener(`pointerdown`,e=>{e.preventDefault(),Oh(!1)}),Rf?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),_h()}),zf?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),xh()}),window.addEventListener(`resize`,lh),window.addEventListener(`pointerdown`,Yh,{passive:!0}),window.addEventListener(`keydown`,Yh),window.addEventListener(`keydown`,Xh),window.addEventListener(`keyup`,Zh),window.addEventListener(`blur`,()=>{Wm&&Gh(),!Hm&&Oh(!0)}),document.addEventListener(`pointerlockchange`,kh),Dp?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Mh()}),Ep?.addEventListener(`pointerdown`,e=>{e.target===Ep&&Mh()}),Op?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Pp>0&&(--Pp,Ah())}),kp?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),Pp<Np-1?(Pp+=1,Ah()):Mh()}),jp.forEach(e=>{e.addEventListener(`pointerdown`,t=>{t.preventDefault(),t.stopPropagation();let n=Number(e.dataset.dot);Number.isFinite(n)&&(Pp=n,Ah())})}),$m(),lh(),Ch(),Jh(),window.setTimeout(()=>{if(Bm||ym)return;let e=!1;try{e=window.localStorage?.getItem(Mp)===`true`}catch{e=!1}e||jh()},600);