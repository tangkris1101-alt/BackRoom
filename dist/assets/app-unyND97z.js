...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(e,t,n){let r=new Float32Array(Ba),i=new U(0,1,0);return new bi({name:`SphericalGaussianBlur`,defines:{n:Ba,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ro(),fragmentShader:`
	...
	`}var io=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $r(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,Pc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ri(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new bi({vertexShader:Mc,fragmentShader:Nc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new q(new ci(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Fc=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Pc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new H,O=null,k=new ea;k.viewport=new Dt;let te=new ea;te.viewport=new Dt;let A=[k,te],j=new da,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new ln,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new ln,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new ln,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new kt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new ti(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new kt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new U,se=new U;function N(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;ce(j,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?N(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),le(e,j,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=it*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let ue=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new ea,o.layers.enable(n),o.viewport=new Dt,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ri,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ue&&ue(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new Da;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){ue=e},this.dispose=function(){}}},Ic=new Mt,Lc=new W;Lc.set(-1,0,0,0,1,0,0,0,1);function Rc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,gi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Ic.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Lc),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function zc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return B(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?z(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):z(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Bc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Vc=null;function Hc(){return Vc===null&&(Vc=new Fr(Bc,16,16,O,g),Vc.name=`DFG_LUT`,Vc.minFilter=o,Vc.magFilter=o,Vc.wrapS=t,Vc.wrapT=t,Vc.generateMipmaps=!1,Vc.needsUpdate=!0),Vc}var Uc=class{constructor(e={}){let{canvas:t=qe(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new U,O=null,A=null,j=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null;this._outputColorSpace=Le;let oe=0,se=0,N=null,ce=-1,le=null,ue=new Dt,de=new Dt,fe=null,pe=new K(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new Dt(0,0,he,ge),xe=new Dt(0,0,he,ge),Se=!1,Ce=new Qr,we=!1,Te=!1,Ee=new Mt,De=new U,Oe=new Dt,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return N===null?_e:1}let P=n;function Me(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,at,!1),t.addEventListener(`webglcontextrestored`,V,!1),t.addEventListener(`webglcontextcreationerror`,ot,!1),P===null){let t=`webgl2`;if(P=Me(t,e),P===null)throw Me(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw B(`WebGLRenderer: `+e.message),e}let F,Ne,I,Pe,L,R,Fe,Ie,Re,ze,Be,Ve,He,We,Ge,Ke,Je,Ye,Ze,Qe,et,tt,nt;function rt(){F=new oo(P),F.init(),et=new jc(P,F),Ne=new Ia(P,F,e,et),I=new kc(P,F),Ne.reversedDepthBuffer&&h&&I.buffers.depth.setReversed(!0),Pe=new lo(P),L=new lc,R=new Ac(P,F,I,L,Ne,et,Pe),Fe=new ao(M),Ie=new Oa(P),tt=new Pa(P,Ie),Re=new so(P,Ie,Pe,tt),ze=new fo(P,Re,Ie,tt,Pe),Ye=new uo(P,Ne,R),Ge=new La(L),Be=new cc(M,Fe,F,Ne,tt,Ge),Ve=new Rc(M,L),He=new pc,We=new bc(F),Je=new Na(M,Fe,I,ze,x,s),Ke=new Oc(M,ze,Ne),nt=new zc(P,Pe,Ne,I),Ze=new Fa(P,F,Pe),Qe=new co(P,F,Pe),Pe.programs=Be.programs,M.capabilities=Ne,M.extensions=F,M.properties=L,M.renderLists=He,M.shadowMap=Ke,M.state=I,M.info=Pe}rt(),S!==1009&&(re=new mo(S,t.width,t.height,r,i));let it=new Fc(M,P);this.xr=it,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=F.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=F.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(it.isPresenting){z(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){B(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){z(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),I.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),I.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){I.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Je.getClearColor())},this.setClearColor=function(){Je.setClearColor(...arguments)},this.getClearAlpha=function(){return Je.getClearAlpha()},this.setClearAlpha=function(){Je.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=Je.getClearColor(),r=Je.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,at,!1),t.removeEventListener(`webglcontextrestored`,V,!1),t.removeEventListener(`webglcontextcreationerror`,ot,!1),Je.dispose(),He.dispose(),We.dispose(),L.dispose(),Fe.dispose(),ze.dispose(),tt.dispose(),nt.dispose(),Be.dispose(),it.dispose(),it.removeEventListener(`sessionstart`,ft),it.removeEventListener(`sessionend`,W),pt.stop()};function at(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),ie=!0}function V(){Xe(`WebGLRenderer: Context Restored.`),ie=!1;let e=Pe.autoReset,t=Ke.enabled,n=Ke.autoUpdate,r=Ke.needsUpdate,i=Ke.type;rt(),Pe.autoReset=e,Ke.enabled=t,Ke.autoUpdate=n,Ke.needsUpdate=r,Ke.type=i}function ot(e){B(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function st(e){let t=e.target;t.removeEventListener(`dispose`,st),ct(t)}function ct(e){lt(e),L.remove(e)}function lt(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){Be.releaseProgram(e)}),e.isShaderMaterial&&Be.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=Ct(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Re.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;tt.setup(i,r,s,n,c);let h,g=Ze;if(c!==null&&(h=Ie.get(c),g=Qe,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*je()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*je()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(F.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ie.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function H(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,yt(e,t,n),e.side=0,e.needsUpdate=!0,yt(e,t,n),e.side=2):yt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=We.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];H(a,n,e),r.add(a)}else H(t,n,e),r.add(t)}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){L.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}F.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ut=null;function dt(e){ut&&ut(e)}function ft(){pt.stop()}function W(){pt.start()}let pt=new Da;pt.setAnimationLoop(dt),typeof self<`u`&&pt.setContext(self),this.setAnimationLoop=function(e){ut=e,it.setAnimationLoop(e),e===null?pt.stop():pt.start()},it.addEventListener(`sessionstart`,ft),it.addEventListener(`sessionend`,W),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){B(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=it.enabled===!0&&it.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),it.enabled===!0&&it.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(it.cameraAutoUpdate===!0&&it.updateCamera(t),t=it.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),A=We.get(e,ne.length),A.init(t),A.state.textureUnits=R.getTextureUnits(),ne.push(A),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,Ue,t.reversedDepth),Te=this.localClippingEnabled,we=Ge.init(this.clippingPlanes,Te),O=He.get(e,j.length),O.init(),j.push(O),it.enabled===!0&&it.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&mt(e,t,-1/0,M.sortObjects)}mt(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(ve,ye),Ae=it.enabled===!1||it.isPresenting===!1||it.hasDepthSensing()===!1,Ae&&Je.addToRenderList(O,e),this.info.render.frame++,we===!0&&Ge.beginShadows();let i=A.state.shadowsArray;if(Ke.render(i,e,t),we===!0&&Ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];gt(n,r,e,a)}Ae&&Je.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];ht(O,e,n,n.viewport)}}else r.length>0&&gt(n,r,e,t),Ae&&Je.render(e),ht(O,e,t)}N!==null&&se===0&&(R.updateMultisampleRenderTarget(N),R.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),tt.resetDefaultState(),ce=-1,le=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],R.setTextureUnits(A.state.textureUnits),we===!0&&Ge.setGlobalState(M.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ae!==null&&ae.renderEnd()};function mt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ce.intersectsSprite(e)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let t=ze.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Oe.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ce.intersectsObject(e))){let t=ze.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Oe.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Oe.z,o)}}else i.visible&&O.push(e,t,i,n,Oe.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)mt(i[e],t,n,r)}function ht(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),we===!0&&Ge.setGlobalState(M.clippingPlanes,n),r&&I.viewport(ue.copy(r)),i.length>0&&_t(i,t,n),a.length>0&&_t(a,t,n),o.length>0&&_t(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function gt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=F.has(`EXT_color_buffer_half_float`)||F.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new kt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ne.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:G.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(pe),me=M.getClearAlpha(),me<1&&M.setClearColor(16777215,.5),M.clear(),Ae&&Je.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),we===!0&&Ge.setGlobalState(M.clippingPlanes,r),_t(e,n,r),R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a),F.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,vt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(pe,me),p!==void 0&&(r.viewport=p),M.toneMapping=f}function _t(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&vt(o,t,n,s,l,c)}}function vt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function yt(e,t,n){t.isScene!==!0&&(t=ke);let r=L.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Be.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Be.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Fe.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,st),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return xt(e,s),d}else s.uniforms=Be.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Be.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ge.uniform),xt(e,s),r.needsLights=Tt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function bt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=xs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function xt(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function St(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ct(e,t,n,r,i){t.isScene!==!0&&(t=ke),R.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:G.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Fe.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=A.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;Ge.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ge.numPlanes||v.numIntersection!==Ge.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=yt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=St(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,De.setFromMatrixPosition(e.matrixWorld)),Ne.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,R),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,R),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,R)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,R))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,R),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,R),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,R));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ye.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Hc()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&wt(E,w),a&&r.fog===!0&&Ve.refreshFogUniforms(E,a),Ve.refreshMaterialUniforms(E,r,_e,ge,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}xs.upload(P,bt(v),E,R)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(xs.upload(P,bt(v),E,R),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];nt.update(n,x),nt.bind(n,x)}}return x}function wt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Tt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Et=P.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){N=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,I.viewport(ue),I.scissor(de),I.setScissorTest(fe),ce=-1;return}else if(o.__webglFramebuffer===void 0)R.setupRenderTarget(e);else if(o.__hasExternalTextures)R.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);R.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&R.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=Et),I.bindFramebuffer(P.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(ue),I.scissor(de),I.setScissorTest(fe),i){let r=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}ce=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(c)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ne.textureTypeReadable(l)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,et.convert(c),et.convert(l),a)}finally{let e=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ne.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,et.convert(l),et.convert(u),0);let f=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await $e(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;R.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()};let Ot=P.createFramebuffer(),At=P.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=et.convert(t.format),_=et.convert(t.type),v;t.isData3DTexture?(R.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(R.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(R.setTexture2D(t,0),v=P.TEXTURE_2D),I.activeTexture(P.TEXTURE0),I.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),I.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),I.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=I.getParameter(P.UNPACK_ROW_LENGTH),b=I.getParameter(P.UNPACK_IMAGE_HEIGHT),x=I.getParameter(P.UNPACK_SKIP_PIXELS),S=I.getParameter(P.UNPACK_SKIP_ROWS),C=I.getParameter(P.UNPACK_SKIP_IMAGES);I.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),I.pixelStorei(P.UNPACK_SKIP_PIXELS,l),I.pixelStorei(P.UNPACK_SKIP_ROWS,u),I.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(P.READ_FRAMEBUFFER,Ot),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,At);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);I.pixelStorei(P.UNPACK_ROW_LENGTH,y),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),I.pixelStorei(P.UNPACK_SKIP_PIXELS,x),I.pixelStorei(P.UNPACK_SKIP_ROWS,S),I.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&R.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?R.setTextureCube(e,0):e.isData3DTexture?R.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?R.setTexture2DArray(e,0):R.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){oe=0,se=0,N=null,I.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ue}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=G._getDrawingBufferColorSpace(e),t.unpackColorSpace=G._getUnpackColorSpace()}};function Wc(){let e=null,t=null,n=null,r=!1,i=null,a=0,o=null;function s(){if(r)return;r=!0;let a=window.AudioContext||window.webkitAudioContext;if(!a)return;e=new a,t=e.createGain(),t.gain.value=.022,t.connect(e.destination);let s=e.createOscillator();s.type=`sine`,s.frequency.value=58;let c=e.createOscillator();c.type=`triangle`,c.frequency.value=118;let l=e.createGain();l.gain.value=.55,s.connect(l),c.connect(l),l.connect(t);let u=e.sampleRate*2,d=e.createBuffer(1,u,e.sampleRate),f=d.getChannelData(0);for(let e=0;e<u;e+=1)f[e]=Math.random()*2-1;let p=e.createBufferSource();p.buffer=d,p.loop=!0;let m=e.createBiquadFilter();m.type=`bandpass`,m.frequency.value=840,m.Q.value=.8,n=e.createGain(),n.gain.value=.09,p.connect(m),m.connect(n),n.connect(t),s.start(),c.start(),p.start();let h=Math.floor(e.sampleRate*.08);o=e.createBuffer(1,h,e.sampleRate);let g=o.getChannelData(0);for(let e=0;e<h;e+=1)g[e]=(Math.random()*2-1)*(1-e/h);i=e.createBiquadFilter(),i.type=`lowpass`,i.frequency.value=620,i.Q.value=.58,i.connect(t)}function c({sprinting:n}){if(!e||!i||!o)return;let r=e.currentTime,a=e.createBufferSource();a.buffer=o;let s=e.createGain();s.gain.setValueAtTime(0,r),s.gain.linearRampToValueAtTime(n?.42:.28,r+.012),s.gain.exponentialRampToValueAtTime(.001,r+(n?.12:.105)),a.connect(s),s.connect(i),a.start(r),a.stop(r+.14);let c=e.createOscillator();c.type=`sine`,c.frequency.setValueAtTime(n?76:62,r),c.frequency.exponentialRampToValueAtTime(n?46:38,r+.09);let l=e.createGain();l.gain.setValueAtTime(0,r),l.gain.linearRampToValueAtTime(n?.16:.1,r+.008),l.gain.exponentialRampToValueAtTime(.001,r+.1),c.connect(l),l.connect(t),c.start(r),c.stop(r+.11)}function l(t,r={}){if(!e||!n)return;e.state===`suspended`&&e.resume?.();let i=e.currentTime,o=.055+(1-t)*.08;if(n.gain.setTargetAtTime(o,i,.035),!(r.moving&&r.grounded)){a=Math.min(a,i);return}let s=Math.max(0,r.movementSpeed??0),l=!!r.sprinting,u=l?Math.max(.24,.34-s*.018):Math.max(.38,.54-s*.026);i-a>=u&&(c({sprinting:l}),a=i)}return{start:s,update:l}}var Z=4,Gc=3.72,Kc=.22,qc=3.66,Jc=12,Yc=Z*4.25,Xc=2.05,Zc=50,Qc=24,$c=18,el=6.4,tl=.72,nl=1.85,rl=6.2,il=36,al=24,ol=31,sl=27,cl=new Map([[0,{level:0,levelLabel:`LEVEL 0`,levelName:`NOCLIP ZONE`}],[1,{level:1,levelLabel:`LEVEL 1`,levelName:`HABITABLE ZONE`}],[2,{level:2,levelLabel:`LEVEL 2`,levelName:`PIPE DREAMS`}]]);function ll(e=0){return cl.get(Number(e))??cl.get(0)}var ul=[{col:19,row:1,width:10,height:7},{col:11,row:3,width:7,height:5},{col:10,row:10,width:9,height:6}],dl=[{col:1,row:20,width:6,height:5},{col:22,row:12,width:6,height:4},{col:3,row:8,width:5,height:5},{col:13,row:18,width:12,height:5}];function fl(){let e=Array.from({length:sl},()=>Array.from({length:ol},()=>`#`)),t=(t,n)=>{n>0&&n<sl-1&&t>0&&t<ol-1&&(e[n][t]=`.`)},n=(e,n,r,i)=>{for(let a=n;a<n+i;a+=1)for(let n=e;n<e+r;n+=1)t(n,a)},r=(e,n,r,i=1)=>{let a=Math.min(e,n),o=Math.max(e,n);for(let e=a;e<=o;e+=1)for(let n=0;n<i;n+=1)t(e,r+n)},i=(e,n,r,i=1)=>{let a=Math.min(n,r),o=Math.max(n,r);for(let n=a;n<=o;n+=1)for(let r=0;r<i;r+=1)t(e+r,n)};return[{col:1,row:20,width:6,height:5},{col:2,row:13,width:4,height:3},{col:3,row:8,width:5,height:5},{col:1,row:1,width:8,height:6},{col:11,row:3,width:7,height:5},{col:10,row:10,width:9,height:6},{col:13,row:18,width:12,height:5},{col:22,row:12,width:6,height:4},{col:19,row:1,width:10,height:7},{col:24,row:20,width:5,height:4}].forEach(e=>n(e.col,e.row,e.width,e.height)),i(3,15,22,1),r(3,14,15,1),i(14,7,15,1),r(14,23,7,2),i(23,5,8,1),r(23,28,5,1),r(5,13,21,2),i(13,15,21,2),r(18,24,14,1),i(24,14,22,1),r(5,11,10,1),i(11,5,10,1),r(8,12,4,1),r(17,22,4,1),[[13,12],[15,12],[17,12],[14,14],[20,4],[23,3],[26,5],[16,20],[20,20],[5,10]].forEach(([t,n])=>{e[n][t]=`#`}),e.map(e=>e.join(``))}var pl=fl(),ml=pl.length,hl=pl[0].length,gl=-(hl*Z)/2,_l=-(ml*Z)/2,vl={col:3,row:23,yaw:-Math.PI*.48},yl={col:27,row:3},bl=Z*.8,xl=new Mt,Sl=new ut,Cl=new U(1,1,1),wl=new U,Tl=new U;function El(e,t){return t>=0&&t<ml&&e>=0&&e<hl&&pl[t][e]===`.`}function Dl(e,t,n){return e>=n.col&&e<n.col+n.width&&t>=n.row&&t<n.row+n.height}function Ol(e,t,n){return n.some(n=>Dl(e,t,n))}function kl(e,t){return[[0,-1],[0,1],[-1,0],[1,0]].filter(([n,r])=>El(e+n,t+r)).length}function Al(e,t){return{x:gl+e*Z+Z/2,z:_l+t*Z+Z/2}}function jl(e,t){return{col:Math.floor((e-gl)/Z),row:Math.floor((t-_l)/Z)}}function Ml(t,n,r,i){let a=document.createElement(`canvas`);a.width=t,a.height=t,n(a.getContext(`2d`),t);let o=new ei(a);return o.wrapS=e,o.wrapT=e,o.repeat.set(r,i),o.colorSpace=Le,o.anisotropy=6,o}function Nl(e){let t=e>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function Pl(e){return Math.max(0,Math.min(255,e))}function Fl(e){return e*e*(3-2*e)}function Il(e,t,n){let r=Math.sin((e*127.1+t*311.7+n*74.7)*43758.5453);return r-Math.floor(r)}function Ll(e,t,n,r,i){let a=e/n*r,o=t/n*r,s=Math.floor(a),c=Math.floor(o),l=(s+1)%r,u=(c+1)%r,d=Fl(a-s),f=Fl(o-c),p=Il(s%r,c%r,i),m=Il(l,c%r,i),h=Il(s%r,u,i),g=Il(l,u,i),_=p+(m-p)*d;return _+(h+(g-h)*d-_)*f}function Rl(e,t,n,r,i=`0,0,0`,a=Math.random){for(let o=0;o<n;o+=1){let n=a()*t,o=a()*t,s=a()*2.4+.35;e.fillStyle=`rgba(${i},${a()*r})`,e.beginPath(),e.arc(n,o,s,0,Math.PI*2),e.fill()}}function zl(){let e=Nl(12241920),n=Ml(512,(t,n)=>{let r=t.createImageData(n,n),i=r.data;for(let t=0;t<n;t+=1)for(let r=0;r<n;r+=1){let a=(t*n+r)*4,o=Math.sin(r*.045)*2.2,s=(Ll(r,t,n,18,2.7)-.5)*6+(e()-.5)*4,c=Math.max(0,Math.abs(t/n-.5)-.36)*5;i[a]=Pl(222+o+s-c),i[a+1]=Pl(214+o*.8+s-c),i[a+2]=Pl(153+o*.45+s*.55),i[a+3]=255}t.putImageData(r,0,0);for(let e=0;e<=n;e+=74)t.fillStyle=`rgba(112,100,55,0.08)`,t.fillRect(e-1,0,2,n),t.fillStyle=`rgba(245,235,174,0.08)`,t.fillRect(e+2,0,1,n);t.strokeStyle=`rgba(66,78,58,0.2)`,t.lineWidth=.9;for(let r=-38;r<n+38;r+=38)for(let i=-34;i<n+34;i+=34){let n=(e()-.5)*1.2;t.beginPath(),t.moveTo(i+10+n,r+4),t.lineTo(i+18+n,r+17),t.lineTo(i+10+n,r+31),t.moveTo(i+24-n,r+4),t.lineTo(i+16-n,r+17),t.lineTo(i+24-n,r+31),t.stroke(),t.fillStyle=`rgba(65,74,55,0.14)`,t.fillRect(i+16,r+18,1.2,1.2)}for(let r=0;r<12;r+=1){let r=e()*n,i=e()*n,a=18+e()*48,o=t.createRadialGradient(r,i,0,r,i,a);o.addColorStop(0,`rgba(96,82,44,0.035)`),o.addColorStop(1,`rgba(96,82,44,0)`),t.fillStyle=o,t.beginPath(),t.arc(r,i,a,0,Math.PI*2),t.fill()}Rl(t,n,300,.07,`76,68,38`,e),Rl(t,n,110,.06,`238,226,169`,e)},1.85,1.05);return n.wrapT=t,n.needsUpdate=!0,n}function Bl(){let e=Nl(13278980);return Ml(512,(t,n)=>{let r=t.createImageData(n,n),i=r.data;for(let t=0;t<n;t+=1)for(let r=0;r<n;r+=1){let a=(t*n+r)*4,o=r/n,s=t/n,c=(Ll(r,t,n,4,4.1)-.5)*12,l=(Ll(r,t,n,11,8.7)-.5)*7,u=(e()-.5)*4,d=Math.sin(Math.PI*2*(o*18+s*2))*.55+Math.sin(Math.PI*2*(o*7-s*3))*.45,f=c+l+u+d;i[a]=Pl(185+f),i[a+1]=Pl(165+f*.78),i[a+2]=Pl(120+f*.5),i[a+3]=255}t.putImageData(r,0,0),t.globalAlpha=.028;for(let e=0;e<n;e+=5){let r=Math.sin(e/n*Math.PI*2*4)*.8;t.strokeStyle=e%10==0?`#8b774e`:`#ddc48c`,t.lineWidth=.55,t.beginPath(),t.moveTo(0,e+r),t.lineTo(n,e+r),t.stroke()}t.globalAlpha=1,Rl(t,n,1500,.055,`72,58,32`,e)},7.5,7.5)}function Vl(){let e=Nl(13504793);return Ml(512,(t,n)=>{t.fillStyle=`#d6cfaa`,t.fillRect(0,0,n,n);let r=t.createLinearGradient(0,0,n,n);r.addColorStop(0,`rgba(255,250,224,0.12)`),r.addColorStop(1,`rgba(105,99,68,0.1)`),t.fillStyle=r,t.fillRect(0,0,n,n),t.strokeStyle=`rgba(85,82,58,0.24)`,t.lineWidth=5,t.strokeRect(0,0,n,n),t.strokeStyle=`rgba(245,239,200,0.12)`,t.lineWidth=1.5,t.strokeRect(9,9,n-18,n-18);for(let r=0;r<7;r+=1){let r=e()*n,i=e()*n,a=26+e()*58,o=t.createRadialGradient(r,i,0,r,i,a);o.addColorStop(0,`rgba(92,80,43,0.065)`),o.addColorStop(1,`rgba(92,80,43,0)`),t.fillStyle=o,t.beginPath(),t.arc(r,i,a,0,Math.PI*2),t.fill()}Rl(t,n,1500,.08,`91,86,58`,e),Rl(t,n,260,.05,`238,231,190`,e)},20,18)}function Hl(e,t,n){let r=document.createElement(`canvas`);r.width=1024,r.height=410;let i=r.getContext(`2d`);i.fillStyle=t,i.fillRect(0,0,r.width,r.height),i.fillStyle=n;let a=r.width*.82,o=220;do i.font=`bold ${o}px Arial, sans-serif`,o-=8;while(i.measureText(e).width>a&&o>78);i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e,r.width/2,r.height/2+8),i.strokeStyle=`rgba(0,0,0,0.24)`,i.lineWidth=20,i.strokeRect(18,18,r.width-36,r.height-36);let s=new ei(r);return s.colorSpace=Le,s.anisotropy=6,s}function Ul(e){return null}function Wl(e){return e?`YELLOW HAZMAT`:`NONE`}function Gl(e,t,n){if(!e)return;e.userData.previousPlayerPosition||(e.userData.previousPlayerPosition=n.clone());let r=e.userData.previousPlayerPosition,i=Math.hypot(n.x-r.x,n.z-r.z);r.copy(n);let a=Math.min(1,i*18),o=Math.sin(t*1.8)*.006,s=Math.sin(t*9.5)*.012*a,c=Math.sin(t*6.8)*.012*a;e.position.set(c,o+s,0),e.rotation.set(Math.sin(t*5.2)*.012*a,Math.sin(t*4.4)*.012*a,-c*.18)}function Kl(e,t,n,r){let i=new Wr(t,n,r.length);return r.forEach((e,t)=>{xl.compose(e,Sl,Cl),i.setMatrixAt(t,xl)}),i.instanceMatrix.needsUpdate=!0,e.add(i),i}function ql(e,t,{rangeScale:n,intensityScale:r,decay:i=2}){let a=new ia(e.color,e.baseIntensity*r,e.range*n,i);return a.position.set(e.x,t,e.z),a.userData.intensityScale=r,a}function Jl(e,t,n=1){e.light&&(e.light.intensity=t*e.baseIntensity*(e.light.userData.intensityScale??n))}function Yl(e,{dimBelow:t,normalAbove:n,dimDelay:r=.42,normalDelay:i=.62}){let a=e,o=0,s=i;return(c,l)=>(l<t?(o+=c,s=0):l>n?(s+=c,o=0):(o=0,s=0),o>=r&&(a=`DIM`),s>=i&&(a=e),a)}function Xl(){let n=document.createElement(`canvas`);n.width=512,n.height=256;let r=n.getContext(`2d`);r.fillStyle=`#f5f0d4`,r.fillRect(0,0,n.width,n.height),r.fillStyle=`#2f6f94`,r.fillRect(0,0,n.width,42),r.fillRect(0,n.height-44,n.width,44);let i=r.getImageData(0,0,n.width,n.height);for(let e=0;e<i.data.length;e+=4){let t=(Math.random()-.5)*12;i.data[e]=Pl(i.data[e]+t),i.data[e+1]=Pl(i.data[e+1]+t),i.data[e+2]=Pl(i.data[e+2]+t)}r.putImageData(i,0,0),r.fillStyle=`#f9f5df`,r.fillRect(58,54,292,134),r.strokeStyle=`rgba(35, 76, 79, 0.42)`,r.lineWidth=4,r.strokeRect(58,54,292,134),r.fillStyle=`#234c4f`,r.font=`900 34px Arial, sans-serif`,r.fillText(`ALMOND`,82,102),r.font=`900 32px Arial, sans-serif`,r.fillText(`WATER`,102,140),r.font=`700 11px Arial, sans-serif`,r.fillStyle=`#5f6542`,r.fillText(`LEVEL 0 SUPPLY`,106,164),r.fillText(`+50 STAMINA BOOST`,83,181),r.fillStyle=`#dccb83`,r.beginPath(),r.ellipse(304,120,28,45,-.12,0,Math.PI*2),r.fill(),r.strokeStyle=`rgba(96, 82, 38, 0.35)`,r.lineWidth=3,r.stroke(),r.strokeStyle=`rgba(86, 76, 34, 0.42)`,r.lineWidth=2;for(let e=0;e<5;e+=1)r.beginPath(),r.moveTo(286+e*7,84+e*6),r.bezierCurveTo(302,110,302,132,287+e*6,156-e*5),r.stroke();r.fillStyle=`#18303a`;for(let e=384;e<462;e+=4){let t=e%12==0?3:1;r.fillRect(e,78,t,88)}r.font=`700 10px Arial, sans-serif`,r.fillStyle=`#24414a`,r.fillText(`NOT FROM HERE`,374,190);let a=new ei(n);return a.colorSpace=Le,a.wrapS=e,a.wrapT=t,a.anisotropy=2,a.needsUpdate=!0,a}function Zl(){let e=new sn;e.name=`almond-water-model`;let t=new Si({color:14285823,emissive:2846586,emissiveIntensity:.08,roughness:.12,metalness:0,transmission:.18,transparent:!0,opacity:.42,thickness:.22}),n=new J({color:12246992,emissive:9157539,emissiveIntensity:.18,roughness:.38,transparent:!0,opacity:.72}),r=new J({map:Xl(),color:16777215,emissive:14149309,emissiveIntensity:.08,roughness:.62,side:2}),i=new J({color:2313840,emissive:464159,emissiveIntensity:.22,roughness:.46,metalness:.12}),a=new xr({color:1910552,transparent:!0,opacity:.2,depthWrite:!1}),o=new q(new si([new H(.108,.02),new H(.158,.06),new H(.174,.15),new H(.174,.52),new H(.138,.6),new H(.086,.66),new H(.084,.78),new H(.102,.81)],32),t);e.add(o);let s=new q(new si([new H(.098,.06),new H(.145,.09),new H(.151,.16),new H(.151,.48),new H(.116,.53),new H(.078,.58)],28),n);e.add(s);let c=new q(new oi(.181,.181,.255,32,1,!0),r);c.position.y=.35,e.add(c);let l=new q(new oi(.102,.108,.09,24),i);l.position.y=.855,e.add(l);for(let t=0;t<3;t+=1){let n=new q(new di(.106,.0045,6,24),i);n.rotation.x=Math.PI/2,n.position.y=.824+t*.027,e.add(n)}let u=new q(new ai(.33,32),a);return u.rotation.x=-Math.PI/2,u.position.y=.012,e.add(u),e.traverse(e=>{e.isMesh&&(e.userData.itemId=`almond-water`)}),e}function Ql(e,{cols:t,rows:n,isCellOpen:r,getCellCenter:i,avoidPositions:a=[],blockedAabbs:o=[]}){let s=[];for(let e=0;e<n;e+=1)for(let n=0;n<t;n+=1){if(!r(n,e))continue;let t=i(n,e),c=a.every(e=>Math.hypot(t.x-e.x,t.z-e.z)>Z*4),l=o.every(e=>!Iu(t.x,t.z,Xc,e));c&&l&&s.push({col:n,row:e,x:t.x,z:t.z})}let c=new sn;c.name=`almond-water-pickup`;let l=Zl();l.scale.setScalar(tl),c.add(l);let u=new q(new li(.26,.38,32),new xr({color:15662035,transparent:!0,opacity:.13,depthWrite:!1,side:2}));u.rotation.x=-Math.PI/2,u.position.y=.02,c.add(u),e.add(c);let d=!1,f=0,p=0;function m(){return s[Math.floor(Math.random()*s.length)]??s[0]}function h(){let e=m();if(!e){c.visible=!1,d=!1;return}c.position.set(e.x,0,e.z),c.rotation.y=Math.random()*Math.PI*2,c.visible=!0,d=!0}return h(),{inspect(e){if(!d||!e)return null;e.getWorldDirection(wl),Tl.set(c.position.x,c.position.y+.34,c.position.z).sub(e.position);let t=Tl.length();if(t>el)return null;Tl.normalize();let n=Math.min(.13,Math.max(.048,Math.atan2(.42,t)));return wl.dot(Tl)<Math.cos(n)?null:{id:`almond-water`,name:`ALMOND WATER`,effect:`+50 STAMINA CAPACITY / 45s`,action:`F / BUTTON PICK UP`,distance:t}},update(e,t,n){if(!d)return f-=e,f<=0&&h(),{visible:!1,available:!1,distance:1/0,respawn:Math.max(0,f)};c.position.y=Math.sin(t*2.4)*.035,c.rotation.y+=e*.45,u.material.opacity=.1+Math.sin(t*3.2)*.045+.045;let r=Math.hypot(n.x-c.position.x,n.z-c.position.z);return{visible:!0,available:r<=Xc,distance:r,respawn:0}},tryPickup(e){return!d||Math.hypot(e.x-c.position.x,e.z-c.position.z)>Xc?{pickedUp:!1}:(p+=1,d=!1,c.visible=!1,f=Qc+Math.random()*$c,{pickedUp:!0,itemId:`almond-water`,count:p,staminaBonus:Zc})}}}function $l(){let e=new sn;e.name=`flashlight-model`;let t=new J({color:2040867,emissive:395271,emissiveIntensity:.12,roughness:.46,metalness:.42}),n=new J({color:724493,roughness:.78,metalness:.2}),r=new J({color:16318423,emissive:15525798,emissiveIntensity:.34,roughness:.2,metalness:.02}),i=new J({color:2107178,emissive:462870,emissiveIntensity:.08,roughness:.56,metalness:.18}),a=new xr({color:395271,transparent:!0,opacity:.24,depthWrite:!1}),o=new q(new oi(.09,.105,.62,20),t);o.rotation.z=Math.PI/2,o.position.set(0,.13,0),e.add(o);let s=new q(new oi(.15,.112,.18,20),t);s.rotation.z=Math.PI/2,s.position.set(.39,.13,0),e.add(s);let c=new q(new oi(.118,.118,.018,20),r);c.rotation.z=Math.PI/2,c.position.set(.49,.13,0),e.add(c);let l=new q(new oi(.096,.088,.09,18),n);l.rotation.z=Math.PI/2,l.position.set(-.36,.13,0),e.add(l);for(let t=0;t<5;t+=1){let r=new q(new di(.104,.0045,6,20),n);r.rotation.y=Math.PI/2,r.position.set(-.22+t*.074,.13,0),e.add(r)}let u=new q(new ii(.12,.026,.06),i);u.position.set(.07,.235,0),e.add(u);let d=new q(new ai(.54,28),a);return d.rotation.x=-Math.PI/2,d.scale.z=.42,d.position.y=.011,e.add(d),e.traverse(e=>{e.isMesh&&(e.userData.itemId=`flashlight`)}),e}function eu(e,{cols:t,rows:n,isCellOpen:r,getCellCenter:i,avoidPositions:a=[],blockedAabbs:o=[]}){let s=[];for(let e=0;e<n;e+=1)for(let n=0;n<t;n+=1){if(!r(n,e))continue;let t=i(n,e),c=a.every(e=>Math.hypot(t.x-e.x,t.z-e.z)>Z*4.2),l=o.every(e=>!Iu(t.x,t.z,nl,e));c&&l&&s.push({col:n,row:e,x:t.x,z:t.z})}let c=new sn;c.name=`flashlight-pickup`,c.add($l());let l=new q(new li(.42,.58,32),new xr({color:12051711,transparent:!0,opacity:.12,depthWrite:!1,side:2}));l.rotation.x=-Math.PI/2,l.position.y=.018,c.add(l),e.add(c);let u=!1,d=0,f=0;function p(){return s[Math.floor(Math.random()*s.length)]??s[0]}function m(){let e=p();if(!e){c.visible=!1,u=!1;return}c.position.set(e.x,0,e.z),c.rotation.y=Math.random()*Math.PI*2,c.visible=!0,u=!0}return m(),{inspect(e){if(!u||!e)return null;e.getWorldDirection(wl),Tl.set(c.position.x,c.position.y+.2,c.position.z).sub(e.position);let t=Tl.length();if(t>rl)return null;Tl.normalize();let n=Math.min(.15,Math.max(.055,Math.atan2(.5,t)));return wl.dot(Tl)<Math.cos(n)?null:{id:`flashlight`,name:`FLASHLIGHT`,effect:`FORWARD BEAM / LIMITED BATTERY`,action:`F / BUTTON PICK UP`,distance:t}},update(e,t,n){if(!u)return d-=e,d<=0&&m(),{visible:!1,available:!1,distance:1/0,respawn:Math.max(0,d)};c.position.y=Math.sin(t*1.9+1.6)*.018,l.material.opacity=.08+Math.sin(t*2.8)*.034+.034;let r=Math.hypot(n.x-c.position.x,n.z-c.position.z);return{visible:!0,available:r<=nl,distance:r,respawn:0}},tryPickup(e){return!u||Math.hypot(e.x-c.position.x,e.z-c.position.z)>nl?{pickedUp:!1}:(f+=1,u=!1,c.visible=!1,d=il+Math.random()*al,{pickedUp:!0,itemId:`flashlight`,count:f})}}}function tu(...e){return e.filter(Boolean).sort((e,t)=>e.distance-t.distance)[0]??null}function nu(e,...t){for(let n of t){let t=n.tryPickup(e);if(t?.pickedUp)return t}return{pickedUp:!1}}function ru(e,t){let n=[],r=new Set(t.map((e,t)=>({index:t,priority:e.priority})).sort((e,t)=>t.priority-e.priority).slice(0,Jc).map(({index:e})=>e)),i=new ii(1,.035,.36),a=new ii(1,.03,.52),o=new J({color:10326616,emissive:4866080,emissiveIntensity:.12,roughness:.88,metalness:.02});return t.forEach((t,s)=>{let c=new J({color:t.color,emissive:t.color,emissiveIntensity:t.baseIntensity,roughness:.28}),l=new q(a,o);l.position.set(t.x,qc-.055,t.z),l.rotation.y=t.rotation,l.scale.x=t.panelWidth+.24,e.add(l);let u=new q(i,c);u.position.set(t.x,qc-.09,t.z),u.rotation.y=t.rotation,u.scale.x=t.panelWidth,e.add(u);let d=null;t.hasPointLight&&r.has(s)&&(d=ql(t,qc-.25,{rangeScale:1.48,intensityScale:1.22}),e.add(d)),n.push({panel:u,material:c,light:d,phase:t.phase,speed:t.speed,baseIntensity:t.baseIntensity,weak:t.weak})}),n}function iu(e){let t=jl(e.x,e.z),n=[{col:t.col,row:t.row-1,x:e.x,z:e.z-Z/2+Kc*.62,rotation:0},{col:t.col,row:t.row+1,x:e.x,z:e.z+Z/2-Kc*.62,rotation:Math.PI},{col:t.col-1,row:t.row,x:e.x-Z/2+Kc*.62,z:e.z,rotation:Math.PI/2},{col:t.col+1,row:t.row,x:e.x+Z/2-Kc*.62,z:e.z,rotation:-Math.PI/2}];return n.find(e=>!El(e.col,e.row))??n[1]}function au(e,t){let n=new J({map:Hl(`EXIT`,`#172d1d`,`#a5ffba`),color:16777215,emissive:4194162,emissiveIntensity:.55,roughness:.42,side:2}),r=iu(t),i=new q(new ci(2.15,.78),n);i.position.set(r.x,1.72,r.z),i.rotation.y=r.rotation,e.add(i);let a=new xr({color:8257425,transparent:!0,opacity:.18,depthWrite:!1,side:2}),o=new q(new ci(Z*.82,Z*.82),a);o.rotation.x=-Math.PI/2,o.position.set(t.x,.034,t.z),e.add(o);let s=new ia(7208847,1.15,8.4,2.1);s.position.set(t.x,1.35,t.z),e.add(s)}function ou(e){let t=new xr({color:4864534,transparent:!0,opacity:.035,depthWrite:!1}),n=new xr({color:16772506,transparent:!0,opacity:.055,depthWrite:!1}),r=(t,n,r)=>{let i=t.width*Z,a=t.height*Z,o=new q(new ci(i,a),n);o.rotation.x=-Math.PI/2,o.position.set(gl+t.col*Z+i/2,r,_l+t.row*Z+a/2),e.add(o)};dl.forEach(e=>r(e,t,.018)),ul.forEach(e=>r(e,n,.022))}function su(){let e=[],t=[],n=[];for(let r=0;r<ml;r+=1)for(let i=0;i<hl;i+=1){if(!El(i,r))continue;let a=Al(i,r),o=Ol(i,r,ul),s=Ol(i,r,dl),c=kl(i,r)>=3;if(!El(i,r-1)){let t=new U(a.x,Gc/2,a.z-Z/2);e.push(t)}if(!El(i,r+1)){let t=new U(a.x,Gc/2,a.z+Z/2);e.push(t)}if(!El(i-1,r)){let e=new U(a.x-Z/2,Gc/2,a.z);t.push(e)}if(!El(i+1,r)){let e=new U(a.x+Z/2,Gc/2,a.z);t.push(e)}let l=(i*37+r*19)%11,u=i%6==3&&r%4==1,d=i%5==2&&r%4==1,f=El(i-1,r)&&El(i+1,r),p=El(i,r-1)&&El(i,r+1),m=!c&&(f||p)&&r%5==2&&i%6==3;(o&&d||!s&&c&&u||!s&&m||s&&u&&(r+i)%2==0)&&n.push({x:a.x,z:a.z,rotation:0,phase:i*.83+r*1.17,speed:s?5+i*r%5:2.6+i*r%4*.45,weak:s?.18:o?0:c?.04:.08,range:o?14.8:s?8.6:11.4,baseIntensity:o?1.78:s?.74:1.24,panelWidth:o?2.95:c?2.58:2.08,color:s?15194015:16775647,hasPointLight:o||c||m&&l<=2,priority:(o?4:0)+(c?2:0)-!!s})}let r=[],i=Al(vl.col,vl.row),a=Al(yl.col,yl.row);return n.push({x:i.x,z:i.z,rotation:0,phase:.2,speed:2.2,weak:.02,range:13.6,baseIntensity:1.46,panelWidth:2.72,color:16775647,hasPointLight:!0,priority:8},{x:a.x,z:a.z,rotation:0,phase:1.4,speed:2.4,weak:.02,range:13.2,baseIntensity:1.42,panelWidth:2.72,color:16775647,hasPointLight:!0,priority:7}),n.sort((e,t)=>t.priority-e.priority).forEach(e=>{r.some(t=>Math.hypot(t.x-e.x,t.z-e.z)<Yc)||r.push(e)}),{northSouth:e,eastWest:t,fixturePositions:r}}function cu(){let e=new gn,t=14209184;e.background=new K(t),e.fog=new hn(t,.0095);let n=new ea(72,1,.05,Math.hypot(hl*Z,ml*Z)+Z*2),r=Ul(n);e.add(n);let i=Al(vl.col,vl.row),a={x:i.x,z:i.z,yaw:vl.yaw},o=Al(yl.col,yl.row),s=Bl(),c=zl(),l=Vl(),u=new J({map:s,color:16181702,emissive:9073737,emissiveIntensity:.2,roughness:.98}),d=new J({map:c,color:16776419,emissive:6642484,emissiveIntensity:.11,roughness:.92,metalness:0}),f=new J({map:l,color:16775135,emissive:12628090,emissiveIntensity:.4,roughness:.86}),p=new J({color:13088632,emissive:5786660,emissiveIntensity:.1,roughness:.98,metalness:0}),m=[d,d,p,p,d,d],h=new q(new ci(hl*Z,ml*Z),u);h.rotation.x=-Math.PI/2,h.position.set(0,0,0),e.add(h);let g=new q(new ci(hl*Z,ml*Z),f);g.rotation.x=Math.PI/2,g.position.set(0,qc,0),e.add(g);let{northSouth:_,eastWest:v,fixturePositions:y}=su();Kl(e,new ii(4.22,Gc,Kc),m,_),Kl(e,new ii(Kc,Gc,4.22),m,v);let b=new Hi(16775388,12164456,1.44);e.add(b);let x=new sa(16775384,.32);x.position.set(-18,qc-.45,12),e.add(x);let S=ru(e,y),C=Yl(`HUM`,{dimBelow:.5,normalAbove:.66});au(e,o),ou(e);let w=Ql(e,{cols:hl,rows:ml,isCellOpen:El,getCellCenter:Al,avoidPositions:[i,o]}),T=eu(e,{cols:hl,rows:ml,isCellOpen:El,getCellCenter:Al,avoidPositions:[i,o]}),E=!1;function D(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=jl(e+n,t+r);return El(i.col,i.row)})}function ee(t,i,a){let s=0;S.forEach(e=>{let t=.92+Math.sin(i*1.45+e.phase)*.035,n=Math.sin(i*e.speed+e.phase*2.4)>.965?.72:1,r=Math.max(.58,t*n-e.weak);e.material.emissiveIntensity=r*e.baseIntensity*1.56,Jl(e,r,1.1),s+=r});let c=S.length>0?s/S.length:.9,l=Math.hypot(a.x-o.x,a.z-o.z);l<bl&&(E=!0),e.fog.density=.0095+(1-c)*.004,Gl(r,i,a);let u=w.update(t,i,a),d=T.update(t,i,a);return{exitDistance:Math.round(l),exitReached:E,flicker:c,lightState:C(t,c),focusItem:tu(w.inspect(n),T.inspect(n)),almondWater:u,flashlight:d}}return{level:0,levelLabel:`LEVEL 0`,levelName:`NOCLIP ZONE`,viewModelName:Wl(r),nextLevel:1,scene:e,camera:n,spawn:a,isWalkable:D,update:ee,tryPickup:e=>nu(e,T,w)}}var lu=35,uu=25,du=Z*.86,fu={col:4,row:22,yaw:-Math.PI*.18},pu={col:31,row:1},mu=10,hu=Z*4.15,gu=[{col:1,row:16,width:8,height:5},{col:23,row:11,width:10,height:6}],_u=[{col:11,row:7,width:6,height:4},{col:25,row:17,width:6,height:4}];function vu(){let e=Array.from({length:uu},()=>Array.from({length:lu},()=>`#`)),t=(t,n)=>{n>0&&n<uu-1&&t>0&&t<lu-1&&(e[n][t]=`.`)};((e,n,r,i)=>{for(let a=n;a<n+i;a+=1)for(let n=e;n<e+r;n+=1)t(n,a)})(1,1,lu-2,uu-2);let n=[{col:2,row:2,width:5,height:3},{col:13,row:2,width:8,height:2},{col:27,row:5,width:5,height:3},{col:3,row:17,width:5,height:3},{col:18,row:18,width:5,height:3},{col:28,row:14,width:4,height:4}],r=[];for(let e=6;e<=20;e+=5)for(let t=8;t<=26;t+=6)r.push({col:t,row:e,width:1,height:1});return[...n,...r].forEach(t=>{for(let n=t.row;n<t.row+t.height;n+=1)for(let r=t.col;r<t.col+t.width;r+=1)n>0&&n<uu-1&&r>0&&r<lu-1&&!(r===fu.col&&n===fu.row)&&!(r===pu.col&&n===pu.row)&&(e[n][r]=`#`)}),e.map(e=>e.join(``))}var yu=vu(),bu=-140/2,xu=-100/2;function Su(e,t){return t>=0&&t<uu&&e>=0&&e<lu&&yu[t][e]===`.`}function Cu(e,t){return{x:bu+e*Z+Z/2,z:xu+t*Z+Z/2}}function wu(e,t){return{col:Math.floor((e-bu)/Z),row:Math.floor((t-xu)/Z)}}function Tu(e,t,n){return n.some(n=>Dl(e,t,n))}function Eu(e,t){return[[0,-1],[0,1],[-1,0],[1,0]].filter(([n,r])=>Su(e+n,t+r)).length}function Du(e,t,n,r,i=1){let a=Nl(e);return Ml(512,(t,n)=>{let o=t.createImageData(n,n),s=o.data;for(let t=0;t<n;t+=1)for(let o=0;o<n;o+=1){let c=(t*n+o)*4,l=(Ll(o,t,n,4,e*.03)-.5)*30*i,u=(Ll(o,t,n,15,e*.07)-.5)*12*i,d=(a()-.5)*9*i,f=Math.max(0,Ll(o,t,n,7,e*.11)-.62)*-32,p=l+u+d+f;s[c]=Pl(r[0]+p),s[c+1]=Pl(r[1]+p*.94),s[c+2]=Pl(r[2]+p*.86),s[c+3]=255}t.putImageData(o,0,0);let c=e===1973776,l=e===1973777,u=e===1973778;if(c){t.strokeStyle=`rgba(20,23,21,0.24)`,t.lineWidth=2;for(let e=0;e<=n;e+=128)t.beginPath(),t.moveTo(e,0),t.lineTo(e+(a()-.5)*14,n),t.stroke();t.globalAlpha=.14,t.strokeStyle=`#202823`,t.lineWidth=9;for(let e=0;e<5;e+=1){let e=60+a()*(n-120);t.beginPath(),t.moveTo(-40,e),t.bezierCurveTo(n*.28,e+a()*30,n*.7,e-a()*26,n+40,e+a()*12),t.stroke()}t.globalAlpha=1}else if(l){t.globalAlpha=.18,t.fillStyle=`#2d3832`;for(let e=0;e<18;e+=1){let e=a()*n,r=4+a()*18,i=80+a()*240;t.fillRect(e,a()*70,r,i)}t.globalAlpha=1}else if(u){t.strokeStyle=`rgba(22,27,24,0.22)`,t.lineWidth=2;for(let e=0;e<=n;e+=128)t.beginPath(),t.moveTo(e,0),t.lineTo(e,n),t.stroke();for(let e=0;e<=n;e+=128)t.beginPath(),t.moveTo(0,e),t.lineTo(n,e),t.stroke()}t.strokeStyle=`rgba(28,31,30,0.28)`,t.lineWidth=1.2;for(let e=0;e<34;e+=1){let e=a()*n,r=a()*n,i=18+a()*86,o=a()*Math.PI;t.beginPath(),t.moveTo(e,r),t.lineTo(e+Math.cos(o)*i,r+Math.sin(o)*i),t.stroke()}Rl(t,n,900,.09,`18,20,19`,a),Rl(t,n,180,.06,`190,197,184`,a)},t,n)}function Ou(){return Du(1973776,13,10,[84,88,82],1.08)}function ku(){return Du(1973777,2.8,1.15,[102,107,101],.9)}function Au(){let e=Du(1973778,10,7,[76,80,77],.82);return e.needsUpdate=!0,e}function ju(e,t){let n=[],r=new Set(t.map((e,t)=>({index:t,priority:e.priority})).sort((e,t)=>t.priority-e.priority).slice(0,mu).map(({index:e})=>e)),i=new ii(1,.04,.34),a=new ii(1,.04,.48),o=new J({color:5660763,emissive:1909793,emissiveIntensity:.16,roughness:.72,metalness:.22});return t.forEach((t,s)=>{let c=new q(a,o);c.position.set(t.x,qc-.075,t.z),c.rotation.y=t.rotation,c.scale.x=t.panelWidth+.32,e.add(c);let l=new J({color:t.color,emissive:t.color,emissiveIntensity:t.baseIntensity,roughness:.22}),u=new q(i,l);u.position.set(t.x,qc-.12,t.z),u.rotation.y=t.rotation,u.scale.x=t.panelWidth,e.add(u);let d=null;t.hasPointLight&&r.has(s)&&(d=ql(t,qc-.32,{rangeScale:1.52,intensityScale:1.2}),e.add(d)),n.push({material:l,light:d,phase:t.phase,speed:t.speed,baseIntensity:t.baseIntensity,weak:t.weak,broken:t.broken})}),n}function Mu(e){let t=wu(e.x,e.z),n=[{col:t.col,row:t.row-1,x:e.x,z:e.z-Z/2+Kc*.65,rotation:0},{col:t.col,row:t.row+1,x:e.x,z:e.z+Z/2-Kc*.65,rotation:Math.PI},{col:t.col-1,row:t.row,x:e.x-Z/2+Kc*.65,z:e.z,rotation:Math.PI/2},{col:t.col+1,row:t.row,x:e.x+Z/2-Kc*.65,z:e.z,rotation:-Math.PI/2}];return n.find(e=>!Su(e.col,e.row))??n[0]}function Nu(e,t){let n=Mu(t),r=new J({color:4870992,emissive:1119765,emissiveIntensity:.16,roughness:.58,metalness:.18}),i=new J({map:Hl(`ELEVATOR`,`#15231f`,`#c9ffd5`),color:16777215,emissive:2182967,emissiveIntensity:.42,roughness:.5,side:2}),a=new q(new ci(2.4,2.28),r);a.position.set(n.x,1.24,n.z),a.rotation.y=n.rotation,e.add(a);let o=new q(new ii(.035,2.16,.022),new J({color:2106916,roughness:.7,metalness:.26}));o.position.set(t.x,1.24,n.z+(n.rotation===0?.014:-.014)),o.rotation.y=n.rotation,e.add(o);let s=new q(new ci(2.35,.72),i);s.position.set(n.x,2.67,n.z),s.rotation.y=n.rotation,e.add(s);let c=new xr({color:10682321,transparent:!0,opacity:.12,depthWrite:!1,side:2}),l=new q(new ci(Z*.9,Z*.9),c);l.rotation.x=-Math.PI/2,l.position.set(t.x,.032,t.z),e.add(l);let u=new ia(9764808,.65,7.2,2.25);u.position.set(t.x,1.55,t.z),e.add(u)}function Pu(e){let t=new J({color:2503214,roughness:.7,metalness:.28}),n=new oi(.07,.07,Z*9.5,14);[{col:9,row:4,axis:`x`},{col:18,row:10,axis:`z`},{col:27,row:20,axis:`x`},{col:6,row:18,axis:`z`}].forEach(r=>{let i=Cu(r.col,r.row),a=new q(n,t);a.position.set(i.x,qc-.42,i.z),r.axis===`x`&&(a.rotation.z=Math.PI/2),r.axis===`z`&&(a.rotation.x=Math.PI/2),e.add(a)})}function Fu(e){let t=new J({color:6969408,emissive:2168847,emissiveIntensity:.08,roughness:.86}),n=new J({color:3948858,emissive:1119505,emissiveIntensity:.06,roughness:.82}),r=new ii(1.25,.86,1.15),i=[];return[{col:12,row:8,x:-.72,z:-.5,rot:.18,dark:!1},{col:14,row:8,x:.45,z:.45,rot:-.12,dark:!0},{col:16,row:10,x:-.3,z:.65,rot:.08,dark:!1},{col:25,row:18,x:-.54,z:-.52,rot:.2,dark:!0},{col:27,row:19,x:.58,z:.1,rot:-.26,dark:!1},{col:29,row:18,x:-.2,z:.4,rot:.08,dark:!0}].forEach(a=>{let o=Cu(a.col,a.row),s=new q(r,a.dark?n:t);s.position.set(o.x+a.x,.43,o.z+a.z),s.rotation.y=a.rot,e.add(s);let c={minX:s.position.x-.86,maxX:s.position.x+.86,minZ:s.position.z-.82,maxZ:s.position.z+.82};s.userData.collider=c,i.push(c)}),i}function Iu(e,t,n,r){let i=Math.max(r.minX,Math.min(e,r.maxX)),a=Math.max(r.minZ,Math.min(t,r.maxZ));return(e-i)**2+(t-a)**2<n**2}function Lu(e){let t=new xr({color:1054742,transparent:!0,opacity:.28,depthWrite:!1,side:2});[{col:7,row:18,width:5.4,height:2.1,rot:-.18},{col:20,row:12,width:4.5,height:1.7,rot:.14},{col:29,row:9,width:3.9,height:1.35,rot:-.06}].forEach(n=>{let r=Cu(n.col,n.row),i=new q(new ci(n.width,n.height),t);i.rotation.x=-Math.PI/2,i.rotation.z=n.rot,i.position.set(r.x,.026,r.z),e.add(i)})}function Ru(e){let t=new xr({color:1909536,transparent:!0,opacity:.11,depthWrite:!1}),n=new xr({color:13095347,transparent:!0,opacity:.055,depthWrite:!1}),r=(t,n,r)=>{let i=t.width*Z,a=t.height*Z,o=new q(new ci(i,a),n);o.rotation.x=-Math.PI/2,o.position.set(bu+t.col*Z+i/2,r,xu+t.row*Z+a/2),e.add(o)};gu.forEach(e=>r(e,t,.018)),_u.forEach(e=>r(e,n,.02))}function zu(e){let t=new xr({color:14147272,transparent:!0,opacity:.18,depthWrite:!1,side:2}),n=new xr({color:14076250,transparent:!0,opacity:.18,depthWrite:!1,side:2});[{col:5,row:21,width:9.4,height:.09,rot:0,hazard:!1},{col:5,row:23,width:7.8,height:.08,rot:0,hazard:!1},{col:13,row:8,width:6.4,height:.1,rot:Math.PI/2,hazard:!0},{col:16,row:9,width:5.2,height:.08,rot:0,hazard:!1},{col:27,row:18,width:7.2,height:.1,rot:0,hazard:!0},{col:30,row:19,width:5.8,height:.08,rot:Math.PI/2,hazard:!1}].forEach(r=>{let i=Cu(r.col,r.row),a=new q(new ci(r.width,r.height),r.hazard?n:t);a.rotation.x=-Math.PI/2,a.rotation.z=r.rot,a.position.set(i.x,.033,i.z),e.add(a)})}function Bu(e){[{col:12,row:7,text:`M.E.G. BASE`,bg:`#101f1a`,fg:`#c9ffd5`},{col:25,row:17,text:`SUPPLY`,bg:`#263022`,fg:`#e9ffbd`},{col:30,row:4,text:`ELEVATOR AHEAD`,bg:`#101f1a`,fg:`#9dffbe`},{col:7,row:18,text:`NO ENTRY`,bg:`#221814`,fg:`#ffd1a1`}].forEach(t=>{let n=Mu(Cu(t.col,t.row)),r=new J({map:Hl(t.text,t.bg,t.fg),color:16777215,emissive:1782568,emissiveIntensity:.24,roughness:.55,side:2}),i=new q(new ci(1.9,.54),r);i.position.set(n.x,1.74,n.z),i.rotation.y=n.rotation,e.add(i)})}function Vu(e){let t=new J({color:3094837,emissive:857105,emissiveIntensity:.08,roughness:.68,metalness:.28}),n=new J({color:7034423,emissive:1905416,emissiveIntensity:.08,roughness:.88}),r=new J({color:7692872,emissive:2234382,emissiveIntensity:.06,roughness:.86}),i=[];return[{col:12,row:9,rot:.04},{col:15,row:8,rot:-.05},{col:26,row:18,rot:Math.PI/2+.06},{col:29,row:18,rot:Math.PI/2-.04}].forEach(a=>{let o=Cu(a.col,a.row),s=new sn;s.position.set(o.x,0,o.z),s.rotation.y=a.rot;let c=new q(new ii(2.2,1.38,.08),t);c.position.set(0,.78,.32),s.add(c);for(let e=0;e<3;e+=1){let n=new q(new ii(2.3,.08,.72),t);n.position.set(0,.34+e*.47,0),s.add(n)}for(let e=-1;e<=1;e+=2){let n=new q(new ii(.08,1.45,.08),t);n.position.set(e*1.12,.72,-.32),s.add(n)}let l=new q(new ii(1.86,.18,.72),n);l.position.set(0,.09,-.72),s.add(l);let u=new q(new ii(.58,.42,.46),r);u.position.set(-.42,.59,-.06),u.rotation.y=.08,s.add(u),e.add(s);let d={minX:o.x-1.42,maxX:o.x+1.42,minZ:o.z-1.05,maxZ:o.z+1.05};s.userData.collider=d,i.push(d)}),i}function Hu(){let e=[],t=[],n=[];for(let r=0;r<uu;r+=1)for(let i=0;i<lu;i+=1){if(!Su(i,r))continue;let a=Cu(i,r),o=Tu(i,r,gu),s=Tu(i,r,_u),c=Eu(i,r)>=3;Su(i,r-1)||e.push(new U(a.x,Gc/2,a.z-Z/2)),Su(i,r+1)||e.push(new U(a.x,Gc/2,a.z+Z/2)),Su(i-1,r)||t.push(new U(a.x-Z/2,Gc/2,a.z)),Su(i+1,r)||t.push(new U(a.x+Z/2,Gc/2,a.z));let l=i%7==3&&r%5==2,u=i%9==5&&r%6==4;(l&&!o||u&&c)&&n.push({x:a.x,z:a.z,rotation:0,phase:i*.74+r*1.31,speed:o?6.2:3.1+(i+r)%5*.34,weak:o?.28:s?.06:.14,broken:o||(i+r)%13==0,range:s?15:c?12.8:9.8,baseIntensity:s?1.8:c?1.22:.92,panelWidth:s?2.95:2.35,color:s?15661020:14477270,hasPointLight:s||c,priority:(s?3:0)+(c?2:0)-(o?2:0)})}let r=[],i=Cu(fu.col,fu.row),a=Cu(pu.col,pu.row);return n.push({x:i.x,z:i.z,rotation:0,phase:.4,speed:2.6,weak:.03,broken:!1,range:15.8,baseIntensity:1.72,panelWidth:2.7,color:15661023,hasPointLight:!0,priority:8},{x:a.x,z:a.z,rotation:0,phase:1.7,speed:2.9,weak:.04,broken:!1,range:15.2,baseIntensity:1.66,panelWidth:2.8,color:14677468,hasPointLight:!0,priority:7}),n.sort((e,t)=>t.priority-e.priority).forEach(e=>{r.some(t=>Math.hypot(t.x-e.x,t.z-e.z)<hu)||r.push(e)}),{northSouth:e,eastWest:t,fixturePositions:r}}function Uu(){let e=new gn,t=9214094;e.background=new K(t),e.fog=new hn(t,.0115);let n=new ea(76,1,.05,Math.hypot(lu*Z,uu*Z)+Z*2),r=Ul(n);e.add(n);let i=Cu(fu.col,fu.row),a={x:i.x,z:i.z,yaw:fu.yaw},o=Cu(pu.col,pu.row),s=new J({map:Ou(),color:14015692,emissive:3884605,emissiveIntensity:.32,roughness:.96}),c=new J({map:ku(),color:14147028,emissive:3489846,emissiveIntensity:.27,roughness:.94}),l=new J({map:Au(),color:13357768,emissive:4279877,emissiveIntensity:.34,roughness:.9}),u=new J({color:7831414,emissive:2436392,emissiveIntensity:.12,roughness:.96}),d=[c,c,u,u,c,c],f=new q(new ci(lu*Z,uu*Z),s);f.rotation.x=-Math.PI/2,e.add(f);let p=new q(new ci(lu*Z,uu*Z),l);p.rotation.x=Math.PI/2,p.position.set(0,qc,0),e.add(p);let{northSouth:m,eastWest:h,fixturePositions:g}=Hu();Kl(e,new ii(4.22,Gc,Kc),d,m),Kl(e,new ii(Kc,Gc,4.22),d,h),e.add(new Hi(14936799,7108203,1.68));let _=new sa(14214356,.22);_.position.set(18,qc-.55,-10),e.add(_);let v=ju(e,g),y=Yl(`HUM`,{dimBelow:.48,normalAbove:.62});Nu(e,o),Pu(e);let b=Fu(e);b=b.concat(Vu(e)),Lu(e),Ru(e),zu(e),Bu(e);let x=Ql(e,{cols:lu,rows:uu,isCellOpen:Su,getCellCenter:Cu,avoidPositions:[i,o],blockedAabbs:b}),S=eu(e,{cols:lu,rows:uu,isCellOpen:Su,getCellCenter:Cu,avoidPositions:[i,o],blockedAabbs:b}),C=!1;function w(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=wu(e+n,t+r);return Su(i.col,i.row)})?!b.some(r=>Iu(e,t,n,r)):!1}function T(t,i,a){let s=0;v.forEach(e=>{let t=.84+Math.sin(i*1.18+e.phase)*.055,n=e.broken&&Math.sin(i*e.speed+e.phase)>.93?.52:1,r=Math.max(.38,t*n-e.weak);e.material.emissiveIntensity=r*e.baseIntensity*1.55,Jl(e,r,1.05),s+=r});let c=v.length>0?s/v.length:.76,l=Math.hypot(a.x-o.x,a.z-o.z);l<du&&(C=!0),e.fog.density=.012+(1-c)*.009,Gl(r,i,a);let u=x.update(t,i,a),d=S.update(t,i,a);return{exitDistance:Math.round(l),exitReached:C,flicker:c,almondWater:u,flashlight:d,focusItem:tu(x.inspect(n),S.inspect(n)),lightState:y(t,c),statusText:C?`ELEVATOR ONLINE`:l<9?`ELEVATOR TRACE`:`HABITABLE ZONE`}}return{level:1,levelLabel:`LEVEL 1`,levelName:`HABITABLE ZONE`,viewModelName:Wl(r),colliderCount:b.length,nextLevel:2,scene:e,camera:n,spawn:a,isWalkable:w,update:T,tryPickup:e=>nu(e,S,x)}}var Wu=39,Gu=23,Ku={col:3,row:3,yaw:-Math.PI*.44},qu={col:36,row:20},Ju=Z*.74,Yu=8,Xu=Z*5.25,Zu=[{col:4,row:7,width:4,height:3},{col:12,row:13,width:5,height:4},{col:24,row:14,width:4,height:4},{col:31,row:17,width:4,height:3}];function Qu(){let e=Array.from({length:Gu},()=>Array.from({length:Wu},()=>`#`)),t=(t,n)=>{n>0&&n<Gu-1&&t>0&&t<Wu-1&&(e[n][t]=`.`)},n=(e,n,r,i)=>{for(let a=n;a<n+i;a+=1)for(let n=e;n<e+r;n+=1)t(n,a)},r=(e,n,r,i=1)=>{let a=Math.min(e,n),o=Math.max(e,n);for(let e=a;e<=o;e+=1)for(let n=0;n<i;n+=1)t(e,r+n)},i=(e,n,r,i=1)=>{let a=Math.min(n,r),o=Math.max(n,r);for(let n=a;n<=o;n+=1)for(let r=0;r<i;r+=1)t(e+r,n)};return r(2,15,3,2),i(14,3,11,2),r(8,28,10,2),i(8,10,20,2),r(8,36,19,2),i(30,11,20,2),r(24,34,11,2),n(3,6,5,4),n(18,5,6,5),n(12,13,5,4),n(25,14,6,4),n(31,17,6,4),[{col:20,row:7},{col:22,row:7},{col:12,row:15},{col:28,row:16},{col:33,row:18}].forEach(({col:t,row:n})=>{!(t===Ku.col&&n===Ku.row)&&!(t===qu.col&&n===qu.row)&&(e[n][t]=`#`)}),e.map(e=>e.join(``))}var $u=Qu(),ed=-156/2,td=-92/2;function nd(e,t){return t>=0&&t<Gu&&e>=0&&e<Wu&&$u[t][e]===`.`}function rd(e,t){return{x:ed+e*Z+Z/2,z:td+t*Z+Z/2}}function id(e,t){return{col:Math.floor((e-ed)/Z),row:Math.floor((t-td)/Z)}}function ad(e,t){return[[0,-1],[0,1],[-1,0],[1,0]].filter(([n,r])=>nd(e+n,t+r)).length}function od(e,t,n,r,i=1){let a=Nl(e);return Ml(512,(t,n)=>{let o=t.createImageData(n,n),s=o.data;for(let t=0;t<n;t+=1)for(let o=0;o<n;o+=1){let c=(t*n+o)*4,l=(Ll(o,t,n,5,e*.021)-.5)*36,u=Math.max(0,Ll(o,t,n,11,e*.047)-.58)*-46,d=Math.max(0,Ll(o,t,n,8,e*.091)-.68)*28*i,f=(a()-.5)*10;s[c]=Pl(r[0]+l+u+d+f),s[c+1]=Pl(r[1]+l*.84+u*.72+d*.42+f),s[c+2]=Pl(r[2]+l*.58+u*.62+d*.18+f*.7),s[c+3]=255}t.putImageData(o,0,0);let c=e===3088387,l=e===3088388;if(c){t.globalAlpha=.24;for(let e=0;e<18;e+=1){let e=a()*n,r=a()*n*.38,i=70+a()*210,o=4+a()*12,s=t.createLinearGradient(e,r,e,r+i);s.addColorStop(0,`rgba(124,63,25,0.52)`),s.addColorStop(1,`rgba(124,63,25,0)`),t.fillStyle=s,t.fillRect(e,r,o,i)}t.globalAlpha=1}else if(l){t.strokeStyle=`rgba(7,8,7,0.34)`,t.lineWidth=3;for(let e=24;e<n;e+=76)t.beginPath(),t.moveTo(0,e),t.lineTo(n,e+(a()-.5)*14),t.stroke()}t.globalAlpha=.18,t.strokeStyle=`#15140f`,t.lineWidth=1.3;for(let e=0;e<28;e+=1){let e=a()*n,r=a()*n,i=24+a()*120,o=a()*Math.PI;t.beginPath(),t.moveTo(e,r),t.lineTo(e+Math.cos(o)*i,r+Math.sin(o)*i),t.stroke()}t.globalAlpha=1;for(let e=0;e<=n;e+=86)t.fillStyle=`rgba(28,24,18,0.18)`,t.fillRect(e-1,0,2,n);Rl(t,n,980,.1,`13,12,9`,a),Rl(t,n,210,.08,`173,104,50`,a)},t,n)}function sd(){let e=Nl(3088386);return Ml(512,(t,n)=>{t.fillStyle=`#3d3d30`,t.fillRect(0,0,n,n);for(let e=0;e<n;e+=1)t.fillStyle=`rgba(0,0,0,${.05+Math.sin(e*.08)*.018})`,t.fillRect(0,e,n,1);t.strokeStyle=`rgba(15,14,10,0.46)`,t.lineWidth=2;for(let e=0;e<=n;e+=64)t.beginPath(),t.moveTo(e,0),t.lineTo(e,n),t.stroke();for(let e=0;e<=n;e+=96)t.beginPath(),t.moveTo(0,e),t.lineTo(n,e),t.stroke();t.globalAlpha=.2,t.strokeStyle=`#b15d2d`,t.lineWidth=2.2;for(let r=0;r<16;r+=1){let r=e()*n;t.beginPath(),t.moveTo(e()*80,r),t.lineTo(n-e()*80,r+(e()-.5)*18),t.stroke()}t.globalAlpha=1,t.globalAlpha=.22,t.fillStyle=`#0d0d0a`;for(let e=44;e<n;e+=132){t.fillRect(0,e,n,18),t.fillStyle=`#7b4a24`;for(let r=0;r<n;r+=42)t.fillRect(r,e,22,18);t.fillStyle=`#0d0d0a`}t.globalAlpha=1,Rl(t,n,1050,.1,`12,12,9`,e),Rl(t,n,360,.12,`153,92,43`,e)},11,9)}function cd(){return od(3088387,2.4,1.1,[84,78,61],1.15)}function ld(){return od(3088388,8,6,[56,54,44],.8)}function ud(){let e=[],t=[],n=[];for(let r=0;r<Gu;r+=1)for(let i=0;i<Wu;i+=1){if(!nd(i,r))continue;let a=rd(i,r),o=Ol(i,r,Zu);nd(i,r-1)||e.push(new U(a.x,Gc/2,a.z-Z/2)),nd(i,r+1)||e.push(new U(a.x,Gc/2,a.z+Z/2)),nd(i-1,r)||t.push(new U(a.x-Z/2,Gc/2,a.z)),nd(i+1,r)||t.push(new U(a.x+Z/2,Gc/2,a.z));let s=ad(i,r),c=nd(i-1,r)||nd(i+1,r),l=s<=2,u=(i*11+r*7)%17==0;o&&!(i===3&&r===3||i===36&&r===20)||(l&&u||i===3&&r===3||i===36&&r===20)&&n.push({x:a.x,z:a.z,rotation:c?0:Math.PI/2,phase:i*.57+r*1.17,speed:3.8+(i+r)%5*.62,weak:.2+(i+r)%3*.04,range:i===3||i===36?12.6:9.6,baseIntensity:i===3||i===36?1.36:.95,panelWidth:1.35+(i+r)%2*.38,color:(i+r)%4==0?16742973:16756828,hasPointLight:!0,priority:i===3||i===36?8:l?3:1})}let r=[];return n.sort((e,t)=>t.priority-e.priority).forEach(e=>{r.some(t=>Math.hypot(t.x-e.x,t.z-e.z)<Xu)||r.push(e)}),{northSouth:e,eastWest:t,fixturePositions:r}}function dd(e,t){let n=[],r=new Set(t.map((e,t)=>({index:t,priority:e.priority})).sort((e,t)=>t.priority-e.priority).slice(0,Yu).map(({index:e})=>e)),i=new ii(1,.045,.34),a=new ii(1,.05,.48),o=new J({color:2826776,emissive:1313541,emissiveIntensity:.24,roughness:.82,metalness:.36});return t.forEach((t,s)=>{let c=new q(a,o);c.position.set(t.x,qc-.095,t.z),c.rotation.y=t.rotation,c.scale.x=t.panelWidth+.2,e.add(c);let l=new J({color:t.color,emissive:t.color,emissiveIntensity:t.baseIntensity,roughness:.34}),u=new q(i,l);u.position.set(t.x,qc-.145,t.z),u.rotation.y=t.rotation,u.scale.x=t.panelWidth,e.add(u);let d=null;r.has(s)&&(d=ql(t,qc-.44,{rangeScale:1.62,intensityScale:1.32,decay:2.05}),e.add(d)),n.push({material:l,light:d,phase:t.phase,speed:t.speed,weak:t.weak,baseIntensity:t.baseIntensity})}),n}function fd(e,t,n){let r=rd(n.col,n.row),i=new q(new oi(n.radius,n.radius,n.length,14),t);if(i.position.set(r.x+(n.offsetX??0),n.y,r.z+(n.offsetZ??0)),n.axis===`x`&&(i.rotation.z=Math.PI/2),n.axis===`z`&&(i.rotation.x=Math.PI/2),e.add(i),n.joint){let r=new q(new ui(n.radius*1.35,12,8),t);r.position.copy(i.position),e.add(r)}}function pd(e){let t=new J({color:3813930,emissive:1051141,emissiveIntensity:.12,roughness:.76,metalness:.36}),n=new J({color:5713948,emissive:2821380,emissiveIntensity:.2,roughness:.7,metalness:.32});[{col:8,row:3,axis:`x`,length:Z*11,radius:.08,y:qc-.48,offsetZ:-.9},{col:14,row:8,axis:`z`,length:Z*8.5,radius:.11,y:qc-.36,offsetX:-.95,hot:!0,joint:!0},{col:20,row:10,axis:`x`,length:Z*9,radius:.07,y:2.55,offsetZ:1},{col:8,row:16,axis:`z`,length:Z*7,radius:.1,y:2.8,offsetX:.88,hot:!0},{col:22,row:19,axis:`x`,length:Z*17,radius:.09,y:qc-.52,offsetZ:-1.05},{col:30,row:15,axis:`z`,length:Z*9,radius:.12,y:2.38,offsetX:1.05,joint:!0},{col:32,row:11,axis:`x`,length:Z*8,radius:.065,y:qc-.68,offsetZ:.82}].forEach(r=>fd(e,r.hot?n:t,r))}function md(e){let t=new J({color:2565407,emissive:591620,emissiveIntensity:.1,roughness:.8,metalness:.26}),n=new J({color:5912097,emissive:1443844,emissiveIntensity:.1,roughness:.88,metalness:.18}),r=new xr({color:16752730}),i=[];return[{col:5,row:7,width:1.35,height:1.15,depth:1,x:.6,z:-.5,rot:.05},{col:20,row:7,width:1.65,height:1.35,depth:.85,x:-.4,z:.5,rot:-.12,rust:!0},{col:13,row:15,width:1.2,height:1,depth:1.25,x:.45,z:-.35,rot:.16},{col:27,row:15,width:1.6,height:1.55,depth:1.15,x:-.55,z:.42,rot:-.06,rust:!0},{col:33,row:19,width:1.28,height:1.08,depth:1,x:.2,z:.3,rot:.18}].forEach(a=>{let o=rd(a.col,a.row),s=new q(new ii(a.width,a.height,a.depth),a.rust?n:t);s.position.set(o.x+a.x,a.height/2,o.z+a.z),s.rotation.y=a.rot,e.add(s);let c=new q(new ii(.3,.08,.018),r);c.position.set(s.position.x,s.position.y+a.height*.18,s.position.z-a.depth/2-.012),c.rotation.y=a.rot,e.add(c),i.push({minX:s.position.x-a.width*.62,maxX:s.position.x+a.width*.62,minZ:s.position.z-a.depth*.62,maxZ:s.position.z+a.depth*.62})}),i}function hd(e){let t=[],n=new ui(.34,12,8);return[{col:14,row:8,x:-1.05,z:.48,phase:.2},{col:8,row:16,x:.9,z:-.35,phase:1.6},{col:30,row:15,x:1,z:.42,phase:2.7},{col:23,row:19,x:-.4,z:-1,phase:3.3}].forEach(r=>{let i=rd(r.col,r.row),a=new q(n,new xr({color:14208438,transparent:!0,opacity:.08,depthWrite:!1}));a.position.set(i.x+r.x,1.22,i.z+r.z),a.scale.set(1,.8,1),a.userData.phase=r.phase,e.add(a),t.push(a)}),t}function gd(e){let t=id(e.x,e.z),n=[{col:t.col,row:t.row-1,x:e.x,z:e.z-Z/2+Kc*.7,rotation:0},{col:t.col,row:t.row+1,x:e.x,z:e.z+Z/2-Kc*.7,rotation:Math.PI},{col:t.col-1,row:t.row,x:e.x-Z/2+Kc*.7,z:e.z,rotation:Math.PI/2},{col:t.col+1,row:t.row,x:e.x+Z/2-Kc*.7,z:e.z,rotation:-Math.PI/2}];return n.find(e=>!nd(e.col,e.row))??n[0]}function _d(e,t){let n=gd(t),r=new J({color:2827552,emissive:1181700,emissiveIntensity:.18,roughness:.72,metalness:.34}),i=new J({map:Hl(`PIPE EXIT`,`#241108`,`#ffbc73`),color:16777215,emissive:8006923,emissiveIntensity:.55,roughness:.5,side:2}),a=new q(new ci(2.35,2.35),r);a.position.set(n.x,1.28,n.z),a.rotation.y=n.rotation,e.add(a);let o=new q(new ci(2.22,.62),i);o.position.set(n.x,2.62,n.z),o.rotation.y=n.rotation,e.add(o);let s=new q(new li(Z*.32,Z*.52,32),new xr({color:16747325,transparent:!0,opacity:.13,depthWrite:!1,side:2}));s.rotation.x=-Math.PI/2,s.position.set(t.x,.035,t.z),e.add(s);let c=new ia(16747325,.52,6.8,2.2);c.position.set(t.x,1.6,t.z),e.add(c)}function vd(e){let t=new xr({color:16742960,transparent:!0,opacity:.055,depthWrite:!1,side:2});[{col:13,row:9,width:3.2,height:5.8,rot:.08},{col:29,row:16,width:3.6,height:4.8,rot:-.11},{col:21,row:19,width:6.4,height:2,rot:.02}].forEach(n=>{let r=rd(n.col,n.row),i=new q(new ci(n.width,n.height),t);i.rotation.x=-Math.PI/2,i.rotation.z=n.rot,i.position.set(r.x,.028,r.z),e.add(i)})}function yd(e){let t=new xr({color:328707,transparent:!0,opacity:.2,depthWrite:!1,side:2}),n=new xr({color:328707,transparent:!0,opacity:.1,depthWrite:!1,side:2});Zu.forEach(r=>{let i=r.width*Z,a=r.height*Z,o=ed+r.col*Z+i/2,s=td+r.row*Z+a/2,c=new q(new ci(i,a),t);c.rotation.x=-Math.PI/2,c.position.set(o,.04,s),e.add(c);let l=new q(new ci(i,a),n);l.rotation.x=Math.PI/2,l.position.set(o,qc-.035,s),e.add(l)})}function bd(e){let t=new J({color:329222,emissive:66050,emissiveIntensity:.12,roughness:.7,metalness:.2}),n=new oi(.028,.028,1,8);[{col:4,row:3,axis:`x`,length:Z*9.5,y:qc-.18,offsetZ:.86},{col:14,row:10,axis:`z`,length:Z*8,y:qc-.2,offsetX:.78},{col:21,row:19,axis:`x`,length:Z*14,y:qc-.16,offsetZ:-.9},{col:30,row:14,axis:`z`,length:Z*6.5,y:qc-.2,offsetX:-.82}].forEach(r=>{let i=rd(r.col,r.row),a=new q(n,t);a.scale.y=r.length,a.position.set(i.x+(r.offsetX??0),r.y,i.z+(r.offsetZ??0)),r.axis===`x`&&(a.rotation.z=Math.PI/2),r.axis===`z`&&(a.rotation.x=Math.PI/2),e.add(a)}),[{col:14,row:4,text:`LOW PRESSURE`,bg:`#251308`,fg:`#ffbd73`},{col:20,row:10,text:`MAINTENANCE`,bg:`#17130d`,fg:`#ffd78a`},{col:29,row:18,text:`PIPE DREAMS`,bg:`#211006`,fg:`#ff945c`},{col:34,row:19,text:`KEEP MOVING`,bg:`#1b1109`,fg:`#ffca8f`}].forEach(t=>{let n=gd(rd(t.col,t.row)),r=new J({map:Hl(t.text,t.bg,t.fg),color:16777215,emissive:4988170,emissiveIntensity:.28,roughness:.64,side:2}),i=new q(new ci(1.8,.5),r);i.position.set(n.x,1.62,n.z),i.rotation.y=n.rotation,e.add(i)});let r=new J({color:7025952,emissive:1705731,emissiveIntensity:.16,roughness:.72,metalness:.22});[{col:14,row:8},{col:8,row:16},{col:30,row:15},{col:23,row:19}].forEach(t=>{let n=gd(rd(t.col,t.row)),i=new q(new di(.26,.026,8,24),r);i.position.set(n.x,1.44,n.z),i.rotation.y=n.rotation,e.add(i);let a=new q(new oi(.055,.055,.04,12),r);a.position.copy(i.position),a.rotation.x=Math.PI/2,a.rotation.y=n.rotation,e.add(a)});let i=new xr({color:328964,transparent:!0,opacity:.22,depthWrite:!1,side:2});[{col:14,row:10,width:2.6,height:1.1,rot:0},{col:8,row:19,width:2.2,height:1.2,rot:Math.PI/2},{col:30,row:12,width:2.7,height:1.15,rot:0}].forEach(t=>{let n=rd(t.col,t.row),r=new q(new ci(t.width,t.height),i);r.rotation.x=-Math.PI/2,r.rotation.z=t.rot,r.position.set(n.x,.036,n.z),e.add(r)})}function xd(e){let t=new J({color:5189922,emissive:1312516,emissiveIntensity:.12,roughness:.78,metalness:.24}),n=new J({color:1776407,emissive:328964,emissiveIntensity:.1,roughness:.82,metalness:.26}),r=new J({color:8014371,emissive:2165764,emissiveIntensity:.14,roughness:.72,metalness:.12}),i=[];return[{col:5,row:7,x:-.65,z:.5},{col:19,row:6,x:.54,z:-.62},{col:26,row:14,x:-.48,z:.56},{col:32,row:18,x:.58,z:-.48}].forEach((r,a)=>{let o=rd(r.col,r.row),s=new q(new oi(.3,.32,.82,18),a%2==0?t:n);s.position.set(o.x+r.x,.41,o.z+r.z),s.rotation.y=a*.28,e.add(s);for(let t=.17;t<=.67;t+=.25){let r=new q(new di(.305,.012,6,18),n);r.position.set(s.position.x,t,s.position.z),r.rotation.x=Math.PI/2,e.add(r)}i.push({minX:s.position.x-.42,maxX:s.position.x+.42,minZ:s.position.z-.42,maxZ:s.position.z+.42})}),[{col:13,row:15,x:.24,z:.6,rot:.22},{col:28,row:16,x:-.36,z:-.48,rot:-.2}].forEach(t=>{let n=rd(t.col,t.row),a=new q(new ii(1.55,.68,.16),r);a.position.set(n.x+t.x,.38,n.z+t.z),a.rotation.y=t.rot,e.add(a),i.push({minX:a.position.x-.88,maxX:a.position.x+.88,minZ:a.position.z-.52,maxZ:a.position.z+.52})}),i}function Sd(){let e=new gn,t=5588279;e.background=new K(t),e.fog=new hn(t,.0165);let n=new ea(76,1,.05,Math.hypot(Wu*Z,Gu*Z)+Z*2),r=Ul(n);e.add(n);let i=rd(Ku.col,Ku.row),a={x:i.x,z:i.z,yaw:Ku.yaw},o=rd(qu.col,qu.row),s=new J({map:sd(),color:13220240,emissive:3023122,emissiveIntensity:.4,roughness:.94,metalness:.08}),c=new J({map:cd(),color:13681307,emissive:2891023,emissiveIntensity:.32,roughness:.94,metalness:.04}),l=new J({map:ld(),color:9142640,emissive:2628626,emissiveIntensity:.36,roughness:.9,metalness:.08}),u=new J({color:4932405,emissive:1248776,emissiveIntensity:.16,roughness:.92,metalness:.08}),d=[c,c,u,u,c,c],f=new q(new ci(Wu*Z,Gu*Z),s);f.rotation.x=-Math.PI/2,e.add(f);let p=new q(new ci(Wu*Z,Gu*Z),l);p.rotation.x=Math.PI/2,p.position.set(0,qc,0),e.add(p);let{northSouth:m,eastWest:h,fixturePositions:g}=ud();Kl(e,new ii(4.22,Gc,Kc),d,m),Kl(e,new ii(Kc,Gc,4.22),d,h),e.add(new Hi(16760194,3351062,.96));let _=new sa(16751444,.16);_.position.set(-8,qc-.3,18),e.add(_);let v=dd(e,g),y=Yl(`HEAT`,{dimBelow:.34,normalAbove:.52,dimDelay:.5,normalDelay:.78});_d(e,o),pd(e);let b=md(e);b=b.concat(xd(e));let x=hd(e);vd(e),yd(e),bd(e);let S=Ql(e,{cols:Wu,rows:Gu,isCellOpen:nd,getCellCenter:rd,avoidPositions:[i,o],blockedAabbs:b}),C=eu(e,{cols:Wu,rows:Gu,isCellOpen:nd,getCellCenter:rd,avoidPositions:[i,o],blockedAabbs:b}),w=!1;function T(e,t,n=.36){let r=n*.72;return[[0,0],[n,0],[-n,0],[0,n],[0,-n],[r,r],[-r,r],[r,-r],[-r,-r]].every(([n,r])=>{let i=id(e+n,t+r);return nd(i.col,i.row)})?!b.some(r=>Iu(e,t,n,r)):!1}function E(t,i,a){let s=0;v.forEach(e=>{let t=.78+Math.sin(i*1.7+e.phase)*.07,n=Math.sin(i*e.speed+e.phase*1.7)>.91?.48:1,r=Math.max(.24,t*n-e.weak);e.material.emissiveIntensity=r*e.baseIntensity*1.8,Jl(e,r,1.08),s+=r}),x.forEach(e=>{let t=e.userData.phase??0,n=.5+Math.sin(i*1.8+t)*.5,r=.8+n*.9;e.scale.set(r*.78,.65+n*.9,r),e.position.y=1.12+n*.18,e.material.opacity=.035+n*.07});let c=v.length>0?s/v.length:.56,l=Math.hypot(a.x-o.x,a.z-o.z);l<Ju&&(w=!0),e.fog.density=.016+(1-c)*.01,Gl(r,i,a);let u=S.update(t,i,a),d=C.update(t,i,a);return{exitDistance:Math.round(l),exitReached:w,flicker:c,almondWater:u,flashlight:d,focusItem:tu(S.inspect(n),C.inspect(n)),lightState:y(t,c),statusText:w?`SERVICE LOCKED`:l<8?`PIPE EXIT TRACE`:`PIPE DREAMS`}}return{level:2,levelLabel:`LEVEL 2`,levelName:`PIPE DREAMS`,viewModelName:Wl(r),colliderCount:b.length,nextLevel:null,scene:e,camera:n,spawn:a,isWalkable:T,update:E,tryPickup:e=>nu(e,C,S)}}function Cd(e=0){let t=ll(e);return t.level===1?Uu():t.level===2?Sd():cu()}var wd=.36,Td=11.5,Ed=4.4,Dd=150,Od=30,kd=20,Ad=.55,jd=0,Md=50,Nd=45,Pd=200;function Fd(e,t,n){return Math.max(t,Math.min(n,e))}function Id(e){return Fd(e,-Math.PI*.47,Math.PI*.47)}var Ld=class{constructor({camera:e,canvas:t,joystick:n,jumpButton:r,isWalkable:i,spawn:a}){this.camera=e,this.canvas=t,this.joystick=n,this.joystickKnob=n?.querySelector(`.joystick__knob`),this.jumpButton=r,this.isWalkable=i,this.spawn=a,this.eyeHeight=1.62,this.moveSpeed=3.05,this.sprintMultiplier=1.65,this.lookSensitivity=.0028,this.touchSensitivity=.004,this.yaw=a.yaw,this.pitch=-.02,this.lookPointerId=null,this.lookLast=new H,this.joystickPointerId=null,this.joystickInput=new H,this.keys=new Set,this.forward=new U,this.right=new U,this.move=new U,this.isLocked=!1,this.verticalVelocity=0,this.groundY=this.eyeHeight,this.bodyY=this.eyeHeight,this.isGrounded=!0,this.jumpQueued=!1,this.staminaMax=Dd,this.stamina=Dd,this.staminaRecoveryDelay=0,this.almondWaterTimer=0,this.isSprinting=!1,this.walkCycle=0,this.walkBobStrength=0,this.headBobY=0,this.rollOffset=0,this.isMoving=!1,this.movementSpeed=0,this.onCanvasPointerDown=this.onCanvasPointerDown.bind(this),this.onCanvasPointerMove=this.onCanvasPointerMove.bind(this),this.onCanvasPointerUp=this.onCanvasPointerUp.bind(this),this.onKeyDown=this.onKeyDown.bind(this),this.onKeyUp=this.onKeyUp.bind(this),this.onBlur=this.onBlur.bind(this),this.onPointerLockChange=this.onPointerLockChange.bind(this),this.onPointerLockError=this.onPointerLockError.bind(this),this.onMouseMove=this.onMouseMove.bind(this),this.onJoystickDown=this.onJoystickDown.bind(this),this.onJoystickMove=this.onJoystickMove.bind(this),this.onJoystickUp=this.onJoystickUp.bind(this),this.onJumpButtonDown=this.onJumpButtonDown.bind(this),this.onJumpButtonUp=this.onJumpButtonUp.bind(this),t.addEventListener(`pointerdown`,this.onCanvasPointerDown),t.addEventListener(`pointermove`,this.onCanvasPointerMove),t.addEventListener(`pointerup`,this.onCanvasPointerUp),t.addEventListener(`pointercancel`,this.onCanvasPointerUp),window.addEventListener(`keydown`,this.onKeyDown),window.addEventListener(`keyup`,this.onKeyUp),window.addEventListener(`blur`,this.onBlur),document.addEventListener(`pointerlockchange`,this.onPointerLockChange),document.addEventListener(`pointerlockerror`,this.onPointerLockError),window.addEventListener(`mousemove`,this.onMouseMove),n&&(n.addEventListener(`pointerdown`,this.onJoystickDown),n.addEventListener(`pointermove`,this.onJoystickMove),n.addEventListener(`pointerup`,this.onJoystickUp),n.addEventListener(`pointercancel`,this.onJoystickUp)),r&&(r.addEventListener(`pointerdown`,this.onJumpButtonDown),r.addEventListener(`pointerup`,this.onJumpButtonUp),r.addEventListener(`pointercancel`,this.onJumpButtonUp),r.addEventListener(`pointerleave`,this.onJumpButtonUp)),this.reset()}reset(){this.bodyY=this.eyeHeight,this.headBobY=0,this.rollOffset=0,this.walkCycle=0,this.walkBobStrength=0,this.camera.position.set(this.spawn.x,this.bodyY,this.spawn.z),this.verticalVelocity=0,this.isGrounded=!0,this.jumpQueued=!1,this.almondWaterTimer<=0&&(this.staminaMax=Dd),this.stamina=this.staminaMax,this.staminaRecoveryDelay=0,this.isSprinting=!1,this.isMoving=!1,this.movementSpeed=0,this.yaw=this.spawn.yaw,this.pitch=-.025,this.applyRotation(),this.syncCameraState()}setWorld({camera:e,isWalkable:t,spawn:n}){this.camera=e,this.isWalkable=t,this.spawn=n,this.keys.clear(),this.resetJoystick(),this.reset()}canRequestPointerLock(){if(typeof this.canvas.requestPointerLock!=`function`||!document.hasFocus())return!1;try{return window.self===window.top}catch{return!1}}startDragLook(e){this.lookPointerId=e.pointerId,this.lookLast.set(e.clientX,e.clientY);try{this.canvas.setPointerCapture(e.pointerId)}catch{this.lookPointerId=null;return}this.canvas.classList.add(`is-dragging`)}applyRotation(){this.camera.rotation.order=`YXZ`,this.camera.rotation.y=this.yaw,this.camera.rotation.x=this.pitch,this.camera.rotation.z=this.rollOffset,this.syncCameraState()}syncCameraState(){this.canvas.dataset.cameraX=this.camera.position.x.toFixed(3),this.canvas.dataset.cameraY=this.camera.position.y.toFixed(3),this.canvas.dataset.cameraZ=this.camera.position.z.toFixed(3),this.canvas.dataset.cameraYaw=this.yaw.toFixed(3),this.canvas.dataset.cameraPitch=this.pitch.toFixed(3),this.canvas.dataset.grounded=String(this.isGrounded),this.canvas.dataset.stamina=this.stamina.toFixed(0),this.canvas.dataset.staminaMax=this.staminaMax.toFixed(0),this.canvas.dataset.staminaBaseMax=Dd.toFixed(0),this.canvas.dataset.almondWaterActive=String(this.almondWaterTimer>0),this.canvas.dataset.almondWaterRemaining=this.almondWaterTimer.toFixed(1),this.canvas.dataset.sprinting=String(this.isSprinting),this.canvas.dataset.moving=String(this.isMoving),this.canvas.dataset.movementSpeed=this.movementSpeed.toFixed(3),this.canvas.dataset.headBob=this.headBobY.toFixed(3)}queueJump(){this.jumpQueued=!0}canStandAt(e,t){return this.isWalkable(e,t,wd)}resolveMove(e,t){let n=this.camera.position.x,r=this.camera.position.z;return this.canStandAt(e,t)?{x:e,z:t}:this.canStandAt(e,r)?{x:e,z:r}:this.canStandAt(n,t)?{x:n,z:t}:{x:n,z:r}}onCanvasPointerDown(e){if(e.pointerType===`touch`){if(this.lookPointerId!==null)return;this.startDragLook(e);return}if(document.pointerLockElement!==this.canvas&&this.lookPointerId===null){if(this.canRequestPointerLock()){try{let t=this.canvas.requestPointerLock({unadjustedMovement:!0});t&&typeof t.catch==`function`&&t.catch(()=>{this.startDragLook(e)})}catch{this.startDragLook(e)}return}this.startDragLook(e)}}onCanvasPointerMove(e){if(e.pointerId!==this.lookPointerId)return;let t=e.clientX-this.lookLast.x,n=e.clientY-this.lookLast.y;this.lookLast.set(e.clientX,e.clientY);let r=e.pointerType===`touch`?this.touchSensitivity:this.lookSensitivity;this.yaw-=t*r,this.pitch=Id(this.pitch-n*r),this.applyRotation()}onCanvasPointerUp(e){e.pointerId===this.lookPointerId&&(this.canvas.hasPointerCapture(e.pointerId)&&this.canvas.releasePointerCapture(e.pointerId),this.lookPointerId=null,this.canvas.classList.remove(`is-dragging`))}onPointerLockChange(){this.isLocked=document.pointerLockElement===this.canvas,this.canvas.classList.toggle(`is-locked`,this.isLocked),this.canvas.dataset.mouseLocked=String(this.isLocked),this.isLocked||(this.keys.clear(),this.resetJoystick())}onPointerLockError(){this.isLocked=!1,this.canvas.classList.remove(`is-locked`),this.canvas.dataset.mouseLocked=`false`}onMouseMove(e){this.isLocked&&(this.yaw-=e.movementX*this.lookSensitivity,this.pitch=Id(this.pitch-e.movementY*this.lookSensitivity),this.applyRotation())}onKeyDown(e){if(e.code===`Space`){e.preventDefault(),e.repeat||this.queueJump();return}[`KeyW`,`KeyA`,`KeyS`,`KeyD`,`ShiftLeft`,`ShiftRight`].includes(e.code)&&(e.preventDefault(),this.keys.add(e.code))}onKeyUp(e){this.keys.delete(e.code)}onBlur(){this.keys.clear(),this.isSprinting=!1,this.isMoving=!1,this.movementSpeed=0,this.resetJoystick()}onJoystickDown(e){this.joystickPointerId===null&&(e.preventDefault(),e.stopPropagation(),this.joystickPointerId=e.pointerId,this.joystick.setPointerCapture(e.pointerId),this.updateJoystick(e))}onJoystickMove(e){e.pointerId===this.joystickPointerId&&(e.preventDefault(),e.stopPropagation(),this.updateJoystick(e))}onJoystickUp(e){e.pointerId===this.joystickPointerId&&(e.preventDefault(),e.stopPropagation(),this.joystick.hasPointerCapture(e.pointerId)&&this.joystick.releasePointerCapture(e.pointerId),this.joystickPointerId=null,this.resetJoystick())}updateJoystick(e){let t=this.joystick.getBoundingClientRect(),n=t.width*.32,r=e.clientX-(t.left+t.width/2),i=e.clientY-(t.top+t.height/2),a=Math.hypot(r,i),o=a>n?n/a:1,s=r*o,c=i*o;this.joystickInput.set(s/n,-c/n),this.joystickKnob.style.transform=`translate(${s}px, ${c}px)`,this.joystick.classList.add(`is-active`)}resetJoystick(){this.joystickInput.set(0,0),this.joystickKnob&&(this.joystickKnob.style.transform=`translate(0, 0)`),this.joystick?.classList.remove(`is-active`)}onJumpButtonDown(e){e.preventDefault(),e.stopPropagation(),this.queueJump(),this.jumpButton.classList.add(`is-active`),this.jumpButton.setPointerCapture(e.pointerId)}onJumpButtonUp(e){e.preventDefault(),e.stopPropagation(),this.jumpButton.hasPointerCapture(e.pointerId)&&this.jumpButton.releasePointerCapture(e.pointerId),this.jumpButton.classList.remove(`is-active`)}updateVerticalMotion(e){this.jumpQueued&&this.isGrounded&&(this.verticalVelocity=Ed,this.isGrounded=!1),this.jumpQueued=!1,this.verticalVelocity-=Td*e,this.bodyY+=this.verticalVelocity*e,this.bodyY<=this.groundY&&(this.bodyY=this.groundY,this.verticalVelocity=0,this.isGrounded=!0)}updateAlmondWaterEffect(e){this.almondWaterTimer<=0||(this.almondWaterTimer=Math.max(0,this.almondWaterTimer-e),this.almondWaterTimer===0&&(this.staminaMax=Dd,this.stamina=Math.min(this.stamina,this.staminaMax)))}updateHeadBob(e,t,n){let r=n&&t>1e-4&&this.isGrounded;this.isMoving=r,this.movementSpeed=e>0?t/e:0;let i=+!!r,a=Math.min(1,e*(r?10:7));if(this.walkBobStrength+=(i-this.walkBobStrength)*a,r){let n=this.moveSpeed*(this.isSprinting?this.sprintMultiplier:1),r=t/Math.max(e*n,1e-4),i=(this.isSprinting?10.35:9.4)*Math.min(1.18,Math.max(.55,r));this.walkCycle+=i*e}let o=this.isSprinting?.038:.032,s=this.isSprinting?.014:.012;this.headBobY=Math.sin(this.walkCycle*2)*o*this.walkBobStrength,this.rollOffset=Math.sin(this.walkCycle)*s*this.walkBobStrength,this.camera.position.y=this.bodyY+this.headBobY}update(e){this.updateAlmondWaterEffect(e);let t=this.joystickInput.x,n=this.joystickInput.y;this.isSprinting=!1;let r=0;this.keys.has(`KeyA`)&&--t,this.keys.has(`KeyD`)&&(t+=1),this.keys.has(`KeyW`)&&(n+=1),this.keys.has(`KeyS`)&&--n;let i=Math.hypot(t,n),a=!1;if(i>=.01){a=!0,i>1&&(t/=i,n/=i),this.forward.set(-Math.sin(this.yaw),0,-Math.cos(this.yaw)).normalize(),this.right.set(Math.cos(this.yaw),0,-Math.sin(this.yaw)).normalize(),this.move.copy(this.forward).multiplyScalar(n).addScaledVector(this.right,t);let o=n>.35&&this.keys.has(`KeyW`)&&(this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`)),s=this.joystickPointerId!==null&&this.joystickInput.y>.88,c=o||s;this.isSprinting=c&&this.stamina>jd,this.isSprinting&&(this.stamina=Math.max(0,this.stamina-Od*e),this.staminaRecoveryDelay=Ad);let l=this.moveSpeed*(this.isSprinting?this.sprintMultiplier:1)*e;this.move.normalize().multiplyScalar(l);let u=this.camera.position.x,d=this.camera.position.z,f=this.resolveMove(u+this.move.x,d+this.move.z);r=Math.hypot(f.x-u,f.z-d),this.camera.position.x=f.x,this.camera.position.z=f.z}if(!this.isSprinting&&(this.staminaRecoveryDelay=Math.max(0,this.staminaRecoveryDelay-e),this.staminaRecoveryDelay===0)){let t=a?kd*.72:kd;this.stamina=Math.min(this.staminaMax,this.stamina+t*e)}this.updateVerticalMotion(e),this.updateHeadBob(e,r,a),this.applyRotation()}getState(){return{stamina:this.stamina,staminaMax:this.staminaMax,staminaBaseMax:Dd,sprinting:this.isSprinting,moving:this.isMoving,grounded:this.isGrounded,movementSpeed:this.movementSpeed,almondWaterActive:this.almondWaterTimer>0,almondWaterRemaining:this.almondWaterTimer,almondWaterDuration:Nd}}drinkAlmondWater(e=Md){let t=Math.max(0,Math.min(e,Pd-Dd));return this.staminaMax=Math.min(Pd,Dd+t),this.stamina=this.staminaMax,this.almondWaterTimer=Nd,this.staminaRecoveryDelay=0,this.isSprinting=!1,this.syncCameraState(),this.getState()}},Q=document.querySelector(`#scene`),Rd=document.querySelector(`#joystick`),zd=document.querySelector(`#jump-button`),Bd=document.querySelector(`#use-button`),Vd=document.querySelector(`#flashlight-button`),Hd=document.querySelector(`#status-text`),Ud=document.querySelector(`#level-select`),Wd=document.querySelector(`#language-select`),Gd=document.querySelector(`#distance-readout`),Kd=document.querySelector(`#light-readout`),qd=document.querySelector(`#fps-readout`),Jd=document.querySelector(`.hud`),Yd=document.querySelector(`.stamina-meter`),Xd=document.querySelector(`#stamina-fill`),Zd=document.querySelector(`#stamina-readout`),Qd=document.querySelector(`#flashlight-meter`),$d=document.querySelector(`#flashlight-fill`),ef=document.querySelector(`#flashlight-readout`),tf=document.querySelector(`#loading-overlay`),nf=document.querySelector(`#loading-fill`),rf=document.querySelector(`#loading-status`),af=document.querySelector(`#exit-overlay`),of=af?.querySelector(`strong`),sf=af?.querySelector(`span`),cf=tf?.querySelector(`.loading-overlay__panel span`),lf=document.querySelector(`#item-info`),uf=document.querySelector(`#item-info-name`),df=document.querySelector(`#item-info-effect`),ff=document.querySelector(`#item-info-action`),pf=1.25,mf=.75,hf=.75,gf=48,_f=58,vf=460,yf=1250,bf=100,xf=3.4,Sf=`backrooms-language`,Cf={"zh-CN":{"almond-water":{name:`杏仁水`,effect:`+50 疾跑上限 / 45秒`,action:`F / 按钮拾取并饮用`},flashlight:{name:`手电筒`,effect:`照亮前方 / 电量有限`,action:`F / 按钮拾取 · 拾取后按 E 开关`}},en:{"almond-water":{name:`ALMOND WATER`,effect:`+50 STAMINA CAPACITY / 45s`,action:`F / BUTTON PICK UP`},flashlight:{name:`FLASHLIGHT`,effect:`FORWARD BEAM / LIMITED BATTERY`,action:`F / BUTTON PICK UP · E TO TOGGLE AFTER PICKUP`}}};[Jd,Rd,zd,Bd,Vd,tf].forEach(e=>{e?.removeAttribute(`hidden`)}),af?.setAttribute(`hidden`,``);var wf=new Uc({canvas:Q,antialias:!0,powerPreference:`high-performance`}),Tf=Math.min(window.devicePixelRatio,pf);wf.setPixelRatio(Tf),wf.outputColorSpace=Le,wf.toneMapping=4,wf.toneMappingExposure=1.18;var Ef=new na(16773829,0,34,.46,.6,1.85);Ef.position.set(.18,-.12,-.16),Ef.name=`player-flashlight`;var Df=new on;Df.position.set(0,-.16,-1);function Of(){return ll(Number(new URLSearchParams(window.location.search).get(`level`))).level}var $=Cd(Of());function kf(e){e.add(Ef),e.add(Df),Ef.target=Df}kf($.camera);var Af=new Ld({camera:$.camera,canvas:Q,joystick:Rd,jumpButton:zd,isWalkable:$.isWalkable,spawn:$.spawn}),jf=Wc(),Mf=new wa,Nf=0,Pf=0,Ff=0,If=0,Lf=!1,Rf=!1,zf=null,Bf=0,Vf=``,Hf=!1,Uf=!1,Wf=0,Gf=`zh-CN`;try{let e=window.localStorage?.getItem(Sf);(e===`zh-CN`||e===`en`)&&(Gf=e)}catch{Gf=`zh-CN`}Wd&&(Wd.value=Gf),document.documentElement.lang=Gf,Q.dataset.language=Gf;function Kf(){Ud&&(Ud.value=String($.level)),cf&&(cf.textContent=$.levelLabel),Q.dataset.level=String($.level),Q.dataset.levelName=$.levelName,Q.dataset.viewModel=$.viewModelName??`NONE`,Q.dataset.colliderCount=String($.colliderCount??0)}function qf(e){if(Array.isArray(e)){e.forEach(qf);return}Object.values(e).forEach(e=>{e?.isTexture&&e.dispose()}),e.dispose()}function Jf(e){e.scene.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&qf(e.material)})}function Yf(e){let t=new URL(window.location.href);t.searchParams.set(`level`,String(e)),window.history.replaceState(null,``,t)}function Xf(e,{updateUrl:t=!1}={}){let n=$;$=Cd(e),kf($.camera),Af.setWorld({camera:$.camera,isWalkable:$.isWalkable,spawn:$.spawn}),Rf=!1,Q.dataset.exitReached=`false`,Kf(),t&&Yf($.level),np(),Jf(n)}function Zf(e,t){of&&(of.textContent=e),sf&&(sf.textContent=t)}function Qf(e,t){Zf(e,t),af?.removeAttribute(`hidden`),af?.classList.add(`is-visible`)}function $f(){af?.classList.remove(`is-visible`),window.setTimeout(()=>af?.setAttribute(`hidden`,``),vf)}function ep(e){let t=ll(e);zf={nextLevel:t.level,elapsed:0},Q.dataset.transitioning=`true`,Q.dataset.exitReached=`true`,Qf(t.levelLabel,t.levelName)}function tp(e){if(!zf||(zf.elapsed+=e*1e3,zf.elapsed<yf))return;let t=zf.nextLevel;zf=null,Xf(t,{updateUrl:!0}),Q.dataset.transitioning=`false`,Q.dataset.exitReached=`false`,$f()}Ud?.addEventListener(`change`,()=>{let e=Number(Ud.value);e!==$.level&&(zf=null,Rf=!1,Q.dataset.transitioning=`false`,Q.dataset.exitReached=`false`,$f(),Xf(e,{updateUrl:!0}))}),Wd?.addEventListener(`change`,()=>{let e=Wd.value===`en`?`en`:`zh-CN`;Gf=e,document.documentElement.lang=e,Q.dataset.language=e;try{window.localStorage?.setItem(Sf,e)}catch{}});function np(){let e=window.innerWidth,t=window.innerHeight;wf.setSize(e,t,!1),$.camera.aspect=e/t,$.camera.updateProjectionMatrix()}function rp(e){let t=Math.max(mf,Math.min(Math.min(window.devicePixelRatio,pf),e));Math.abs(t-Tf)<.01||(Tf=t,wf.setPixelRatio(Tf),np())}function ip(e){Pf+=1,Ff+=e,!(Ff<hf)&&(If=Math.round(Pf/Ff),If<gf?rp(Tf-.1):If>_f&&rp(Tf+.05),qd.textContent=`${If} FPS`,qd.dataset.quality=Tf<1?`LOW`:`HIGH`,Q.dataset.fps=String(If),Q.dataset.pixelRatio=Tf.toFixed(2),Pf=0,Ff=0)}function ap(){if(Lf)return;let e=Math.min(1,.18+Nf/42);nf&&(nf.style.transform=`scaleX(${e.toFixed(3)})`),rf&&(rf.textContent=e>.7?`SIGNAL LOCK`:`NOCLIP SYNC`),e>=1&&Q.dataset.sceneReady===`true`&&(Lf=!0,tf?.classList.add(`is-hidden`),window.setTimeout(()=>tf?.setAttribute(`hidden`,``),vf))}function op(e){if(!e)return;let t=Math.max(0,Math.min(1,e.stamina/e.staminaMax)),n=Math.max(0,e.almondWaterRemaining??0),r=n>0;if(Xd&&(Xd.style.transform=`scaleX(${t.toFixed(3)})`),Zd){let t=`${Math.round(e.stamina)}/${Math.round(e.staminaMax)}`;Zd.textContent=r?`${t} ${Math.ceil(n)}s`:t}Yd?.dataset&&(Yd.dataset.state=t<.24?`low`:r?`boosted`:`ready`),Q.dataset.stamina=String(Math.round(t*100)),Q.dataset.staminaValue=String(Math.round(e.stamina)),Q.dataset.staminaMax=String(Math.round(e.staminaMax)),Q.dataset.staminaBaseMax=String(Math.round(e.staminaBaseMax)),Q.dataset.almondWaterActive=String(r),Q.dataset.almondWaterRemaining=n.toFixed(1),Q.dataset.sprinting=String(e.sprinting)}function sp(){let e=Wf/bf;Qd&&(Qd.hidden=!Hf,Qd.dataset.state=e<.18?`low`:Uf?`on`:`ready`),$d&&($d.style.transform=`scaleX(${Math.max(0,e).toFixed(3)})`),ef&&(ef.textContent=Hf?`${Math.round(Wf)}%`:`--`),Vd&&(Vd.classList.toggle(`is-visible`,Hf),Vd.classList.toggle(`is-active`,Uf),Vd.disabled=!Hf||Wf<=0),Q.dataset.flashlightOwned=String(Hf),Q.dataset.flashlightOn=String(Uf),Q.dataset.flashlightBattery=String(Math.round(Wf))}function cp(e){Uf&&(Wf=Math.max(0,Wf-xf*e),Wf<=0&&(Uf=!1));let t=Wf/bf;Ef.intensity=Hf&&Uf&&Wf>0?4.8*Math.max(.44,t):0,Ef.distance=20+t*18,sp()}function lp(){!Hf||Wf<=0||(Uf=!Uf,sp())}function up(e){let t=Hf;Hf=!0,Uf=!1,Wf=bf,Vf=t?`FLASHLIGHT BATTERY FULL`:`FLASHLIGHT ACQUIRED`,Bf=Mf.elapsedTime+1.7,Q.dataset.flashlightPickups=String(e??1),sp()}function dp(e){let t=e.almondWater,n=e.flashlight,r=!!t?.available,i=!!n?.available,a=r||i;Bd?.classList.toggle(`is-visible`,a),Bd&&(Bd.disabled=!a),Q.dataset.almondWaterVisible=String(!!t?.visible),Q.dataset.almondWaterAvailable=String(r),Q.dataset.almondWaterDistance=Number.isFinite(t?.distance)?String(Math.round(t.distance)):``,Q.dataset.flashlightVisible=String(!!n?.visible),Q.dataset.flashlightAvailable=String(i),Q.dataset.flashlightDistance=Number.isFinite(n?.distance)?String(Math.round(n.distance)):``}function fp(e){let t=e.focusItem,n=!!t;if(lf&&(n&&(lf.hidden=!1),lf.classList.toggle(`is-visible`,n),n||(lf.hidden=!0)),n){let e=Cf[Gf]?.[t.id]??t;uf&&(uf.textContent=e.name??t.name),df&&(df.textContent=e.effect??t.effect),ff&&(ff.textContent=e.action??t.action)}Q.dataset.focusItem=n?t.id:``,Q.dataset.focusItemDistance=Number.isFinite(t?.distance)?String(Math.round(t.distance*10)/10):``}function pp(){if(Rf||zf)return;let e=$.tryPickup?.($.camera.position);if(e?.pickedUp){if(e.itemId===`flashlight`)up(e.count);else{let t=Af.drinkAlmondWater(e.staminaBonus);Vf=`ALMOND WATER ${Math.ceil(t.almondWaterRemaining)}s`,Bf=Mf.elapsedTime+1.7,Q.dataset.almondWaterDrinks=String(e.count)}Bd?.classList.add(`is-active`),window.setTimeout(()=>Bd?.classList.remove(`is-active`),140)}}function mp(e,t,n){Gd.textContent=`${e.exitDistance}m`,Kd.textContent=e.lightState??(e.flicker<.62?`DIM`:`HUM`),Hd.textContent=n<Bf?Vf:e.flashlight?.available?`FLASHLIGHT`:e.almondWater?.available?`ALMOND WATER`:e.statusText??(e.exitReached?`EXIT STABILIZED`:e.exitDistance<7?`SIGNAL FOUND`:`NO SIGNAL`),dp(e),fp(e),op(t)}function hp(){let e=Math.min(Mf.getDelta(),.05),t=Mf.elapsedTime;tp(e),!Rf&&!zf&&Af.update(e);let n=Af.getState(),r=$.update(e,t,$.camera.position);cp(e),r.exitReached&&!Rf&&!zf&&($.nextLevel!==null&&$.nextLevel!==void 0?ep($.nextLevel):(Rf=!0,Qf(`EXIT STABILIZED`,`${$.levelLabel} SIGNAL LOST`),Q.dataset.exitReached=`true`)),jf.update(r.flicker,n),mp(r,n,t),ip(e),ap(),wf.render($.scene,$.camera),Nf+=1,Q.dataset.sceneReady=`true`,Q.dataset.frameCount=String(Nf),requestAnimationFrame(hp)}function gp(){jf.start(),window.removeEventListener(`pointerdown`,gp),window.removeEventListener(`keydown`,gp)}function _p(e){if(e.code!==`KeyF`&&e.code!==`KeyE`)return;let t=e.target?.tagName;if(!(t===`INPUT`||t===`SELECT`||t===`TEXTAREA`)){if(e.preventDefault(),e.code===`KeyE`){lp();return}pp()}}Bd?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),pp()}),Vd?.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),lp()}),window.addEventListener(`resize`,np),window.addEventListener(`pointerdown`,gp,{passive:!0}),window.addEventListener(`keydown`,gp),window.addEventListener(`keydown`,_p),Kf(),np(),hp();